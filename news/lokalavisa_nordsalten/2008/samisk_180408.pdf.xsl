...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.nord-salten.no/files/samisk_180408.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sidá gus ålggorijkan studerit? og Englánndaj giellaskåvllåj'"/>
    <!--
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Maria'"/>
    ...
    <xsl:variable name="author2_born" select="'1987'"/>
    ...
    <xsl:variable name="translator_fn" select="'Lars Theodro'"/>
    ...
    <xsl:variable name="note" select="'det er bare den ene teksten som er oversatt'"/>
