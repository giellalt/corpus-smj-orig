...
<xsl:variable name="filename" select="'http://www.nord-salten.no/files/samisk_220110.pdf'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Bállotjiektjam ja valástallam bisot årudagáv'"/>
