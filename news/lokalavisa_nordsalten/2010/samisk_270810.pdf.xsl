...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.nord-salten.no/files/samisk_270810.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'- Vuogas Árranij! og Stuoves låhko sámegielak oahppijs'"/>
    <!--
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Gunnar'"/>
    <xsl:variable name="author2_ln" select="'Grytøyr'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author3_fn" select="'Kitty'"/>
    <xsl:variable name="author3_ln" select="'Skapalen'"/>
    ...
    <xsl:variable name="translator_fn" select="'Ingrid'"/>
