...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.nord-salten.no/admin/tinymce/jscripts/tiny_mce/plugins/filemanager/files/client_113/samisk/2012/samisk_10022012.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámij álmmukbiejvve'"/>
    <!--
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Geir'"/>
    <xsl:variable name="author2_ln" select="'Smelror'"/>
    ...
    <xsl:variable name="translator_fn" select="'Jørgen'"/>
    <xsl:variable name="translator_ln" select="'Kintel'"/>
    <xsl:variable name="translator_gender" select="'m'"/>
    <xsl:variable name="translator_born" select="'1991'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="samisk_10022012.pdf"/>
