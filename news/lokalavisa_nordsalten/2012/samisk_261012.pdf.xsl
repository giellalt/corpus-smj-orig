...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.nord-salten.no/admin/tinymce/jscripts/tiny_mce/plugins/filemanager/files/client_113/samisk/2012/samisk_261012.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Duodjevuosádus Ruossjan og Politihkajgasskasasj semalasjvuohta Måsskerahte hárráj'"/>
    <!--
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Kitty'"/>
    <xsl:variable name="author2_ln" select="'Skapalen'"/>
    ...
    <xsl:variable name="sub_email" select="'ingal.mikkelsen@uit.no'"/>
    ...
    <xsl:variable name="note" select="'norsk bildetekst, parallelfila gjelder bare en av artiklene'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="duodji-utstilling-i-russland_261112.html"/>
