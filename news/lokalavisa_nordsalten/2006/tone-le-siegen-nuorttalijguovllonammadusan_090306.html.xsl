...
<xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/samisk/tone-le-siegen-nuorttalijguovllonammadus-n.4170'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Tone le siegen nuorttalijguovllonammadusán'"/>
