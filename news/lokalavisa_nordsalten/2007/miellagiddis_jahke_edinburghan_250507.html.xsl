...
<xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/samisk/miellagiddis-jahke-edinburgh-an.4046'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Miellagiddis jahke Edinburgh:an'"/>
<xsl:variable name="author1_fn" select="'Birgit'"/>
...
<xsl:variable name="author1_born" select="'1984'"/>
