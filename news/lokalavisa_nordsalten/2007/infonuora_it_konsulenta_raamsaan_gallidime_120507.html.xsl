...
<xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/samisk/infonuora-it-konsulenta-romsan-gallidime.4048'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Infonuora IT-konsulenta Romsån gallidime'"/>
<xsl:variable name="author1_fn" select="'Infonuorra'"/>
...
<xsl:variable name="translator_fn" select="'Birgit'"/>
<xsl:variable name="translator_ln" select="'Andersen'"/>
