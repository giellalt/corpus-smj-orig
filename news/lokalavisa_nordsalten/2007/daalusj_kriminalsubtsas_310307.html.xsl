...
<xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/samisk/dalusj-kriminalsubtsas-forsanj-vres.4052'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Dålusj kriminalsubtsas Forsanjávres'"/>
...
<xsl:variable name="author2_fn" select="'Lars Børge'"/>
<xsl:variable name="author2_ln" select="'Myklevoll'"/>
