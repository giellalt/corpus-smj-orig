...
<xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/samisk/sihtin-nuppe-oahppij-oahp-stuvvat.4205'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sihtin nuppe oahppij oahpástuvvat'"/>
<xsl:variable name="author1_fn" select="'Sandra'"/>
<xsl:variable name="author1_ln" select="'Nystø Rahka'"/>
<xsl:variable name="author1_gender" select="'f'"/>
<xsl:variable name="author1_nat" select="'nor'"/>
<xsl:variable name="author1_born" select="'1987'"/>
<xsl:variable name="author2_fn" select="'Eskil'"/>
<xsl:variable name="author2_ln" select="'Mikkelsen'"/>
<xsl:variable name="author2_gender" select="'m'"/>
<xsl:variable name="author2_nat" select="'nor'"/>
<xsl:variable name="author2_born" select="'1989'"/>
<xsl:variable name="author3_fn" select="'Idar'"/>
<xsl:variable name="author3_ln" select="'Kintel'"/>
<xsl:variable name="author3_gender" select="'m'"/>
<xsl:variable name="author3_nat" select="'nor'"/>
<xsl:variable name="author3_born" select="'1989'"/>
