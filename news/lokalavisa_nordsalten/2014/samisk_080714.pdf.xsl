...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.nord-salten.no/admin/tinymce/jscripts/tiny_mce/plugins/filemanager/files/client_113/samisk/2014/samisk_080714.pdf'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Karianne Sørgård'"/>
    <xsl:variable name="author1_ln" select="'Olsen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="utforsker-makt-og-avmakt-i-kritikerrost-bok.51596.html"/>
