...
<xsl:variable name="filename" select="'http://www.nord-salten.no/files/samisk_120609.pdf'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Julevsáme nuora:- Dárbahip ienep diedojt'"/>
