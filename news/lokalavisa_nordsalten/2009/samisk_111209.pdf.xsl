...
<xsl:variable name="filename" select="'http://www.nord-salten.no/files/samisk_111209.pdf'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Avtamielakvuodajn værálda álggoálmmugij'"/>
