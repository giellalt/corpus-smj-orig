...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.nord-salten.no/admin/tinymce/jscripts/tiny_mce/plugins/filemanager/files/client_113/samisk/2011/samisk_161211.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Lågådallam Áhkkánjárgan'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Geir'"/>
    <xsl:variable name="author1_ln" select="'Smelror'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="translator_fn" select="'Ingrid katrine'"/>
    <xsl:variable name="translator_ln" select="'Kintel'"/>
    <xsl:variable name="translator_gender" select="'f'"/>
    <xsl:variable name="translator_born" select="'1988'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="lars_holdt_foredrag_231211.html"/>
