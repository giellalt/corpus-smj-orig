...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.nrk.no/osloogviken/xl/koronadavdda---informasjon-pa-lulesamisk-1.14954641'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Koronadávdda - diedo julevsábmáj. Ájnas diedo koronadávda birra.'"/>
    <!--
    ...
    <xsl:variable name="publisher" select="'nrk.no'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="nrk-koronavirusinfo.txt"/>
        <parallel_text xml:lang="sme" location="nrk-koronavirusinfo.txt"/>
