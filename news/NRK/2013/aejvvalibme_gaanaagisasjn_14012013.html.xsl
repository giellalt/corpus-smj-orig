...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.nrk.no/kanal/nrk_sapmi/samegillii/1.10872009'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Vájmulasj æjvvalibme Gånågisájn'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Harrieth'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Mette'"/>
    <xsl:variable name="author2_ln" select="'Ballovara'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author3_fn" select="'Johannes Edvard'"/>
    <xsl:variable name="author3_ln" select="'Kalvemo'"/>
    <xsl:variable name="author3_gender" select="'m'"/>
    <xsl:variable name="author3_nat" select="'NO'"/>
    <xsl:variable name="author3_born" select="'19490325'"/>
    ...
    <xsl:variable name="publisher" select="'NRK Sápmi'"/>
    ...
    <xsl:variable name="sub_email" select="'inga.l.mikkelsen@it.no'"/>
