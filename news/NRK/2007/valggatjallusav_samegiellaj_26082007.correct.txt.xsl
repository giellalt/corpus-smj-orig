...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.nrk.no/kanal/nrk_sapmi/1.3297033'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Válggatjállusav sámegiellaj'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Eilif Andreas'"/>
    <xsl:variable name="author1_ln" select="'Aslaksen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="author1_born" select="'19631203'"/>
    <!--
