...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.nrk.no/sapmi/samegillii/same-ajrrasa-galggi-nammaduvvat-1.11603180'"/>
    ...
    <parallel_text xml:lang="nob" location="soker-samer-til-tdms-planlegging-1.11603360.html"/></xsl:variable>
