...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.nrk.no/sapmi/samegillii/musihka-baktu-kalle-ietjas-gavnaj-1.12291394'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="''"/>
    <xsl:variable name="author1_fn" select="'Simon Piera'"/>
    <xsl:variable name="author1_ln" select="'Paulsen'"/>
    ...
    <xsl:variable name="sub_name" select="'Sandra Nystø Ráhka'"/>
