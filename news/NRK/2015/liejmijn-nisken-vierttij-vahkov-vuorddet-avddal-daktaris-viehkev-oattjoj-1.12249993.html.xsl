...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.nrk.no/sapmi/liejmijn-nisken-vierttij-vahkov-vuorddet-avddal-daktaris-viehkev-oattjoj-1.12249993'"/>
    ...
    <xsl:variable name="author1_born" select="'1989'"/>
    <!--
