...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.folkhalsomyndigheten.se/om-folkhalsomyndigheten/information-pa-minoritetssprak/lulesamiska/'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="om-folkhalsomyndigheten.html"/>
        <parallel_text xml:lang="fit" location="om-folkhalsomyndigheten.html"/>
        ...
        <parallel_text xml:lang="sma" location="om-folkhalsomyndigheten.html"/>
        <parallel_text xml:lang="sme" location="om-folkhalsomyndigheten.html"/>
