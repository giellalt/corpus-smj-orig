...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://kirken.no/globalassets/kirken.no/om-kirken/slik-styres-kirken/kirkevalget/2015/for-medarbeidere/veiledninger/2-3-2_veil_stemmegivning-valgdag_ls.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Válggabiejve jienastibme'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="kirkevalget_2015_stemmegivning_valgdag.pdf"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="gaerhkoeveeljeme_2015_veeljemebiejjien_steemmadidh.pdf"/>
        <parallel_text xml:lang="sme" location="girkovalga_2015_jienasteapmi_valgabeaivvi.pdf"/>
