...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.kyrkja.no/globalassets/kirken.no/samisk-kirkeliv/dokumenter/samisk-strategiplan/strategiplan_samisk_kirkeliv_2011_nordsam.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámi girkoeallima strategalaš plána'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="strategiplan_samisk_kirkeliv_2011_nob.pdf"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="strategiplan_samisk_kirkeliv_2011_sma.pdf"/>
        <parallel_text xml:lang="sme" location="strategiplan_samisk_kirkeliv_2011_sme.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-16, 25-119'"/>
    ...
    <xsl:variable name="top_margin" select="'17=68'"/>
    <xsl:variable name="bottom_margin" select="'24=75'"/>
