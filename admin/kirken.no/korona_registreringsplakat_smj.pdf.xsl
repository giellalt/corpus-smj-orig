...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://kirken.no/globalassets/kirken.no/aktuelt/filer%202020/infoplakater%20og%20registreringsmal/lulesam%20-%20korona%20-%20registreringsplakat.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Registrerim'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="''"/>
    <xsl:variable name="author1_ln" select="'kirken.no'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="korona_registreringsplakat_eng.pdf"/>
        ...
        <parallel_text xml:lang="nno" location="korona_registreringsplakat_nynorsk.pdf"/>
        <parallel_text xml:lang="nob" location="korona_registreringsplakat_nob.pdf"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="korona_registreringsplakat_sma.pdf"/>
        <parallel_text xml:lang="sme" location="korona_registreringsplakat_sme.pdf"/>
