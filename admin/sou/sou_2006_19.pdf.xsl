...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.regeringen.se/49bafa/contentassets/b1ca532ce4fb4e908ec9444e6b25149b/sammanfattning-av-att-aterta-mitt-sprak---atgarder-for-att-starka-det-samiska-spraket-pa-lulesamiska'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tjoahkkájgäsos'"/>
    <!--
    ...
    <xsl:variable name="bottom_margin" select="'all=27, 2=34'"/>
