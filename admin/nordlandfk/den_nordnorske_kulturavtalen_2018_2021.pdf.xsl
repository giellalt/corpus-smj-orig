...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.nfk.no/_f/p34/id3e88822-2fef-4043-9788-26fcafccf453/den-nordnorske-kulturavtalen.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'DEN NORDNORSKE KULTURAVTALEN 2018-2021'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="den_nordnorske_kulturavtalen_2018_2021_nob.pdf"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="den_nordnorske_kulturavtalen_2018_2021_sma.pdf"/>
        <parallel_text xml:lang="sme" location="den_nordnorske_kulturavtalen_2018_2021_sme.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-20, 29-40'"/>
    ...
    <!--
        ...
        1;3;8=20, 4;5;7=10
    -->
    <xsl:variable name="linespacing" select="'all=5'"/>
