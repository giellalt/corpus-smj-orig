...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Dearvvasvuohta-ja-sosiala/Manaidsuodjalus/Samediggi-dahka-ovttasbargosiehtadusa-Norgga-biebmoruovttuidservviin'"/>
    ...
    <parallel_text xml:lang="sma" location="healsoe-jih-sosijaale_maanavaarjelimmie_laavenjostoelatjkoem-dorje-noeoerjen-foestehiejmesiebrine.html"/>
	<parallel_text xml:lang="nob" location="helse-og-sosial_barnevern_inngaar-samarbeidsavtale-med-norsk-fosterhjemsforening.html"/>
	<parallel_text xml:lang="sme" location="dearvvasvuohta-ja-sosiala_manaidsuodjalus_samediggi-dahka-ovttasbargosiehtadusa-norgga-biebmoruovttuidservviin.html"/></xsl:variable>
