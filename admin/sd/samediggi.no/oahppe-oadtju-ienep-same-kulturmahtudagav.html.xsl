...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <parallel_text location="studenter-faar-mer-samisk-kulturkunnskap.html" xml:lang="nob"/>
<parallel_text location="studeanttat-ozzot-eanet-sami-kulturmahtu.html" xml:lang="sme"/>
</xsl:variable>
