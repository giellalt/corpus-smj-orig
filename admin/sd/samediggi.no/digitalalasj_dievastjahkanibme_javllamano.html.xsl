...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/digitalt-plenumsmote-i-desember.8428.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Digitálalasj dievastjåhkanibme javllamáno - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="digitalt_plenumsmote_i_desember.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="digitaale_stoerretjaanghkoe_goeven.html"/>
        <parallel_text xml:lang="sme" location="digitala_dievascoahkkin_juovlamanus.html"/>
