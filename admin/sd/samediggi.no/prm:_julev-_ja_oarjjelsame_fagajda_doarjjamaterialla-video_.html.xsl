...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/prd-doarjjamaterialafilmmat-julev-ja-lullisamegielfagaide.21969.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRM: Julev- ja oarjjelsáme fágajda doarjjamateriálla-video  - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm:_stottemateriell-videoer_til_lule-_og_sorsamiske_fag.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="prm:_stottemateriell-videoer_til_lule-_og_sorsamiske_fag.html"/>
        <parallel_text xml:lang="sme" location="prd:_doarjjamaterialafilmmat_julev-_ja_lullisamegielfagaide.html"/>
