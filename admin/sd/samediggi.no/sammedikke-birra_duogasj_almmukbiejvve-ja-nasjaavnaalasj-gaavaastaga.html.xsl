...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="saemiedigkien-bijre_sjieke_aaaalmegebiejjie-jih-nasjovnaale-symbovlh.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_bakgrunn_nasjonaldag-og-nasjonale-symboler.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_duogas_sami-albmotbeaivi-ja-nasuvnnalas-dovdomearkkat.html"/></xsl:variable>
