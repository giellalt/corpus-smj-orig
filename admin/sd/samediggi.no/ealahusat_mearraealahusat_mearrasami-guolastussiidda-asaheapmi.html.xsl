...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Mearraealahusat/Mearrasami-guolastussiidda-asaheapmi'"/>
    ...
    <parallel_text xml:lang="sma" location="ealahusat_mearraealahusat_mearrasami-guolastussiidda-asaheapmi.html"/>
	<parallel_text xml:lang="nob" location="naeringer_marine-naeringer_mot-en-sjoesamisk-fiskerisiida.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_mearraealahusat_mearrasami-guolastussiidda-asaheapmi.html"/></xsl:variable>
