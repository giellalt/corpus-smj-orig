...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="kultuvrejieleme_gaarsjelimmie_saemiedigkien-kultuvre-jih-gaarsjelimmiestipende.html"/>
	<parallel_text xml:lang="nob" location="kulturliv_idrett_sametingets-kultur-og-idrettsstipend.html"/>
	<parallel_text xml:lang="sme" location="kultureallin_falastallan_samedikki-kultur-ja-valastallanstipeanddat.html"/></xsl:variable>
