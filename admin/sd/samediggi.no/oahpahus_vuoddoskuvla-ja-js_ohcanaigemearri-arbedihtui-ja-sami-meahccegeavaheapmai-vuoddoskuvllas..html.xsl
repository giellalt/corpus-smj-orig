...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Oahpahus/Vuoddoskuvla-ja-JS/Ohcanaigemearri-arbedihtui-ja-sami-meahccegeavaheapmai-vuoddoskuvllas.'"/>
    ...
    <parallel_text xml:lang="sma" location="lierehtimmie_maadthskuvle-jih-jaaa_ohtsememierie-aerpievuekien-daajrose-jih-saemien-miehtjieaatnose-maadthskuvlesne.html"/>
	<parallel_text xml:lang="nob" location="opplaering_grunnskole-og-vgs_soeknadsfrist-for-tradisjonell-kunnskap-og-samisk-utmarksbruk-i-grunnskolen.html"/>
	<parallel_text xml:lang="sme" location="oahpahus_vuoddoskuvla-ja-js_ohcanaigemearri-arbedihtui-ja-sami-meahccegeavaheapmai-vuoddoskuvllas..html"/></xsl:variable>
