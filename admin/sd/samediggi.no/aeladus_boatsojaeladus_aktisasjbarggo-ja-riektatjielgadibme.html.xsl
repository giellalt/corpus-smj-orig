...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="jielemh_baaatsoe_laavenjostoe-jih-reaktatjielkestimmie.html"/>
	<parallel_text xml:lang="nob" location="naeringer_reindrift_samarbeid-og-rettighetsavklaring.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_boazodoallu_ovttasbargu-ja-vuoigatvuodacielggadeapmi.html"/></xsl:variable>
