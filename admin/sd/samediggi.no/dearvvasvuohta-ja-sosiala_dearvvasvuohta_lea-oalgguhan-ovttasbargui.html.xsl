...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Dearvvasvuohta-ja-sosiala/Dearvvasvuohta/Lea-oalgguhan-ovttasbargui'"/>
    ...
    <parallel_text xml:lang="sma" location="dearvvasvuohta-ja-sosiala_dearvvasvuohta_lea-oalgguhan-ovttasbargui.html"/>
	<parallel_text xml:lang="nob" location="helse-og-sosial_helse_har-saadd-et-froe-for-samarbeid.html"/>
	<parallel_text xml:lang="sme" location="dearvvasvuohta-ja-sosiala_dearvvasvuohta_lea-oalgguhan-ovttasbargui.html"/></xsl:variable>
