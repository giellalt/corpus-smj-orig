...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Arkiv/Valgperiode-2009-2013/Artikler/Viiddis-angirussamat-samegielain'"/>
    ...
    <parallel_text xml:lang="sma" location="vaaarhkoe_veeljemeboelhken-2009-2013_tjaalegh_vijries-raaajvarimmie-saemien-gielide.html"/>
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_bred-satsning-paa-samisk-spraak.html"/>
	<parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_viiddis-angirussamat-samegielain.html"/></xsl:variable>
