...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Girjeradju/Mii-avzzuhit/Sami-bibliografiija/Norgga-sami-bibliografia'"/>
    ...
    <parallel_text xml:lang="sma" location="gaerjagaaetie_mijjieh-juvnehtibie_saemien-bibliografije_noeoerjen-saemien-bibliografije.html"/>
	<parallel_text xml:lang="nob" location="bibliotek_vi-anbefaler_samisk-bibliografi_norsk-samisk-bibliografi.html"/>
	<parallel_text xml:lang="sme" location="girjeradju_mii-avzzuhit_sami-bibliografiija_norgga-sami-bibliografia.html"/></xsl:variable>
