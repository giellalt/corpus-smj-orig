...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="lierehtimmie_maanagierte.html"/>
	<parallel_text xml:lang="nob" location="opplaering_barnehager.html"/>
	<parallel_text xml:lang="sme" location="oahpahus_manaidgardi.html"/></xsl:variable>
