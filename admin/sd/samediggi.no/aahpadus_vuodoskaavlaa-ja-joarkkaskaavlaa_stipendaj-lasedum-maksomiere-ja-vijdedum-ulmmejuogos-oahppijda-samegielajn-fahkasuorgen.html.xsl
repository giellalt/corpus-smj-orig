...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/AAhpadus/Vuodoskaavlaa-ja-joarkkaskaavlaa/Stipendaj-lasedum-maksomiere-ja-vijdedum-ulmmejuogos-oahppijda-samegielajn-fahkasuorgen'"/>
    ...
    <parallel_text xml:lang="sma" location="lierehtimmie_maadthskuvle-jih-jaaa_lissiehtamme-stipendeaaasah-jih-vijriedamme-ulmiedaaehkie-stipendese-learoehkidie-mej-saemien-faagegievlesne.html"/>
	<parallel_text xml:lang="nob" location="opplaering_grunnskole-og-vgs_oekte-satser-og-utvidet-maalgruppe-for-stipend-til-elever-med-samisk-i-fagkretsen.html"/>
	<parallel_text xml:lang="sme" location="oahpahus_vuoddoskuvla-ja-js_stipeanddas-stuorit-maksomearri-ja-eanet-oahppit-olahusjoavkkus-geain-lea-samegiella-fagan..html"/></xsl:variable>
