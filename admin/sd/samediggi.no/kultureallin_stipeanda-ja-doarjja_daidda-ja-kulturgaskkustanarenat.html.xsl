...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Kultureallin/Stipeanda-ja-doarjja/Daidda-ja-kulturgaskkustanarenat'"/>
    ...
    <parallel_text xml:lang="sma" location="kultureallin_stipeanda-ja-doarjja_daidda-ja-kulturgaskkustanarenat.html"/>
	<parallel_text xml:lang="nob" location="kulturliv_stipend-og-tilskudd_arena-for-kunst-og-kulturformidling.html"/>
	<parallel_text xml:lang="sme" location="kultureallin_stipeanda-ja-doarjja_daidda-ja-kulturgaskkustanarenat.html"/></xsl:variable>
