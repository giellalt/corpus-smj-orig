...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Samedikki-birra/Airasat/Aili-Keskitalo'"/>
    ...
    <parallel_text xml:lang="sma" location="samedikki-birra_airasat_aili-keskitalo.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_representanter_aili-keskitalo.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_airasat_aili-keskitalo.html"/></xsl:variable>
