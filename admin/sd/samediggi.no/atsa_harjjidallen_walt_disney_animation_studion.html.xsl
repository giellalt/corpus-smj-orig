...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/praksismulighet-hos-walt-disney-animation-studios.10126.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Åtså hárjjidallen Walt Disney Animation Studion - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="praksismulighet_hos_walt_disney_animation_studios.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="ohtsh_lierehtaejjine_sjidtedh_walt_disney_animation_studiosne.html"/>
        <parallel_text xml:lang="sme" location="oza_oahpahallin_walt_disney_animation_studios.html"/>
