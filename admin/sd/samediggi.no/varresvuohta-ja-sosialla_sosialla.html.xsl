...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="healsoe-jih-sosijaale_sosijaale.html"/>
	<parallel_text xml:lang="nob" location="helse-og-sosial_sosial.html"/>
	<parallel_text xml:lang="sme" location="dearvvasvuohta-ja-sosiala_sosiala.html"/></xsl:variable>
