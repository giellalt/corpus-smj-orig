...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Valgga-ja-jienastuslaahkuj/Kampanjeside/Belludaga-Valggabarggoguojme/Jaahtotjala-Samediggevalga-njuolgadusaj-rievddama-birra'"/>
    ...
    <parallel_text location="johtucalus-samediggevalggaid-lahkaasahusa-rievdadusaid-birra.html" xml:lang="sme"/>
<parallel_text location="rundskriv-om-endring-i-forskrift-om-valg-til-sametinget.html" xml:lang="nob"/>
<parallel_text location="tjaalaldahke-jarkelimmien-bijre-mieriedimmesne-veeljemen-birje-saemiedaegkan.html" xml:lang="sma"/>
</xsl:variable>
