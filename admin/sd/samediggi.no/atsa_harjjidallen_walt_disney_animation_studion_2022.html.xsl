...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/apply-as-an-internship-at-walt-disney-animation-studios-2022.18041.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Åtså hárjjidallen Walt Disney Animation Studion 2022 - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="apply_as_an_internship_at_walt_disney_animation_studios_2022.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="ohtsh_lierehtaejjine_arrodh_walt_disney_animation_studiosne_2022.html"/>
        <parallel_text xml:lang="sme" location="oza_oahpahallin_walt_disney_animation_studioi_2022.html"/>
