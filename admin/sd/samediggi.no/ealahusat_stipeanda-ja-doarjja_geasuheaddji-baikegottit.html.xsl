...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Stipeanda-ja-doarjja/Geasuheaddji-baikegottit'"/>
    ...
    <parallel_text xml:lang="sma" location="ealahusat_stipeanda-ja-doarjja_geasuheaddji-baikegottit.html"/>
	<parallel_text xml:lang="nob" location="naeringer_stipend-og-tilskudd_attraktive-lokalsamfunn.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_stipeanda-ja-doarjja_geasuheaddji-baikegottit.html"/></xsl:variable>
