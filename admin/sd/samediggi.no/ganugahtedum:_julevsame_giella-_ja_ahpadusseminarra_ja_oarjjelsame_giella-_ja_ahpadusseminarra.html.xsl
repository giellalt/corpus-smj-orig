...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/lule-og-sorsamisk-sprak-og-opplaringsseminarer-er-avlyst.8476.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ganugahtedum: Julevsáme giella- ja åhpadusseminárra ja oarjjelsáme giella- ja åhpadusseminárra - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="lule-_og_sorsamisk_sprak-_og_opplaeringsseminarer_er_avlyst_.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="julev-_jih_aarjelsaemien_giele-_jih_lierehtimmieseminaarh_eah_oornesovvh.html"/>
        <parallel_text xml:lang="sme" location="julev-_ja_lullisami_giella-_ja_oahpahusseminarat_eai_satta_lagiduvvot.html"/>
