...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politikk/taler-og-innlegg/plenumsleders-velkomsttale-under-sametingsapning.17067.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ållestjåhkanimjådediddje sámedikke rahpama buorástahttemhålla - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="plenumsleders_velkomsttale_under_sametingsapning.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="stoerretjaanghkoeavtehken_buerie_baeteme-haalome_saemiedigkien_rihpestimmesne.html"/>
        <parallel_text xml:lang="sme" location="dievascoahkkinjodiheaddji_sardni_samedikki_rahpamis.html"/>
