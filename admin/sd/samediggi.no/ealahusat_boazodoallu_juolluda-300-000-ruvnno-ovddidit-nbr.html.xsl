...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Boazodoallu/Juolluda-300-000-ruvnno-ovddidit-NBR'"/>
    ...
    <parallel_text xml:lang="sma" location="ealahusat_boazodoallu_juolluda-300-000-ruvnno-ovddidit-nbr.html"/>
	<parallel_text xml:lang="nob" location="naeringer_reindrift_bevilger-300-000-til-aa-utvikle-nrl.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_boazodoallu_juolluda-300-000-ruvnno-ovddidit-nbr.html"/></xsl:variable>
