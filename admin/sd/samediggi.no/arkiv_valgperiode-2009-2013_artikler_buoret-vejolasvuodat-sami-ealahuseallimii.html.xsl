...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Arkiv/Valgperiode-2009-2013/Artikler/Buoret-vejolasvuodat-sami-ealahuseallimii'"/>
    ...
    <parallel_text xml:lang="sma" location="arkiv_valgperiode-2009-2013_artikler_buoret-vejolasvuodat-sami-ealahuseallimii.html"/>
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_bedre-utviklingsmuligheter-for-samisk-naeringsliv.html"/>
	<parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_buoret-vejolasvuodat-sami-ealahuseallimii.html"/></xsl:variable>
