...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Samedikki-birra/Rabas-virggit'"/>
    ...
    <parallel_text xml:lang="sma" location="samedikki-birra_rabas-virggit.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_ledige-stillinger.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_rabas-virggit.html"/></xsl:variable>
