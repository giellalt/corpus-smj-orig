...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/rapport-og-webinar-om-situasjonen-for-pite-og-umesamisk-pa-norsk-side-av-sapmi.14363.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Diedádus ja webinárra bihtám- ja ubbmemsámegielaj dile birra Vuona bielen Sámen - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="rapport_og_webinar_om_situasjonen_for_pite-_og_umesamisk_pa_norsk_side_av_sapmi.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="reektehtse_jih_webinaare_pijte-_jih_upmejesaemien_gieletsiehkien_bijre_saepmien_noorjen_bielesne.html"/>
        <parallel_text xml:lang="sme" location="raporta_ja_webinara_bihtan-_ja_ubmisamegielaid_dili_birra_norgga_beale_samis_.html"/>
