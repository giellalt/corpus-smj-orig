...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politihkka/valga/dutnje-gii-galggat-jienastit/jienastanvuoigatvuohta-samediggevalggaide/?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Jienastimriektá - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="stemmerett_ved_sametingsvalget.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="jienestimmiereakta.html"/>
        <parallel_text xml:lang="sme" location="jienastanvuoigatvuohta_samediggevalggaidde.html"/>
