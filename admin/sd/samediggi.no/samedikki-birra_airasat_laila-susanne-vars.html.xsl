...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Samedikki-birra/Airasat/Laila-Susanne-Vars'"/>
    ...
    <parallel_text xml:lang="sma" location="samedikki-birra_airasat_laila-susanne-vars.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_representanter_laila-susanne-vars.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_airasat_laila-susanne-vars.html"/></xsl:variable>
