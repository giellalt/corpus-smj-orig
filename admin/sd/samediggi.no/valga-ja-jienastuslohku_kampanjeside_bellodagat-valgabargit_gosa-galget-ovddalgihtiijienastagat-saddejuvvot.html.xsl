...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Valga-ja-jienastuslohku/Kampanjeside/Bellodagat-Valgabargit/Gosa-galget-ovddalgihtiijienastagat-saddejuvvot'"/>
    ...
    <parallel_text xml:lang="sma" location="veeljeme-jih-veeljemelaahkoe_kampanjeside_krirrieh-veeljemebarkijh_gaaabph-edtja-dejtie-aavtelhbodti-steemmide-seedtedh.html"/>
	<parallel_text xml:lang="nob" location="valg-og-manntall_kampanjeside_partier-valgmedarbeidere_hvor-skal-forhaandsstemmene-sendes.html"/>
	<parallel_text xml:lang="sme" location="valga-ja-jienastuslohku_kampanjeside_bellodagat-valgabargit_gosa-galget-ovddalgihtiijienastagat-saddejuvvot.html"/></xsl:variable>
