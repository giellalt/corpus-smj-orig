...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Girjeradju/Bibliotehka-birra'"/>
    ...
    <parallel_text xml:lang="sma" location="gaerjagaaetie_gaerjagaaetien-bijre.html"/>
	<parallel_text xml:lang="nob" location="bibliotek_om-biblioteket.html"/>
	<parallel_text xml:lang="sme" location="girjeradju_bibliotehka-birra.html"/></xsl:variable>
