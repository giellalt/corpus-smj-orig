...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Sammedikke-birra/Organisasjaavnaa-struktuvrra/Samedikkerade/Haala-ja-tjallaga/Veahkavaldi-nissonolbmuid-vuosta-mailmmiviidosas-ja-bakkalas-cuolbma'"/>
    ...
    <parallel_text xml:lang="sma" location="saemiedigkien-bijre_aaaarganisasjovnestruktuvre_saemiedigkieraerie_haaalemh-jih-tjaalegh_vaedtsoesvoete-nyjseni-voeoeste-akte-abpeveartenen-jih-lihkemes-daaeriesmoere.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_organisasjonsstruktur_sametingsraadet_taler-og-artikler_vold-mot-kvinner-et-globalt-og-lokalt-problem.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_organisasuvdnastruktuvra_samediggeraddi_sartnit-ja-artihkkalat_veahkavaldi-nissonolbmuid-vuosta-mailmmiviidosas-ja-bakkalas-cuolbma.html"/></xsl:variable>
