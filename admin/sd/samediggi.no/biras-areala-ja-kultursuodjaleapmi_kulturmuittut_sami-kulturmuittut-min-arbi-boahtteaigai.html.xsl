...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Biras-areala-ja-kultursuodjaleapmi/Kulturmuittut/Sami-kulturmuittut-min-arbi-boahtteaigai'"/>
    ...
    <parallel_text xml:lang="sma" location="byjrese-areale-jih-kultuvrevarjelimmie_kultuvremojhtesh_saemien-kultuvremojhtesh-mijjen-aerpie-baaetijen-aajkan.html"/>
	<parallel_text xml:lang="nob" location="miljoe-areal-og-kulturvern_kulturminner_samiske-kulturminner-vaar-arv-for-fremtiden.html"/>
	<parallel_text xml:lang="sme" location="biras-areala-ja-kultursuodjaleapmi_kulturmuittut_sami-kulturmuittut-min-arbi-boahtteaigai.html"/></xsl:variable>
