...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Praessadiedadus/Gaavvaagallerija'"/>
    ...
    <parallel_text xml:lang="sma" location="preessebievnesh_guvvievaaarhkoe.html"/>
	<parallel_text xml:lang="nob" location="presse_bildegalleri.html"/>
	<parallel_text xml:lang="sme" location="preassadiedahusat_govvavuorka.html"/></xsl:variable>
