...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Riikkaidgaskasas-bargu/Alta-2013/Haliidat-go-don-leat-mielde-markaniin'"/>
    ...
    <parallel_text xml:lang="sma" location="riikkaidgaskasas-bargu_alta-2013_haliidat-go-don-leat-mielde-markaniin.html"/>
	<parallel_text xml:lang="nob" location="internasjonalt-arbeid_alta-2013_vil-du-vaere-med-aa-lage-marked.html"/>
	<parallel_text xml:lang="sme" location="riikkaidgaskasas-bargu_alta-2013_haliidat-go-don-leat-mielde-markaniin.html"/></xsl:variable>
