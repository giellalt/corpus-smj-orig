...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Dokumeantta/Oza-assiid'"/>
    ...
    <parallel_text xml:lang="sma" location="tjaatsegh_ohtsedh-aamhtesh.html"/>
	<parallel_text xml:lang="nob" location="dokumenter_soek-etter-saker.html"/>
	<parallel_text xml:lang="sme" location="dokumeantta_oza-assiid.html"/></xsl:variable>
