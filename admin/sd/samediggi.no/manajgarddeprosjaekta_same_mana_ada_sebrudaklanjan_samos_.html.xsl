...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/barnehage/barnehageprosjektet-sami-manat-odda-searvelanjain-samos/?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Mánájgárddeprosjækta Sáme máná ådå sebrudaklanján (SáMOS) - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="barnehageprosjektet_sami_manat_odda_searvelanjain_samos_.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="maanagierteprosjekte_saemien_maanah_orre_ektietjiehtjielinie_samos_.html"/>
        <parallel_text xml:lang="sme" location="manaidgardeproseakta_sami_manat_odda_searvelanjain_samos_.html"/>
