...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Dearvvasvuohta-ja-sosiala/Sosiala/Buoret-cohkkandilalasvuodat-sapmelaccaide-geat-leat-giddagasas'"/>
    ...
    <parallel_text xml:lang="sma" location="healsoe-jih-sosijaale_sosijaale_buerebe-sovnedimmie-saemien-faangkide.html"/>
	<parallel_text xml:lang="nob" location="helse-og-sosial_sosial_bedre-soning-for-samiske-innsatte.html"/>
	<parallel_text xml:lang="sme" location="dearvvasvuohta-ja-sosiala_sosiala_buoret-cohkkandilalasvuodat-sapmelaccaide-geat-leat-giddagasas.html"/></xsl:variable>
