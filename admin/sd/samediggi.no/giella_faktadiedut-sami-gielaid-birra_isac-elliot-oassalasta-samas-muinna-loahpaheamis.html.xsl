...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Giella/Faktadiedut-sami-gielaid-birra/Isac-Elliot-oassalasta-Samas-muinna-loahpaheamis'"/>
    ...
    <parallel_text xml:lang="sma" location="giella_faktadiedut-sami-gielaid-birra_isac-elliot-oassalasta-samas-muinna-loahpaheamis.html"/>
	<parallel_text xml:lang="nob" location="spraak_fakta-om-samiske-spraak_isac-elliot-deltar-paa-samas-muinna-avslutningen.html"/>
	<parallel_text xml:lang="sme" location="giella_faktadiedut-sami-gielaid-birra_isac-elliot-oassalasta-samas-muinna-loahpaheamis.html"/></xsl:variable>
