...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Arkiv/Valgperiode-2009-2013/Artikler/Ovttas.no-bistevas-doaibma'"/>
    ...
    <parallel_text xml:lang="sma" location="arkiv_valgperiode-2009-2013_artikler_ovttas.no-bistevas-doaibma.html"/>
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_ovttas.no-permanent-drift.html"/>
	<parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_ovttas.no-bistevas-doaibma.html"/></xsl:variable>
