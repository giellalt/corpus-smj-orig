...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Biras-areala-ja-kultursuodjaleapmi/Stipeanda-ja-doarjja'"/>
    ...
    <parallel_text xml:lang="sma" location="biras-areala-ja-kultursuodjaleapmi_stipeanda-ja-doarjja.html"/>
	<parallel_text xml:lang="nob" location="miljoe-areal-og-kulturvern_stipend-og-tilskudd.html"/>
	<parallel_text xml:lang="sme" location="biras-areala-ja-kultursuodjaleapmi_stipeanda-ja-doarjja.html"/></xsl:variable>
