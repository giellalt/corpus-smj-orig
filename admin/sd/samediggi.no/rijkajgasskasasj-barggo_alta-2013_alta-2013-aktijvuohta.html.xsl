...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Rijkajgasskasasj-barggo/Alta-2013/Alta-2013-aktijvuohta'"/>
    ...
    <parallel_text xml:lang="sma" location="gaskenasjovnaale-barkoe_alta-2013_govlehtallh-alta-2013.html"/>
	<parallel_text xml:lang="nob" location="internasjonalt-arbeid_alta-2013_kontakt-alta-2013.html"/>
	<parallel_text xml:lang="sme" location="riikkaidgaskasas-bargu_alta-2013_oktavuohta-alta-2013.html"/></xsl:variable>
