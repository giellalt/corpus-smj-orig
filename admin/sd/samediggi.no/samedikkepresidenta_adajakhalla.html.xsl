...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametingspresidentens-nyttarstale.10179.aspx?sprak=15'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingspresidentens_nyttarstale_0_.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="saemiedigkiepresideenten_orrejaepiehaalome.html"/>
        <parallel_text xml:lang="sme" location="samediggepresideantta_oddajagisardni_0_.html"/>
