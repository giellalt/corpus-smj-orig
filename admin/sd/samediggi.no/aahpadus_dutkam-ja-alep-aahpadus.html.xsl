...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="lierehtimmie_dotkeme-jih-jollebe-oeoehpehtimmie.html"/>
	<parallel_text xml:lang="nob" location="opplaering_forskning-og-hoeyere-utdanning.html"/>
	<parallel_text xml:lang="sme" location="oahpahus_dutkan-ja-alit-oahpahus.html"/></xsl:variable>
