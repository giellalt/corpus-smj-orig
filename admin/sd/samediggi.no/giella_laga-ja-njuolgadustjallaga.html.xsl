...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Giella/Laga-ja-njuolgadustjallaga'"/>
    ...
    <parallel_text xml:lang="sma" location="giele_laakh-jih-mieriedimmieh.html"/>
	<parallel_text xml:lang="nob" location="spraak_lover-og-forskrifter.html"/>
	<parallel_text xml:lang="sme" location="giella_lagat-ja-lahkaasahusat.html"/></xsl:variable>
