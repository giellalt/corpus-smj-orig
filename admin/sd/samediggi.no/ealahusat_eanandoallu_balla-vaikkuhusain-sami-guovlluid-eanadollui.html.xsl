...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Eanandoallu/Balla-vaikkuhusain-sami-guovlluid-eanadollui'"/>
    ...
    <parallel_text xml:lang="sma" location="jielemh_jaaartaburrie_jaaartaburreste-baella-saemien-dajvine.html"/>
	<parallel_text xml:lang="nob" location="naeringer_jordbruk_frykter-for-jordbruket-i-samiske-omraader.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_eanandoallu_balla-vaikkuhusain-sami-guovlluid-eanadollui.html"/></xsl:variable>
