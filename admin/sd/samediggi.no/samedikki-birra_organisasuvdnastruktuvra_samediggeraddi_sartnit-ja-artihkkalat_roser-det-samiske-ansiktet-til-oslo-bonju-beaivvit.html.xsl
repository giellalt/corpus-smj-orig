...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Samedikki-birra/Organisasuvdnastruktuvra/Samediggeraddi/Sartnit-ja-artihkkalat/Roser-det-samiske-ansiktet-til-Oslo-Bonju-Beaivvit'"/>
	...
	<parallel_text xml:lang="nob" location="om-sametinget_organisasjonsstruktur_sametingsraadet_taler-og-artikler_roser-det-samiske-ansiktet-til-oslo-bonju-beaivvit.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_organisasuvdnastruktuvra_samediggeraddi_sartnit-ja-artihkkalat_roser-det-samiske-ansiktet-til-oslo-bonju-beaivvit.html"/></xsl:variable>
