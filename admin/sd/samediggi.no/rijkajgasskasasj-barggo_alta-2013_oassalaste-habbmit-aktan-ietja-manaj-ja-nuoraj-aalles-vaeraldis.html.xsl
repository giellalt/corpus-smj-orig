...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Rijkajgasskasasj-barggo/Alta-2013/Oassalaste-habbmit-aktan-ietja-manaj-ja-nuoraj-aalles-vaeraldis'"/>
    ...
    <parallel_text xml:lang="sma" location="gaskenasjovnaale-barkoe_alta-2013_aarroeh-meatan-sjugnedh-maanaj-jih-noerigujmie-ektine-abpe-veartenistie.html"/>
	<parallel_text xml:lang="nob" location="internasjonalt-arbeid_alta-2013_bli-med-aa-skape-sammen-med-barn-og-unge-fra-hele-verden.html"/>
	<parallel_text xml:lang="sme" location="riikkaidgaskasas-bargu_alta-2013_searvva-don-nai-hutkat-ovttas-eara-manaiguin-ja-nuoraiguin-miehta-mailmmi.html"/></xsl:variable>
