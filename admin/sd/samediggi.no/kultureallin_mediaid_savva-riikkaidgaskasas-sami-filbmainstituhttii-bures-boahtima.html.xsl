...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Kultureallin/Mediaid/Savva-Riikkaidgaskasas-Sami-Filbmainstituhttii-bures-boahtima'"/>
    ...
    <parallel_text xml:lang="sma" location="kultuvrejieleme_meedijah_gaskenasjovnaale-filmeinstituhtem-buerie-baaeteme-vaajtele.html"/>
	<parallel_text xml:lang="nob" location="kulturliv_medier_oensker-internasjonalt-samisk-filminstitutt-velkommen.html"/>
	<parallel_text xml:lang="sme" location="kultureallin_mediaid_savva-riikkaidgaskasas-sami-filbmainstituhttii-bures-boahtima.html"/></xsl:variable>
