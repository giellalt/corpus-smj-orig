...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/etablerer-stotteordning-for-kombinasjons-og-utmarksnaringer.17890.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dållat doarjjaårdnigav tjoahkke- ja ålggoednamæládusájda - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="etablerer_stotteordning_for_kombinasjons-_og_utmarksnaeringer.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="daarjoeoornegh_kombinasjovne-_jih_miehtjiesjieliemidie_tseegkie.html"/>
        <parallel_text xml:lang="sme" location="lotnolasealahusaide_ja_meahcceealahusaide_asahuvvo_doarjjaortnet.html"/>
