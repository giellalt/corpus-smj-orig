...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="jielemh_kulturejieleme_saemien-fealadassem-julevsaemien-dajvesne-daaarjohte.html"/>
	<parallel_text xml:lang="nob" location="naeringer_kulturnaering_stoetter-samisk-reiseliv-i-lulesamisk-omraade.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_kulturealahus_doarju-sami-matkeealahusaid-julevsami-guovllus.html"/></xsl:variable>
