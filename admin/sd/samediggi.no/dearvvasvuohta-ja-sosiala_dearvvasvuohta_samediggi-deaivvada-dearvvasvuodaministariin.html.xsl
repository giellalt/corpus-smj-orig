...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Dearvvasvuohta-ja-sosiala/Dearvvasvuohta/Samediggi-deaivvada-dearvvasvuodaministariin'"/>
    ...
    <parallel_text xml:lang="sma" location="healsoe-jih-sosijaale_healsoe_saemiedigkie-healsoeministerem-gaavnesje.html"/>
	<parallel_text xml:lang="nob" location="helse-og-sosial_helse_sametinget-moeter-helseminister.html"/>
	<parallel_text xml:lang="sme" location="dearvvasvuohta-ja-sosiala_dearvvasvuohta_samediggi-deaivvada-dearvvasvuodaministariin.html"/></xsl:variable>
