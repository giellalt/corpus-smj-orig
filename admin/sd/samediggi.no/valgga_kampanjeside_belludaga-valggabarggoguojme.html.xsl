...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Valgga/Kampanjeside/Belludaga-Valggabarggoguojme'"/>
    ...
    <parallel_text xml:lang="sma" location="veeljeme-jih-veeljemelaahkoe_kampanjeside_krirrieh-veeljemebarkijh.html"/>
	<parallel_text xml:lang="nob" location="valg-og-manntall_kampanjeside_partier-valgmedarbeidere.html"/>
	<parallel_text xml:lang="sme" location="valga-ja-jienastuslohku_kampanjeside_bellodagat-valgabargit.html"/></xsl:variable>
