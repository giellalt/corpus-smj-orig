...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Sammedikke-birra/Duogasj'"/>
    ...
    <parallel_text xml:lang="sma" location="saemiedigkien-bijre_sjieke.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_bakgrunn.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_duogas.html"/></xsl:variable>
