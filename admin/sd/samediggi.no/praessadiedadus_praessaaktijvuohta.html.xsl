...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Praessadiedadus/Praessaaktijvuohta'"/>
    ...
    <parallel_text xml:lang="sma" location="preessebievnesh_preessegovlehtallijh.html"/>
	<parallel_text xml:lang="nob" location="presse_pressekontakter.html"/>
	<parallel_text xml:lang="sme" location="preassadiedahusat_preassaoktavuodat.html"/></xsl:variable>
