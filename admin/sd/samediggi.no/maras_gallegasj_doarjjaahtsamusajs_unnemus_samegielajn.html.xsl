...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/bekymret-over-fa-tilskuddssoknader-fra-de-minste-samiske-sprakene.11608.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Mårås gallegasj doarjjaåhtsåmusájs unnemus sámegielajn - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="bekymret_over_fa_tilskuddssoknader_fra_de_minste_samiske_sprakene.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="tjoeperde_vaenie_daarjoeohtsemijstie_dejtie_unnemes_saemien_gielijste.html"/>
        <parallel_text xml:lang="sme" location="fuolas_go_unnan_doarjjaohcamusat_bohtet_smavimus_sami_gielain.html"/>
