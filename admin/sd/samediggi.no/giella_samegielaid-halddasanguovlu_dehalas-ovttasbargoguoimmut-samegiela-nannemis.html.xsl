...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Giella/Samegielaid-halddasanguovlu/Dehalas-ovttasbargoguoimmut-samegiela-nannemis'"/>
    ...
    <parallel_text xml:lang="sma" location="giele_reeremedajve-saemien-gielide_vihkeles-laavenjostoeguejmieh-saemien-gielenaennoestehtemebarkosne.html"/>
	<parallel_text xml:lang="nob" location="spraak_forvaltningsomraade_viktige-samarbeidspartnere-i-arbeidet-for-aa-styrke-samisk-spraak.html"/>
	<parallel_text xml:lang="sme" location="giella_samegielaid-halddasanguovlu_dehalas-ovttasbargoguoimmut-samegiela-nannemis.html"/></xsl:variable>
