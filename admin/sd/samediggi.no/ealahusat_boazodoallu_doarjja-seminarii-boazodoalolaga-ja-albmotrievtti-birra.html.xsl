...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Boazodoallu/Doarjja-seminarii-boazodoalolaga-ja-albmotrievtti-birra'"/>
    ...
    <parallel_text xml:lang="sma" location="jielemh_baaatsoe_daaarjoe-seminaarese-baaatsoelaaken-jih-almetjereaktan-bijre.html"/>
	<parallel_text xml:lang="nob" location="naeringer_reindrift_tilskudd-til-seminar-om-reindriftsloven-og-folkeretten.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_boazodoallu_doarjja-seminarii-boazodoalolaga-ja-albmotrievtti-birra.html"/></xsl:variable>
