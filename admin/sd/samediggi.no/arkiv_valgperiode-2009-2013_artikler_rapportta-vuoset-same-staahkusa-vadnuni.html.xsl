...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Arkiv/Valgperiode-2009-2013/Artikler/Rapportta-vuoset-same-staahkusa-vadnuni'"/>
    ...
    <parallel_text xml:lang="sma" location="vaaarhkoe_veeljemeboelhken-2009-2013_tjaalegh_saemien-staaaakegaevnieh-faaaatesieh-reektehtse-vuesehte.html"/>
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_mangel-paa-samiske-leker-viser-rapport.html"/>
	<parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_raporta-cajeha-ahte-sami-stoahkanhearvvat-vailot.html"/></xsl:variable>
