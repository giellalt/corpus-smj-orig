...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Giella/Faktadiedut-sami-gielaid-birra/Stuorra-vuordamusat-sami-giellalavdegoddai'"/>
    ...
    <parallel_text xml:lang="sma" location="giele_bievnesh-saemien-gieli-bijre_jolle-veanhtadimmieh-saemien-gielemoenehtsasse.html"/>
	<parallel_text xml:lang="nob" location="spraak_fakta-om-samiske-spraak_hoeye-forventninger-til-samisk-spraakutvalg.html"/>
	<parallel_text xml:lang="sme" location="giella_faktadiedut-sami-gielaid-birra_stuorra-vuordamusat-sami-giellalavdegoddai.html"/></xsl:variable>
