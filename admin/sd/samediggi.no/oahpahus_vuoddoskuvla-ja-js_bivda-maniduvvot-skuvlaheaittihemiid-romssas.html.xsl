...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Oahpahus/Vuoddoskuvla-ja-JS/Bivda-maniduvvot-skuvlaheaittihemiid-Romssas'"/>
    ...
    <parallel_text xml:lang="sma" location="oahpahus_vuoddoskuvla-ja-js_bivda-maniduvvot-skuvlaheaittihemiid-romssas.html"/>
	<parallel_text xml:lang="nob" location="opplaering_grunnskole-og-vgs_ber-om-utsettelse-for-skolekutt-i-tromsoe.html"/>
	<parallel_text xml:lang="sme" location="oahpahus_vuoddoskuvla-ja-js_bivda-maniduvvot-skuvlaheaittihemiid-romssas.html"/></xsl:variable>
