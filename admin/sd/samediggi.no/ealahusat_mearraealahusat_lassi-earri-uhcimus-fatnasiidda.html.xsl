...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Mearraealahusat/Lassi-earri-uhcimus-fatnasiidda'"/>
    ...
    <parallel_text xml:lang="sma" location="ealahusat_mearraealahusat_lassi-earri-uhcimus-fatnasiidda.html"/>
	<parallel_text xml:lang="nob" location="naeringer_marine-naeringer_mer-kvote-til-de-minste-fartoeyene.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_mearraealahusat_lassi-earri-uhcimus-fatnasiidda.html"/></xsl:variable>
