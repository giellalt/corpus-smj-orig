...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="laante-jih-vierhtiereaktah_goeoelemereakta.html"/>
	<parallel_text xml:lang="nob" location="land-og-ressursrettigheter_fiskerettigheter.html"/>
	<parallel_text xml:lang="sme" location="eatnan-ja-resursavuoigatvuodat_bivdovuoigatvuohta.html"/></xsl:variable>
