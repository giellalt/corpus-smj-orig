...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Arkiv/Valgperiode-2009-2013/Artikler/Tar-ansvar-for-det-soersamiske-spraaket'"/>
	...
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_tar-ansvar-for-det-soersamiske-spraaket.html"/>
	<parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_tar-ansvar-for-det-soersamiske-spraaket.html"/></xsl:variable>
