...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Boazodoallu/Gulahallancoahkkimat-boazodoaluin'"/>
    ...
    <parallel_text xml:lang="sma" location="jielemh_baaatsoe_dialogetjaaanghkoeh-baaatsojne.html"/>
	<parallel_text xml:lang="nob" location="naeringer_reindrift_dialogmoeter-med-reindriftsnaeringen.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_boazodoallu_gulahallancoahkkimat-boazodoaluin.html"/></xsl:variable>
