...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Sammedikke-birra/Samediggeviesso/Samedikkev-guossidit'"/>
    ...
    <parallel_text xml:lang="sma" location="saemiedigkien-bijre_saemiedigkiegaaetie_guessine-minnedh-saemiedigkesne.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_sametingsbygningen_besoeke-sametinget.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_samediggevisti_samedikki-galledeapmi.html"/></xsl:variable>
