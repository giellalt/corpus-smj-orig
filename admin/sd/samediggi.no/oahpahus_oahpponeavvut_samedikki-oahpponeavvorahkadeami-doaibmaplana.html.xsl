...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Oahpahus/Oahpponeavvut/Samedikki-oahpponeavvorahkadeami-doaibmaplana'"/>
    ...
    <parallel_text xml:lang="sma" location="oahpahus_oahpponeavvut_samedikki-oahpponeavvorahkadeami-doaibmaplana.html"/>
	<parallel_text xml:lang="nob" location="opplaering_laeremidler_sametingets-handlingsplan-for-utvikling-av-laeremidler.html"/>
	<parallel_text xml:lang="sme" location="oahpahus_oahpponeavvut_samedikki-oahpponeavvorahkadeami-doaibmaplana.html"/></xsl:variable>
