...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Giella/Spraakteknologi'"/>
    ...
    <parallel_text xml:lang="sma" location="giele_gieleteknologije.html"/>
	<parallel_text xml:lang="nob" location="spraak_spraakteknologi.html"/>
