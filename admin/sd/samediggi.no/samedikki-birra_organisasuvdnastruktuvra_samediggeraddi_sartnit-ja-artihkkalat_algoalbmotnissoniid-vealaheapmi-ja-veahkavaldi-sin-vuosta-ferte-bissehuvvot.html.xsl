...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Samedikki-birra/Organisasuvdnastruktuvra/Samediggeraddi/Sartnit-ja-artihkkalat/Algoalbmotnissoniid-vealaheapmi-ja-veahkavaldi-sin-vuosta-ferte-bissehuvvot'"/>
    ...
    <parallel_text xml:lang="sma" location="saemiedigkien-bijre_aaaarganisasjovnestruktuvre_saemiedigkieraerie_haaalemh-jih-tjaalegh_sierredimmie-jih-vaedtsoesvoete-aalkoealmetjenyjseni-voeoeste-tjuara-naahkedh.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_organisasjonsstruktur_sametingsraadet_taler-og-artikler_diskriminering-og-vold-mot-urfolkskvinner-maa-stoppes.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_organisasuvdnastruktuvra_samediggeraddi_sartnit-ja-artihkkalat_algoalbmotnissoniid-vealaheapmi-ja-veahkavaldi-sin-vuosta-ferte-bissehuvvot.html"/></xsl:variable>
