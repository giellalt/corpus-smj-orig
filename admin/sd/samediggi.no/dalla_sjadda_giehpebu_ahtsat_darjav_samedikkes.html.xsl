...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/na-blir-det-enklere-a-soke-tilskudd-fra-sametinget.16086.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dálla sjaddá giehpebu åhtsåt dårjav Sámedikkes - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="na_blir_det_enklere_a_soke_tilskudd_fra_sametinget_.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="daelie_aelhkebe_sjaedta_daarjoem_saemiedigkeste_ohtsedh.html"/>
        <parallel_text xml:lang="sme" location="dal_sadda_alkibun_ohcat_doarjaga_samedikkis_.html"/>
