...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Oahpahus/Dutkan-ja-alit-oahpahus/Eanet-oahpaheaddjit'"/>
    ...
    <parallel_text xml:lang="sma" location="oahpahus_dutkan-ja-alit-oahpahus_eanet-oahpaheaddjit.html"/>
	<parallel_text xml:lang="nob" location="opplaering_forskning-og-hoeyere-utdanning_flere-laerere.html"/>
	<parallel_text xml:lang="sme" location="oahpahus_dutkan-ja-alit-oahpahus_eanet-oahpaheaddjit.html"/></xsl:variable>
