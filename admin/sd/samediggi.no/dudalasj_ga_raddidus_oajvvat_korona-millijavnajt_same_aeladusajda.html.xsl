...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/fornoyd-med-at-regjeringen-foreslar-koronamillioner-til-samisk-naringsliv.10818.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dudálasj gå ráddidus oajvvat korona-millijåvnåjt sáme æládusájda - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="fornoyd_med_at_regjeringen_foreslar_koronamillioner_til_samisk_naeringsliv.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="madtjeles_reerenasse_koronavierhtieh_saemien_jieliemasse_raereste.html"/>
        <parallel_text xml:lang="sme" location="duhtavas_go_raddehus_evttoha_korona-miljovnnaid_sami_ealahusaide.html"/>
