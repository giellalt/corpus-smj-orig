...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samedigge.no/AAdaasa/Samedigge-diedet-AN-j-luonndoietjajduhttema-harraj'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámedigge diedet AN:j luonndoietjájduhttema hárráj'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget-rapporterer-til-fn-om-naturinngrep.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="saemiedigkie-eatnemeskilkehtassi-bijre-en-se-reektie.html"/>
        <parallel_text xml:lang="sme" location="samediggi-raportere-on-i-luonddulihkahallamiid-birra.html"/>
