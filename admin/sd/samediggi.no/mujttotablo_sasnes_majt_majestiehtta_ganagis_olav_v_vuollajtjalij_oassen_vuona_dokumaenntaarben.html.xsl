...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/mojhtesetaavla-skaerreste-maam-majesteete-ganka-olav-v-vuelietjaaleme-goh-bielie-noorjen-dokumenteaerpeste.9167.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Mujttotáblo sasnes majt Majestiehtta Gånågis Olav V vuollájtjálij oassen Vuona dokumænntaárben - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="minnetavle_av_sisti_signert_av_h_m__kong_olav_v_som_en_del_av_norges_dokumentarv.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="mojhtesetaavla_skaerreste_maam_majesteete_ganka_olav_v_vuelietjaaleme_goh_bielie_noorjen_dokumenteaerpeste_.html"/>
        <parallel_text xml:lang="sme" location="muitotavval_sisttis_maid_majestehtalas_gonagas_olav_v_vuollaicalii_oassin_norgga_dokumeantaarbbis.html"/>
