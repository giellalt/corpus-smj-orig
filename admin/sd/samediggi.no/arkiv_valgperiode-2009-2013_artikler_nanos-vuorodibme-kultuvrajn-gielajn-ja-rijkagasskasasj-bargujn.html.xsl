...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Arkiv/Valgperiode-2009-2013/Artikler/Nanos-vuorodibme-kultuvrajn-gielajn-ja-rijkagasskasasj-bargujn'"/>
    ...
    <parallel_text xml:lang="sma" location="vaaarhkoe_veeljemeboelhken-2009-2013_tjaalegh_naennoes-skreejreme-kultuvrese-gielese-jih-gaskenasjovnaale-barkose.html"/>
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_sterk-satsning-paa-kultur-spraak-og-internasjonal-arbeid.html"/>
	<parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_nana-angirussamat-kultuvrras-gielas-ja-riikkaidgaskasas-barggus.html"/></xsl:variable>
