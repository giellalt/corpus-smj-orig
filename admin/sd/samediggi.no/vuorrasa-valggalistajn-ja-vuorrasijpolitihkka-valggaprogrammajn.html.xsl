...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samedigge.no/AAdaasa/Vuorrasa-valggalistajn-ja-vuorrasijpolitihkka-valggaprogrammajn'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Vuorrasa válggalistajn ja vuorrasijpolitihkka válggaprográmmajn'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="eldre-paa-valglister-og-eldrepolitikk-i-valgprogrammene.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="voeresh-veeljemelaestojne-jih-voeresepolitihke-veeljemeprogrammine.html"/>
        <parallel_text xml:lang="sme" location="vuorrasat-valgalisttuin-ja-vuorrasiidpolitihkka-valgaprogrammain.html"/>
