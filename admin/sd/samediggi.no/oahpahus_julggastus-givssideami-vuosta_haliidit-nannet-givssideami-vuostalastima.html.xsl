...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Oahpahus/Julggastus-givssideami-vuosta/Haliidit-nannet-givssideami-vuostalastima'"/>
    ...
    <parallel_text xml:lang="sma" location="oahpahus_julggastus-givssideami-vuosta_haliidit-nannet-givssideami-vuostalastima.html"/>
	<parallel_text xml:lang="nob" location="opplaering_arbeidet-mot-mobbing_styrket-kamp-mot-mobbing.html"/>
	<parallel_text xml:lang="sme" location="oahpahus_julggastus-givssideami-vuosta_haliidit-nannet-givssideami-vuostalastima.html"/></xsl:variable>
