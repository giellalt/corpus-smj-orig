...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametinget-videreforer-samisk-sprakuke-bli-med-du-ogsa.14253.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámedigge joarkká Giellavahkov, oassálasste dån aj! - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametinget_videreforer_samisk_sprakuke_bli_med_du_ogsa_.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="saemiedigkie_saemien_gielevahkojne_jaarhka_daeredh_datne_aaj_.html"/>
        <parallel_text xml:lang="sme" location="samediggi_joatka_sami_giellavahkkuin_searvva_don_maid_.html"/>
