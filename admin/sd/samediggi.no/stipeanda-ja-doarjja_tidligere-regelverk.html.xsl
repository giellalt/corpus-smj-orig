...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Stipeanda-ja-doarjja/Tidligere-regelverk'"/>
    ...
    <parallel_text xml:lang="sma" location="stipeanda-ja-doarjja_tidligere-regelverk.html"/>
	<parallel_text xml:lang="nob" location="stipend-og-tilskudd_tidligere-regelverk.html"/>
	<parallel_text xml:lang="sme" location="stipeanda-ja-doarjja_tidligere-regelverk.html"/></xsl:variable>
