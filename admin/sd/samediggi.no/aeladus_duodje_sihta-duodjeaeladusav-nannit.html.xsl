...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="jielemh_duedtie_saejhta-duedtiejielemem-naennoestehtedh.html"/>
	<parallel_text xml:lang="nob" location="naeringer_duodji_vil-styrke-duodjinaeringen.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_duodji_haliida-nannet-duodjeealahusa.html"/></xsl:variable>
