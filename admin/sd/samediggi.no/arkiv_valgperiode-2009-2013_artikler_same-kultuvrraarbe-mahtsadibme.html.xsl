...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Arkiv/Valgperiode-2009-2013/Artikler/Same-kultuvrraarbe-mahtsadibme'"/>
    ...
    <parallel_text xml:lang="sma" location="vaaarhkoe_veeljemeboelhken-2009-2013_tjaalegh_baaaastedefoeresjimmie-saemien-kultuvreaerpeste.html"/>
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_samisk-kulturarv.html"/>
	<parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_kulturarbi-ruovttolutta.html"/></xsl:variable>
