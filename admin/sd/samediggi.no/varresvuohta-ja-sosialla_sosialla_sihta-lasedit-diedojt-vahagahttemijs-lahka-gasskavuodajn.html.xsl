...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Varresvuohta-ja-sosialla/Sosialla/Sihta-lasedit-diedojt-vahagahttemijs-lahka-gasskavuodajn'"/>
    ...
    <parallel_text xml:lang="sma" location="healsoe-jih-sosijaale_sosijaale_saejhta-daajroem-lissiehtidh-vaedtsoesvoeten-bijre-lihke-fuelhkine.html"/>
	<parallel_text xml:lang="nob" location="helse-og-sosial_sosial_vil-oeke-kunnskapen-om-vold-i-naere-relasjoner.html"/>
	<parallel_text xml:lang="sme" location="dearvvasvuohta-ja-sosiala_sosiala_haliidit-buoridit-mahtu-veahkavalddi-birra-lagas-oktavuodain.html"/></xsl:variable>
