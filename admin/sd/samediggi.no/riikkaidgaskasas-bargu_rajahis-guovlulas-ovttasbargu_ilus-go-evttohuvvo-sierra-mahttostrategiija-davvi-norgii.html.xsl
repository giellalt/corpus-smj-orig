...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Riikkaidgaskasas-bargu/Rajahis-guovlulas-ovttasbargu/Ilus-go-evttohuvvo-sierra-mahttostrategiija-Davvi-Norgii'"/>
    ...
    <parallel_text xml:lang="sma" location="gaskenasjovnaale-barkoe_raastendaaaresth-regijovnaale-laavenjostoe_veanhta-hijven-aktine-jijtse-daajroestrategijine-noerhte-noeoerjese.html"/>
	<parallel_text xml:lang="nob" location="internasjonalt-arbeid_grenseoverskridende-regionalt-samarbeid_positiv-til-egen-kunnskapsstrategi-for-nord-norge.html"/>
	<parallel_text xml:lang="sme" location="riikkaidgaskasas-bargu_rajahis-guovlulas-ovttasbargu_ilus-go-evttohuvvo-sierra-mahttostrategiija-davvi-norgii.html"/></xsl:variable>
