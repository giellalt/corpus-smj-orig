...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samedigge.no/AAdaasa/PRD-Boatsojaeladusstivrra-haehttu-rievddaduvvat'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRD: Boatsojæládusstivrra hæhttu rievddaduvvat'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm-reindriftsstyret-maa-endres.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="prm-baaatsoestaavroe-tjuara-jeatjahtovvedh.html"/>
        <parallel_text xml:lang="sme" location="prd-boazodoallostivra-ferte-rievdaduvvot.html"/>
