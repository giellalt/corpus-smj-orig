...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Kultureallin/Falastallan/Gilvalit-golli-Alaskas'"/>
    ...
    <parallel_text xml:lang="sma" location="kultuvrejieleme_gaarsjelimmie_gullien-aavteste-tjuejkieh-alaskesne.html"/>
	<parallel_text xml:lang="nob" location="kulturliv_idrett_gaar-for-gull-i-alaska.html"/>
	<parallel_text xml:lang="sme" location="kultureallin_falastallan_gilvalit-golli-alaskas.html"/></xsl:variable>
