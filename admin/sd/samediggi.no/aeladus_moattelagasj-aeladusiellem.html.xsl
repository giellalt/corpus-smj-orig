...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="jielemh_gellielaaketje-jielemh.html"/>
	<parallel_text xml:lang="nob" location="naeringer_variert-naeringsliv.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_manggalagan-ealahusdoaibma.html"/></xsl:variable>
