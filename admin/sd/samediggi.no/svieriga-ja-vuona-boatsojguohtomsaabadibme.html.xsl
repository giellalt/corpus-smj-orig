...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/AEladus/Boatsojaeladus/Svieriga-ja-Vuona-boatsojguohtomsaabadibme'"/>
    ...
    <parallel_text location="norgga-ruota-boazoguohtunkonvensuvdna.html" xml:lang="sme"/>
<parallel_text location="norsk-svensk-reinbeitekonvensjon.html" xml:lang="nob"/>
</xsl:variable>
