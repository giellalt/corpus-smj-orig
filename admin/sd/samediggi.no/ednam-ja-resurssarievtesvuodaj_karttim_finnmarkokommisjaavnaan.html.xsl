...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ednam-ja-resurssarievtesvuodaj/Karttim/Finnmarkokommisjaavnaan'"/>
    ...
    <parallel_text xml:lang="sma" location="laante-jih-vierhtiereaktah_goerehtalleme_finnmaarhkekommisjovne.html"/>
	<parallel_text xml:lang="nob" location="land-og-ressursrettigheter_kartlegging_finnmarkskommisjonen.html"/>
	<parallel_text xml:lang="sme" location="eatnan-ja-resursavuoigatvuodat_karten_finnmarkokommisuvdna.html"/></xsl:variable>
