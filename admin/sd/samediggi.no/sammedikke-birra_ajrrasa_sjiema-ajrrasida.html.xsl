...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Sammedikke-birra/Ajrrasa/Sjiema-ajrrasida'"/>
    ...
    <parallel_text xml:lang="sma" location="saemiedigkien-bijre_tjirkijh_tjirkijidie.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_representanter_skjema-for-folkevalgte.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_airasat_skovit-airasiidda.html"/></xsl:variable>
