...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Valgga-ja-jienastuslaahkuj'"/>
    ...
    <parallel_text location="valga-ja-jienastuslohku.html" xml:lang="sme"/>
<parallel_text location="valg-og-manntall.html" xml:lang="nob"/>
<parallel_text location="veeljeme-jih-veeljemelaahkoe.html" xml:lang="sma"/>
</xsl:variable>
