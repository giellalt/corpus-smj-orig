...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Samedikki-birra/Airasat/Samediggi-giehtagirji'"/>
    ...
    <parallel_text xml:lang="sma" location="saemiedigkien-bijre_tjirkijh_saemiedigkien-gietegaerja.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_representanter_sametingets-haandbok.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_airasat_samediggi-giehtagirji.html"/></xsl:variable>
