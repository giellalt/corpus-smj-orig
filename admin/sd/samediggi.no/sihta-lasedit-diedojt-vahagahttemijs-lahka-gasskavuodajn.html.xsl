...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="vil-oeke-kunnskapen-om-vold-i-naere-relasjoner.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="saejhta-daajroem-lissiehtidh-vaedtsoesvoeten-bijre-lihke-fuelhkine.html"/>
        <parallel_text xml:lang="sme" location="haliidit-buoridit-mahtu-veahkavalddi-birra-lagas-oktavuodain.html"/>
