...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/prd-giellaloktenbalkkasupmi-2022-aage-solbakkii.22512.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRD: 2022 Giellalåpptimbálká vuojtte Aage Solbakk - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm:_sprakloftprisen_2022_til_aage_solbakk.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="prm:_gielelutnjemebaalhka_2022_aage_solbakkese.html"/>
        <parallel_text xml:lang="sme" location="prd:_giellaloktenbalkkasupmi_2022_aage_solbakkii.html"/>
