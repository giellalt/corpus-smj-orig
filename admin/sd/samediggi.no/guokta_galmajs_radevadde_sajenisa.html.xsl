...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/to-av-tre-politiske-radgivere-pa-plass.17329.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Guokta gålmåjs rádevadde sajenisá - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="to_av_tre_politiske_radgivere_pa_plass.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="gookte_allesth_golme_politihkeles_raeriestaejjijste_nammoehtamme.html"/>
        <parallel_text xml:lang="sme" location="guovttis_golmma_politihkalas_raddeaddis_leat_sajis.html"/>
