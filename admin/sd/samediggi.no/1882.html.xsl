...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/content/view/full/1882'"/>
    ...
    <parallel_text location="1882.html" xml:lang="sme"/>
<parallel_text location="1882.html" xml:lang="sma"/>
<parallel_text location="1882.html" xml:lang="nob"/>
</xsl:variable>
