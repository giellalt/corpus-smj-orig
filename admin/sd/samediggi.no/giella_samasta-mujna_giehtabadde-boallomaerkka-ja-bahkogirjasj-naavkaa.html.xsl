...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="giele_saemesth-munnjien_aaadtjoeh-namhtah-gietebaantem-baaaloem-jih-baakoegaerjetjem.html"/>
	<parallel_text xml:lang="nob" location="spraak_snakk-samisk-te-mae_bestill-gratis-lommeparloer-armbaand-og-buttons.html"/>
	<parallel_text xml:lang="sme" location="giella_samas-muinna_oacco-nuvtta-giehtabatti-boallomearkka-ja-satnegirjjaza.html"/></xsl:variable>
