...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samedigge.no/Dievnastusa/Opplaering-og-laeremidler/Dalla-oattjo-superstipendav'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dálla oattjo superstipendav'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="klart-for-superstipend.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="daelie-superstipendem-aaadtjoeh.html"/>
        <parallel_text xml:lang="sme" location="dal-oaccut-superstipeandda.html"/>
