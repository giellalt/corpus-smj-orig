...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samedigge.no/AAdaasa/Julevsame-ja-gielldasame-vuojtte-Gaallegiella-balkas'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Julevsáme ja gielldasáme vuojtte Gållegiella-bálkás'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="lulesamisk-og-kildinsamisk-vinnere-av-gollegiella-prisen.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="julevsaemien-jih-kildinsaemien-vitnijh-gulliegiele-baalhkeste.html"/>
        <parallel_text xml:lang="sme" location="julevsami-ja-gielddasami-gollegiellabalkkasumi-vuoitit.html"/>
