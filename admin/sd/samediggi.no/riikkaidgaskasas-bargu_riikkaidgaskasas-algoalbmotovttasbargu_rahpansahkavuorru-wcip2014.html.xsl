...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Riikkaidgaskasas-bargu/Riikkaidgaskasas-algoalbmotovttasbargu/Rahpansahkavuorru-WCIP2014'"/>
    ...
    <parallel_text xml:lang="sma" location="gaskenasjovnaale-barkoe_gaskenasjovnaale-aalkoealmetjelaavenjostoe_aalkoehaaaleme-wcip-2014.html"/>
	<parallel_text xml:lang="nob" location="internasjonalt-arbeid_internasjonalt-urfolkssamarbeid_aapningsinnlegg-wcip2014.html"/>
	<parallel_text xml:lang="sme" location="riikkaidgaskasas-bargu_riikkaidgaskasas-algoalbmotovttasbargu_rahpansahkavuorru-wcip2014.html"/></xsl:variable>
