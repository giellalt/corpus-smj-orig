...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <parallel_text location="presidenten-gratulerer-den-nye-biskopen.html" xml:lang="nob"/>
<parallel_text location="presideanta-savva-lihku-odda-bismii.html" xml:lang="sme"/>
</xsl:variable>
