...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/igangsetter-bedriftsutviklingsprogram-for-lokale-matserveringssteder.12509.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Álgat vidnudakåvddånahttemprográmmav bájkálasj biebbmofáladiddjijda - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="igangsetter_bedriftsutviklingsprogram_for_lokale_matserveringssteder.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="sielteevtiedimmieprogrammine_voenges_beapmoegaassoehtimmiesijjide_nearhka.html"/>
        <parallel_text xml:lang="sme" location="alggaha_fitnodatovddidanprogramma_baikkalas_biebmoguossohansajiide.html"/>
