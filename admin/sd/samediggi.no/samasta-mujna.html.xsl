...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Giella/Samasta-mujna'"/>
    ...
    <parallel_text location="snakk-samisk-te-mae.html" xml:lang="nob"/>
<parallel_text location="samas-muinna.html" xml:lang="sme"/>
<parallel_text location="saemesth-munnjien.html" xml:lang="sma"/>
</xsl:variable>
