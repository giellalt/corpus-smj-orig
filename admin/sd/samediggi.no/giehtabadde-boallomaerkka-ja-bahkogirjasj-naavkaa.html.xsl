...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Giella/Samasta-mujna/Giehtabadde-boallomaerkka-ja-bahkogirjasj-naavkaa'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="bestill-gratis-lommeparloer-armbaand-og-buttons.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="aaadtjoeh-namhtah-gietebaantem-baaaloem-jih-baakoegaerjetjem.html"/>
        <parallel_text xml:lang="sme" location="oacco-nuvtta-giehtabatti-boallomearkka-ja-satnegirjjaza.html"/>
