...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samedigge.no/Daarja-ja-stipenda/Arbbedabalasj-mahttu-vuodoaahpadusaj'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Árbbedábálasj máhttu vuodoåhpadusaj'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="tradisjonell-kunnskap-i-grunnopplaeringen.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="aerpievuekien-daajroe-maadthlierehtimmesne.html"/>
        <parallel_text xml:lang="sme" location="arbediehtu-vuoddooahpahusas.html"/>
