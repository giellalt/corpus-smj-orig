...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Dokumeantta/Oza-poastajournalas'"/>
    ...
    <parallel_text xml:lang="sma" location="tjaatsegh_ohtsedh-paaastejournalesne.html"/>
	<parallel_text xml:lang="nob" location="dokumenter_soek-i-postjournalen.html"/>
	<parallel_text xml:lang="sme" location="dokumeantta_oza-poastajournalas.html"/></xsl:variable>
