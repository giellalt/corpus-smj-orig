...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samedigge.no/Valgga/Samedikke-jienastuslaagov-bihkusij-buktet'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámedikke jienastuslågov bihkusij buktet'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="utlegging-av-sametingets-valgmanntall.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="baejhkoehtimmie-saemiedigkien-veeljemelaahkoste.html"/>
        <parallel_text xml:lang="sme" location="samedikki-valgajienastuslogu-almmuheapmi.html"/>
