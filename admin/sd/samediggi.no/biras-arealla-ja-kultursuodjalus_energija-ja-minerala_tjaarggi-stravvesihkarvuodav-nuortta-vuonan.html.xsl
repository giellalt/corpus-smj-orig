...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Biras-arealla-ja-kultursuodjalus/Energija-ja-minerala/Tjaarggi-stravvesihkarvuodav-Nuortta-Vuonan'"/>
    ...
    <parallel_text xml:lang="sma" location="byjrese-areale-jih-kultuvrevarjelimmie_energije-jih-mineraalh_elfaamoejearsoesvoetem-noerhte-noeoerjesne-gorrede.html"/>
	<parallel_text xml:lang="nob" location="miljoe-areal-og-kulturvern_energi-og-mineraler_sikrer-kraftsikkerheten-i-nord-norge.html"/>
	<parallel_text xml:lang="sme" location="biras-areala-ja-kultursuodjaleapmi_energiija-ja-mineralat_sihkkarasta-elfapmosihkkarvuoda-davvi-norggas.html"/></xsl:variable>
