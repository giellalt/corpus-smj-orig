...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Sammedikke-birra/Samediggeviesso/Dajdda-Samedikketsiekkadusan'"/>
    ...
    <parallel_text xml:lang="sma" location="saemiedigkien-bijre_saemiedigkiegaaetie_tjeahpoeh-saemiedigkiegaaetesne.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_sametingsbygningen_kunst-i-sametingsbygningen.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_samediggevisti_daidda-samediggeviesus.html"/></xsl:variable>
