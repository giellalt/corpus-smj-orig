...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/hasot-gajkajt-oassalasstet-sommerles-an.32547.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Hasot gájkajt oassálasstet Sommerles:an - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="oppfordrer_alle_til_a_delta_pa_sommerles.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="gaajhkesidie_haasta_meatan_arrodh_sommerles-kampanjesne.html"/>
        <parallel_text xml:lang="sme" location="avzzuhat_buohkaid_searvat_sommerles_lohkankampanjii.html"/>
