...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Boazodoallu/Oaivvilda-ahte-Listhaug-ain-sahtta-njulget-boasttuvuoda'"/>
    ...
    <parallel_text xml:lang="sma" location="jielemh_baaatsoe_veanhta-listhaug-annje-maahta-skaaram-davvodh.html"/>
	<parallel_text xml:lang="nob" location="naeringer_reindrift_mener-listhaug-enda-kan-rette-opp-skaden.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_boazodoallu_oaivvilda-ahte-listhaug-ain-sahtta-njulget-boasttuvuoda.html"/></xsl:variable>
