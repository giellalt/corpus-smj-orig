...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Giella/Diedo-samegielaj-birra/Gaalmaas-Gaallegiella-balkav-vuojtti'"/>
    ...
    <parallel_text xml:lang="sma" location="giele_bievnesh-saemien-gieli-bijre_golme-vitnijh-gulliegielebaalhkeste.html"/>
	<parallel_text xml:lang="nob" location="spraak_fakta-om-samiske-spraak_tre-vinnere-av-gollegiella-prisen.html"/>
	<parallel_text xml:lang="sme" location="giella_faktadiedut-sami-gielaid-birra_golbma-gollegiellabalkkasumi-vuoiti.html"/></xsl:variable>
