...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/gavdnojit-dusse-ovttaarvosas-ja-doarvai-buorit-sapmelaccat.23588.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Gávnnuji dåssju avtaárvulasj (ja nuoges buorre) sáme! - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="det_finnes_bare_likeverdige_og_gode_nok_samer_.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="det_finnes_bare_likeverdige_og_gode_nok_samer_.html"/>
        <parallel_text xml:lang="sme" location="gavdnojit_dusse_ovttaarvosas_ja_doarvai_buorit_sapmelaccat_.html"/>
