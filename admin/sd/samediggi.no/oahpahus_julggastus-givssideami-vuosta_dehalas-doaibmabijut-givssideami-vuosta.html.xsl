...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Oahpahus/Julggastus-givssideami-vuosta/Dehalas-doaibmabijut-givssideami-vuosta'"/>
    ...
    <parallel_text xml:lang="sma" location="lierehtimmie_manifeeste-irhkemen-voeoeste_vihkeles-raaajvarimmieh-irhkemen-voeoeste.html"/>
	<parallel_text xml:lang="nob" location="opplaering_arbeidet-mot-mobbing_viktige-tiltak-mot-mobbing.html"/>
	<parallel_text xml:lang="sme" location="oahpahus_julggastus-givssideami-vuosta_dehalas-doaibmabijut-givssideami-vuosta.html"/></xsl:variable>
