...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Kultureallin/Daidda-ja-kulturbargu/Sami-nationala-symbolaid-calmmustahttin'"/>
    ...
    <parallel_text xml:lang="sma" location="kultureallin_daidda-ja-kulturbargu_sami-nationala-symbolaid-calmmustahttin.html"/>
	<parallel_text xml:lang="nob" location="kulturliv_kunst-og-kulturutoevelse_forvaltning-av-samiske-nasjonalsymboler.html"/>
	<parallel_text xml:lang="sme" location="kultureallin_daidda-ja-kulturbargu_sami-nationala-symbolaid-calmmustahttin.html"/></xsl:variable>
