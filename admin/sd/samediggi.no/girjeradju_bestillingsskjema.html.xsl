...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Girjeradju/Bestillingsskjema'"/>
    ...
    <parallel_text xml:lang="sma" location="girjeradju_bestillingsskjema.html"/>
	<parallel_text xml:lang="nob" location="bibliotek_bestillingsskjema.html"/>
	<parallel_text xml:lang="sme" location="girjeradju_bestillingsskjema.html"/></xsl:variable>
