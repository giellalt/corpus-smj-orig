...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politikk/politisk-organisering-og-ledelse/sametingsradet/?sprak=15'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="saemiedigkieraerie_0_.html"/>
        <parallel_text xml:lang="sme" location="samediggeraddi_0_.html"/>
