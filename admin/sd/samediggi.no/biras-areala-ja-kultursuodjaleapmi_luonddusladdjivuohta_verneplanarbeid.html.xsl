...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Biras-areala-ja-kultursuodjaleapmi/Luonddusladdjivuohta/Verneplanarbeid'"/>
    ...
    <parallel_text xml:lang="sma" location="biras-areala-ja-kultursuodjaleapmi_luonddusladdjivuohta_verneplanarbeid.html"/>
	<parallel_text xml:lang="nob" location="miljoe-areal-og-kulturvern_naturmangfold_verneplanarbeid.html"/>
	<parallel_text xml:lang="sme" location="biras-areala-ja-kultursuodjaleapmi_luonddusladdjivuohta_verneplanarbeid.html"/></xsl:variable>
