...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samedigge.no/AAdaasa/PRD-Stuorra-berustibme-arbbedabalasj-juojggusijs'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRD: Stuorra berustibme árbbedábálasj juojggusijs'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm-stor-interesse-for-tradisjonell-joik.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="prm-aerpievuekien-vuelien-lea-stoerre-iedtje.html"/>
        <parallel_text xml:lang="sme" location="prd-stuorra-berostupmi-arbevirolas-luohtai.html"/>
