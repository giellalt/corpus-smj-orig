...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Dearvvasvuohta-ja-sosiala/Dearvvasvuohta/Etihkalas-njuolggadusa-sami-humana-biologalas-avdnasiid-varas'"/>
    ...
    <parallel_text xml:lang="sma" location="healsoe-jih-sosijaale_healsoe_etihkeles-njoelkedassh-saemien-humane-biologeles-materijalese.html"/>
	<parallel_text xml:lang="nob" location="helse-og-sosial_helse_etiske-retningslinjer-for-samisk-human-biologisk-materiale.html"/>
	<parallel_text xml:lang="sme" location="dearvvasvuohta-ja-sosiala_dearvvasvuohta_etihkalas-njuolggadusa-sami-humana-biologalas-avdnasiid-varas.html"/></xsl:variable>
