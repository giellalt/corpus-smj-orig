...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1081&amp;sprak=Samisk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Rabás tjåhkanibme - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'64'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1081.html" xml:lang="nob"/>
</xsl:variable>
