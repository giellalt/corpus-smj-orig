...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samedigge.no/AAdaasa/Guoradalla-mahttelisvuodav-same-tjerdalasjvuodav-registrieritjit'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Guoradallá máhttelisvuodav sáme tjerdalasjvuodav registrieritjit'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="utreder-muligheten-for-registrering-av-samisk-etnisitet.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="nuepiem-salkehte-juktie-saemien-etnisiteetem-registreradidh.html"/>
        <parallel_text xml:lang="sme" location="guorahallet-vejolasvuoda-registreret-sami-etnisitehta.html"/>
