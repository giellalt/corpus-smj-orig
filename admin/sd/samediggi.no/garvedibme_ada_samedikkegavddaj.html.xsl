...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/forberedelser-til-ny-sametingsperiode.16203.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Gárvedibme ådå sámedikkegávddaj - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="forberedelser_til_ny_sametingsperiode.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="ryojredimmieh_orre_saemiedigkieboelhkese.html"/>
        <parallel_text xml:lang="sme" location="rahkkaneamit_odda_samediggeaigodahkii.html"/>
