...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <parallel_text location="dutkan-ja-alit-oahpahus.html" xml:lang="sme"/>
<parallel_text location="dotkeme-jih-jollebe-oeoehpehtimmie.html" xml:lang="sma"/>
<parallel_text location="forskning-og-hoeyere-utdanning.html" xml:lang="nob"/>
</xsl:variable>
