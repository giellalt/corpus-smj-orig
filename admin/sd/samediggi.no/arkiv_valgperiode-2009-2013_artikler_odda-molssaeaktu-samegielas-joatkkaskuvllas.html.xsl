...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Arkiv/Valgperiode-2009-2013/Artikler/Odda-molssaeaktu-samegielas-joatkkaskuvllas'"/>
    ...
    <parallel_text xml:lang="sma" location="vaaarhkoe_veeljemeboelhken-2009-2013_tjaalegh_orre-alternatijve-saemiengielesne-jaaarhkeskuvlesne.html"/>
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_nytt-alternativ-i-samisk-paa-videregaaende-skole.html"/>
	<parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_odda-molssaeaktu-samegielas-joatkkaskuvllas.html"/></xsl:variable>
