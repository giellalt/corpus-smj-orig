...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <parallel_text location="algoalbmogat-darbbasit-min-dohkkeheami.html" xml:lang="sme"/>
<parallel_text location="urfolk-trenger-vaar-anerkjennelse.html" xml:lang="nob"/>
<parallel_text location="aalkoealmetjh-mijjen-jaaaahkesjimmiem-daarpesjieh.html" xml:lang="sma"/>
</xsl:variable>
