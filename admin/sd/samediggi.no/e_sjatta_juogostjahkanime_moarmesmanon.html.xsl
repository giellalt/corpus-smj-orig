...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/avlyser-komitemotene-i-mai.3430.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'E sjatta juogostjåhkanime moarmesmánon - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="avlyser_komitemotene_i_mai.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="moenehtsetjaanghkojde_heajhta_suehpeden.html"/>
        <parallel_text xml:lang="sme" location="eai_satta_lavdegoddecoahkkimat_miessemanus.html"/>
