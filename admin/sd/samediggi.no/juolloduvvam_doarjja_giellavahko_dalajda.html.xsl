...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/stotte-til-arrangementer-i-forbindelse-med-samisk-sprakuke.16570.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Juolloduvvam doarjja Giellavahko dålajda - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="stotte_til_arrangementer_i_forbindelse_med_samisk_sprakuke.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="daarjoe_oornemidie_gielevahkoen.html"/>
        <parallel_text xml:lang="sme" location="giellavahku_lagidemiide_juolluduvvon_doarjagat.html"/>
