...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="jielemh_duedtie_duedtiebovride-inka-as-jih-manndalen-husflidslag-daaaarje.html"/>
	<parallel_text xml:lang="nob" location="naeringer_duodji_stoetter-duodjibutikkene-inka-as-og-manndalen-husflidlag.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_duodji_doarju-duodjegavppiid-inka-as-ja-manndalen-husflidlag.html"/></xsl:variable>
