...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Giella/Spraakteknologi/Sami-boallobeavdi-jierbmetelefovnnaide-lea-valmmas'"/>
    ...
    <parallel_text xml:lang="sma" location="giele_gieleteknologije_saemien-tastatuvre-smarttellefovnide-gaervies.html"/>
	<parallel_text xml:lang="nob" location="spraak_spraakteknologi_samisk-tastatur-for-smarttelefoner-er-klart.html"/>
	<parallel_text xml:lang="sme" location="giella_spraakteknologi_sami-boallobeavdi-jierbmetelefovnnaide-lea-valmmas.html"/></xsl:variable>
