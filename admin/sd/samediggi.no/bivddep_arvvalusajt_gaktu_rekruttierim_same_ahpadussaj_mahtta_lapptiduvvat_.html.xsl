...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/bivdit-cealkamusaid-dasa-movt-rekrutteren-sami-oahpahussii-sahtta-loktejuvvot.22897.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Bivddep árvvalusájt gåktu rekruttierim sáme åhpadussaj máhttá låpptiduvvat  - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="ber_om_innspill_til_hvordan_rekrutteringen_til_samisk_opplaering_kan_okes.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="lahtesi_bijre_birrie_guktie_maahta_daarrehtimmiem_saemien_lierehtaemman_lissiehtidh.html"/>
        <parallel_text xml:lang="sme" location="bivdit_cealkamusaid_dasa_movt_rekrutteren_sami_oahpahussii_sahtta_loktejuvvot.html"/>
