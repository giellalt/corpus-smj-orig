...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Valgga/Kampanjeside/Jienastuslaahko'"/>
    ...
    <parallel_text xml:lang="sma" location="veeljeme-jih-veeljemelaahkoe_kampanjeside_veeljemelaahkoe.html"/>
	<parallel_text xml:lang="nob" location="valg-og-manntall_kampanjeside_valgmanntall.html"/>
	<parallel_text xml:lang="sme" location="valga-ja-jienastuslohku_kampanjeside_jienastuslohku.html"/></xsl:variable>
