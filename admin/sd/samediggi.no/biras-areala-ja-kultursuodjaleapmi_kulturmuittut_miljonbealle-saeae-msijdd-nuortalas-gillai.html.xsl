...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Biras-areala-ja-kultursuodjaleapmi/Kulturmuittut/Miljonbealle-Saeae-msijdd-nuortalas-gillai'"/>
    ...
    <parallel_text xml:lang="sma" location="biras-areala-ja-kultursuodjaleapmi_kulturmuittut_miljonbealle-saeae-msijdd-nuortalas-gillai.html"/>
	<parallel_text xml:lang="nob" location="miljoe-areal-og-kulturvern_kulturminner_en-halv-million-til-skoltebyen.html"/>
	<parallel_text xml:lang="sme" location="biras-areala-ja-kultursuodjaleapmi_kulturmuittut_miljonbealle-saeae-msijdd-nuortalas-gillai.html"/></xsl:variable>
