...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Giella/Samasta-mujna/Artikler/Same-giellaguovdatja'"/>
    ...
    <parallel_text xml:lang="sma" location="giele_saemesth-munnjien_artikler_saemien-gielejarngh.html"/>
	<parallel_text xml:lang="nob" location="spraak_snakk-samisk-te-mae_artikler_samiske-spraaksentre.html"/>
	<parallel_text xml:lang="sme" location="giella_samas-muinna_artikler_sami-giellaguovddazat.html"/></xsl:variable>
