...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samedigge.no/AAdaasa/PRM-Stuorra-aeradus-mija-darboj-ja-juollodimij-gaskan'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRM: Stuorra ærádus mijá dárboj ja juollodimij gaskan'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm-stort-sprik-mellom-vaare-behov-og-bevilgningene.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="prm-stoerre-gaahkoe-mijjen-daerpiesvoeti-jih-daaarjoej-gaskem.html"/>
        <parallel_text xml:lang="sme" location="prd-stuora-earru-min-darbbuid-ja-juolludemiid-gaskkas.html"/>
