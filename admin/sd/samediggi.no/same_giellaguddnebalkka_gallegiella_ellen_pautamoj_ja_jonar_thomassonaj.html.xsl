...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/samisk-sprakpris-gollegiella-til-ellen-pautamo-og-jonar-thomasson.8593.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sáme giellaguddnebálkká Gållegiella Ellen Pautamoj ja Jonar Thomassonaj - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="samisk_sprakpris_gollegiella_til_ellen_pautamo_og_jonar_thomasson.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="ellen_pautamo_jih_jonar_thomasson_saemien_gielebaalhkam_gulliegiele_aadtjoeh.html"/>
        <parallel_text xml:lang="sme" location="sami_giellabalkkasupmi_gollegiella_ellen_pautamoi_ja_jonar_thomassonii.html"/>
