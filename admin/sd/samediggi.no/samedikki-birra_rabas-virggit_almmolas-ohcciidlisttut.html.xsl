...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Samedikki-birra/Rabas-virggit/Almmolas-ohcciidlisttut'"/>
    ...
    <parallel_text xml:lang="sma" location="samedikki-birra_rabas-virggit_almmolas-ohcciidlisttut.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_ledige-stillinger_offentlige-soekerlister.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_rabas-virggit_almmolas-ohcciidlisttut.html"/></xsl:variable>
