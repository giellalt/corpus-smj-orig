...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Rijkajgasskasasj-barggo/Same-aktisasjbarggo/Same-stuortjaahkanibme-Ubbmemin'"/>
    ...
    <parallel_text xml:lang="sma" location="riikkaidgaskasas-bargu_sami-ovttasbargu_samisk-stormoete-i-umeaa.html"/>
