...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/orre-daarjoeoornege-saemien-vinhtside.33051.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ådå doarjjaårdnik sáme vantsajda - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="ny_tilskuddsordning_til_samiske_bater.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="orre_daarjoeoornege_saemien_vinhtside.html"/>
        <parallel_text xml:lang="sme" location="odda_doarjjaortnet_sami_fatnasiidda.html"/>
