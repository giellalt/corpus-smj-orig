...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Valga-ja-jienastuslohku/Kampanjeside/Diedut/Samediggevalga-2013-listoevttohusat-mat-leat-boahtan-midjiide'"/>
    ...
    <parallel_text xml:lang="sma" location="veeljeme-jih-veeljemelaahkoe_kampanjeside_bievnesh_baaeteme-laestoeraeriestimmieh.html"/>
	<parallel_text xml:lang="nob" location="valg-og-manntall_kampanjeside_info_sametingsvalget-2013-innkomne-listeforslag.html"/>
	<parallel_text xml:lang="sme" location="valga-ja-jienastuslohku_kampanjeside_diedut_samediggevalga-2013-listoevttohusat-mat-leat-boahtan-midjiide.html"/></xsl:variable>
