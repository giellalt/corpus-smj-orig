...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/ossodatdirektevra-giellaossodat.10774.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Åssudakdirekterra - Giellaåssudak - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="avdelingsdirektor_-_avdeling_for_sprak.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="goevtesedirektoore_-_gielegoevtese.html"/>
        <parallel_text xml:lang="sme" location="ossodatdirektevra_-_giellaossodat.html"/>
