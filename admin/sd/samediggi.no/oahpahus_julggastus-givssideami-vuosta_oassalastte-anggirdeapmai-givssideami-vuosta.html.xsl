...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Oahpahus/Julggastus-givssideami-vuosta/Oassalastte-anggirdeapmai-givssideami-vuosta'"/>
    ...
    <parallel_text xml:lang="sma" location="lierehtimmie_manifeeste-irhkemen-voeoeste_aarroeh-meatan-kampanjesne-irhkemen-voeoeste.html"/>
	<parallel_text xml:lang="nob" location="opplaering_arbeidet-mot-mobbing_delta-i-kampanje-mot-mobbing.html"/>
	<parallel_text xml:lang="sme" location="oahpahus_julggastus-givssideami-vuosta_oassalastte-anggirdeapmai-givssideami-vuosta.html"/></xsl:variable>
