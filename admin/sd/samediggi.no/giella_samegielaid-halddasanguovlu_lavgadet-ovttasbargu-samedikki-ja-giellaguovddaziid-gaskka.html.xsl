...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Giella/Samegielaid-halddasanguovlu/Lavgadet-ovttasbargu-Samedikki-ja-giellaguovddaziid-gaskka'"/>
    ...
    <parallel_text xml:lang="sma" location="giele_reeremedajve-saemien-gielide_lihkebe-laavenjostoe-saemiedigkien-jih-gielejarngi-gaskem.html"/>
	<parallel_text xml:lang="nob" location="spraak_forvaltningsomraade_tettere-samarbeid-mellom-sametinget-og-spraaksentrene.html"/>
	<parallel_text xml:lang="sme" location="giella_samegielaid-halddasanguovlu_lavgadet-ovttasbargu-samedikki-ja-giellaguovddaziid-gaskka.html"/></xsl:variable>
