...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Dahpahusat'"/>
    ...
    <parallel_text xml:lang="sma" location="biejjielaahkoe.html"/>
	<parallel_text xml:lang="nob" location="kalender.html"/>
	<parallel_text xml:lang="sme" location="dahpahusat.html"/></xsl:variable>
