...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Kultureallin/Mediaid/Ellen-Inga-O.-Haetta-NRK-stivrii'"/>
    ...
    <parallel_text xml:lang="sma" location="kultureallin_mediaid_ellen-inga-o.-haetta-nrk-stivrii.html"/>
	<parallel_text xml:lang="nob" location="kulturliv_medier_ellen-inga-o.-haetta-i-nrks-styre.html"/>
	<parallel_text xml:lang="sme" location="kultureallin_mediaid_ellen-inga-o.-haetta-nrk-stivrii.html"/></xsl:variable>
