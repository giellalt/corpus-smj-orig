...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Arkiv/Valgperiode-2009-2013/Artikler/Same-nissunij-varresvuohta-vuoroduvva'"/>
    ...
    <parallel_text xml:lang="sma" location="vaaarhkoe_veeljemeboelhken-2009-2013_tjaalegh_laessanamme-fokuse-saemien-nyjsenaejjaj-healsose.html"/>
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_oekt-fokus-paa-samiske-kvinners-helse.html"/>
	<parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_eanet-fokus-sami-nissonolbmuid-dearvvasvuhtii.html"/></xsl:variable>
