...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Varresvuohta-ja-sosialla/Varresvuohta/Doarjju-vuostasjviehkkekursav-aellobargguj'"/>
    ...
    <parallel_text xml:lang="sma" location="healsoe-jih-sosijaale_healsoe_voestesviehkiekuvsjem-baaatsose-daaarjohte.html"/>
	<parallel_text xml:lang="nob" location="helse-og-sosial_helse_stoetter-foerstehjelpskurs-for-reindriften.html"/>
	<parallel_text xml:lang="sme" location="dearvvasvuohta-ja-sosiala_dearvvasvuohta_doarjja-algoveahkkekurssa-doallamii-boazodoalu.html"/></xsl:variable>
