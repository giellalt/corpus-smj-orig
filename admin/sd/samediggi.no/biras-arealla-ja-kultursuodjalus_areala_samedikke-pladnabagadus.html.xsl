...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Biras-arealla-ja-kultursuodjalus/Areala/Samedikke-pladnabagadus'"/>
    ...
    <parallel_text xml:lang="sma" location="biras-areala-ja-kultursuodjaleapmi_areala_samedikki-planaveahkki.html"/>
	<parallel_text xml:lang="nob" location="miljoe-areal-og-kulturvern_areal_sametinget-planveileder.html"/>
	<parallel_text xml:lang="sme" location="biras-areala-ja-kultursuodjaleapmi_areala_samedikki-planaveahkki.html"/></xsl:variable>
