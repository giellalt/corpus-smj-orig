...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politikk/valg/for-deg-som-skal-stemme/hvordan-kan-du-registrere-deg-i-sametingets-valgmanntall/?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Gåktu máhtá ietjat Sámedikke jienastuslåhkuj tjáledit?  - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="hvordan_kan_du_registrere_deg_i_sametingets_valgmanntall_.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="guktie_maahtah_datnem_registreeredh_saemiedigkien_veeljemelahkoen_sijse_.html"/>
        <parallel_text xml:lang="sme" location="movt_sahtat_calihit_iezat_samedikki_jienastuslohkui_.html"/>
