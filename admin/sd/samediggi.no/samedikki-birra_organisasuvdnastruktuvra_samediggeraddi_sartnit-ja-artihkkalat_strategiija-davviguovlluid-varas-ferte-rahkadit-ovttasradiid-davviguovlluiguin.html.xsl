...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Samedikki-birra/Organisasuvdnastruktuvra/Samediggeraddi/Sartnit-ja-artihkkalat/Strategiija-davviguovlluid-varas-ferte-rahkadit-ovttasradiid-davviguovlluiguin'"/>
    ...
    <parallel_text xml:lang="sma" location="saemiedigkien-bijre_aaaarganisasjovnestruktuvre_saemiedigkieraerie_haaalemh-jih-tjaalegh_strategije-noerhtedajvese-tjuara-dorjesovvedh-noerhtedajvine-ektine.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_organisasjonsstruktur_sametingsraadet_taler-og-artikler_strategi-for-nord-maa-lages-i-samspill-med-nord.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_organisasuvdnastruktuvra_samediggeraddi_sartnit-ja-artihkkalat_strategiija-davviguovlluid-varas-ferte-rahkadit-ovttasradiid-davviguovlluiguin.html"/></xsl:variable>
