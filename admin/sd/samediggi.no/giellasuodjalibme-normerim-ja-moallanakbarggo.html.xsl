...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Giella/Diedo-samegielaj-birra/Giellasuodjalibme-normerim-ja-moallanakbarggo'"/>
    ...
    <parallel_text location="giellagahtten-normeren-ja-tearbmabargu-samigielain.html" xml:lang="sme"/>
<parallel_text location="spraakroekt-normering-og-termarbeid-innen-samiske-spraak.html" xml:lang="nob"/>
<parallel_text location="giele-gorredimmie-normeringe-jih-teermebarkoe-saemien-gieline.html" xml:lang="sma"/>
</xsl:variable>
