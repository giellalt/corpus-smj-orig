...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Girjeradju/Mii-avzzuhit/Sami-bibliografiija'"/>
	...
	<parallel_text xml:lang="sme" location="girjeradju_mii-avzzuhit_sami-bibliografiija.html"/></xsl:variable>
