...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Eanandoallu/Bivda-elliiddearvvasvuoda-gearggusvuoda-nannejuvvot-davvin'"/>
    ...
    <parallel_text xml:lang="sma" location="jielemh_jaaartaburrie_naennoesaabpoe-riejriesvoeten-bijre-birrie-kreekehealsose-noerhtene.html"/>
	<parallel_text xml:lang="nob" location="naeringer_jordbruk_ber-om-styrket-beredskap-for-dyrehelse-i-nord.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_eanandoallu_bivda-elliiddearvvasvuoda-gearggusvuoda-nannejuvvot-davvin.html"/></xsl:variable>
