...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/interreg-noerhte-jih-interreg-saepmie-2021-2027.8545.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Interrega Nuortta ja Interreg Sábme 2021- 2027  - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="interreg_nord_og_interreg_sapmi_2021_-_2027.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="interreg_noerhte_jih_interreg_saepmie_2021_-_2027.html"/>
        <parallel_text xml:lang="sme" location="interreg_davvi_ja_interreg_sapmi_2021_-_2027.html"/>
