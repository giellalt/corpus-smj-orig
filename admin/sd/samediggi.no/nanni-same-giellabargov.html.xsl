...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Arkiv/Valgperiode-2009-2013/Artikler/Nanni-same-giellabargov'"/>
    ...
    <parallel_text location="nannejit-sami-giellabarggu.html" xml:lang="sme"/>
<parallel_text location="styrker-samisk-spraakarbeid.html" xml:lang="nob"/>
<parallel_text location="saemien-gielebarkoem-naennoestahta.html" xml:lang="sma"/>
</xsl:variable>
