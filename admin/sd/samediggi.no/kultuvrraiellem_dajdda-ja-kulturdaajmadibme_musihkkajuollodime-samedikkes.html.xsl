...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Kultuvrraiellem/Dajdda-ja-kulturdaajmadibme/Musihkkajuollodime-Samedikkes'"/>
    ...
    <parallel_text xml:lang="sma" location="kultuvrejieleme_kaaanste-jih-kultuvrebarkoe_musihkedaaarjoe-saemiedigkeste.html"/>
	<parallel_text xml:lang="nob" location="kulturliv_kunst-og-kulturutoevelse_musikktildelinger-fra-sametinget.html"/>
	<parallel_text xml:lang="sme" location="kultureallin_daidda-ja-kulturbargu_samedikki-musihkkajuolludeamit.html"/></xsl:variable>
