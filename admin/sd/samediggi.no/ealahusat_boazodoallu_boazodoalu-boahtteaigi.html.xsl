...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Boazodoallu/Boazodoalu-boahtteaigi'"/>
    ...
    <parallel_text xml:lang="sma" location="jielemh_baaatsoe_baaatsoen-baaetije-aejkie.html"/>
	<parallel_text xml:lang="nob" location="naeringer_reindrift_veivalg-for-reindrift.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_boazodoallu_boazodoalu-boahtteaigi.html"/></xsl:variable>
