...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/stipenda-ja-darja/stipenda/kultur-ja-valastallamstipenda/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kultur- ja valástallamstipenda - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="kultur-_og_idrettsstipend.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="kultuvre-_jih_gaarsjelimmiestipende.html"/>
        <parallel_text xml:lang="sme" location="kultur-_ja_valastallanstipeanda.html"/>
