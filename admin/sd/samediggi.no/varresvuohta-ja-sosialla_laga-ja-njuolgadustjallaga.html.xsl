...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Varresvuohta-ja-sosialla/Laga-ja-njuolgadustjallaga'"/>
    ...
    <parallel_text xml:lang="sma" location="healsoe-jih-sosijaale_laakh.html"/>
	<parallel_text xml:lang="nob" location="helse-og-sosial_lover.html"/>
	<parallel_text xml:lang="sme" location="dearvvasvuohta-ja-sosiala_lagat.html"/></xsl:variable>
