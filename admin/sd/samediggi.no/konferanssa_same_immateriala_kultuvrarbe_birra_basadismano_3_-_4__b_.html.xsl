...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/konferanssa-same-immateriala-kultuvrarbe-birra-basadismano-3-4-b.22163.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Konferánssa sáme immateriála kultuvrárbe birra basádismáno 3.- 4. b. - Sametinget'"/>
    <!--
