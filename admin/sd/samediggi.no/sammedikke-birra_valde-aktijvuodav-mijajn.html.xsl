...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Sammedikke-birra/Valde-aktijvuodav-mijajn'"/>
    ...
    <parallel_text xml:lang="sma" location="saemiedigkien-bijre_gaskesadth-mijjine.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_kontakt-oss.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_valdde-oktavuoda.html"/></xsl:variable>
