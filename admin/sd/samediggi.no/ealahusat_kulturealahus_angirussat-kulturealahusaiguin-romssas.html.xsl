...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Kulturealahus/Angirussat-kulturealahusaiguin-Romssas'"/>
    ...
    <parallel_text xml:lang="sma" location="jielemh_kulturejieleme_kultuvrejielemem-tromsesne-daaarjede.html"/>
	<parallel_text xml:lang="nob" location="naeringer_kulturnaering_satser-paa-kulturnaering-i-troms.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_kulturealahus_angirussat-kulturealahusaiguin-romssas.html"/></xsl:variable>
