...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politikk/taler-og-innlegg/h-m-kongens-tale-ved-apningen-av-det-niende-sameting.17072.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'H.M Kongens tale ved åpningen av det niende Sameting - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="h_m_kongens_tale_ved_apningen_av_det_niende_sameting.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="a_m__gankan_haalome_rihpestimmesne_aktsadistie_saemiedigkeste.html"/>
        <parallel_text xml:lang="sme" location="gonagaslas_majestehta_gonagasa_sardni_ovccat_samedikki_rahpama_oktavuodas.html"/>
