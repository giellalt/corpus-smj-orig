...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Girjeradju/Mii-avzzuhit/Sami-bibliografiija/Suoma-sami-bibliografia'"/>
    ...
    <parallel_text xml:lang="sma" location="gaerjagaaetie_mijjieh-juvnehtibie_saemien-bibliografije_saaevmien-saemien-bibliografije.html"/>
	<parallel_text xml:lang="nob" location="bibliotek_vi-anbefaler_samisk-bibliografi_finsk-samisk-bibliografi.html"/>
	<parallel_text xml:lang="sme" location="girjeradju_mii-avzzuhit_sami-bibliografiija_suoma-sami-bibliografia.html"/></xsl:variable>
