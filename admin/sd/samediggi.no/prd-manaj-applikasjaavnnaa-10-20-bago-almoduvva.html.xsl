...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samedigge.no/AAdaasa/PRD-Manaj-applikasjaavnnaa-10-20-bago-almoduvva'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRD: Mánáj applikasjåvnnå “10/20 bágo” almoduvvá'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="prm-barneapplikasjonen-10-20-bago-lanseres.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="prm-baejhkoehtimmie-maanaapplikasjovneste-10-20-bago.html"/>
        <parallel_text xml:lang="sme" location="prd-manaidapplikasuvdna-10-20-bago-almmuhuvvo.html"/>
