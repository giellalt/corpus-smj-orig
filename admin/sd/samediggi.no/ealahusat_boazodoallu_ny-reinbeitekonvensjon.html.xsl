...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Boazodoallu/Ny-reinbeitekonvensjon'"/>
    ...
    <parallel_text xml:lang="sma" location="ealahusat_boazodoallu_ny-reinbeitekonvensjon.html"/>
	<parallel_text xml:lang="nob" location="naeringer_reindrift_ny-reinbeitekonvensjon.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_boazodoallu_ny-reinbeitekonvensjon.html"/></xsl:variable>
