...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Kultureallin/Stipeanda-ja-doarjja/Musihkka'"/>
    ...
    <parallel_text xml:lang="sma" location="kultuvrejieleme_stipende-jih-daaarjoe_musihke.html"/>
	<parallel_text xml:lang="nob" location="kulturliv_stipend-og-tilskudd_musikk.html"/>
	<parallel_text xml:lang="sme" location="kultureallin_stipeanda-ja-doarjja_musihkka.html"/></xsl:variable>
