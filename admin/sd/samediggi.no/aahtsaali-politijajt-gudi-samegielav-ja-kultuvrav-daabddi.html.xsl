...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="etterlyser-politifolk-med-kompetanse-paa-samisk-spraak-og-kultur.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="pollisealmetjh-ohtsede-saemien-giele-jih-kultuvremaahtojne.html"/>
        <parallel_text xml:lang="sme" location="darbbasit-politiijaid-geain-lea-gelbbolasvuohta-sami-gielas-ja-kultuvrras.html"/>
