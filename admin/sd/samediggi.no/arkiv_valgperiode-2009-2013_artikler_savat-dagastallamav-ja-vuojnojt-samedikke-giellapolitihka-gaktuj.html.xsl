...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Arkiv/Valgperiode-2009-2013/Artikler/Savat-dagastallamav-ja-vuojnojt-Samedikke-giellapolitihka-gaktuj'"/>
    ...
    <parallel_text xml:lang="sma" location="vaaarhkoe_veeljemeboelhken-2009-2013_tjaalegh_digkiedimmiem-jih-raerieh-saejhta-saemiedigkien-gielepolitihken-bijre.html"/>
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_oensker-debatt-og-innspill-om-sametingets-spraakpolitikk.html"/>
	<parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_haliida-digastallama-ja-ravvagiid-samedikki-giellapolitihka-birra.html"/></xsl:variable>
