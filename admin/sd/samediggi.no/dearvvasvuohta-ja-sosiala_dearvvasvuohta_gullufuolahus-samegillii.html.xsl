...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Dearvvasvuohta-ja-sosiala/Dearvvasvuohta/Gullufuolahus-samegillii'"/>
    ...
    <parallel_text xml:lang="sma" location="healsoe-jih-sosijaale_healsoe_govlemehokse-saemien-gielesne.html"/>
	<parallel_text xml:lang="nob" location="helse-og-sosial_helse_hoerselsomsorg-paa-samisk.html"/>
	<parallel_text xml:lang="sme" location="dearvvasvuohta-ja-sosiala_dearvvasvuohta_gullufuolahus-samegillii.html"/></xsl:variable>
