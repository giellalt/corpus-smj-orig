...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/gollegiella-nordisk-samisk-sprakpris-deles-ut-hosten-2020.6808.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'GÅLLEGIELLA- Nuorttarijkaj sáme giellaguddnebálkká juogeduvvá tjavtjan 2020 - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="gollegiella_-_nordisk_samisk_sprakpris_deles_ut_hosten_2020.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="gulliegiele-_noerhtelaanti_saemien_gieleprijse_juakasavva_tjaktjen_2020.html"/>
        <parallel_text xml:lang="sme" location="gollegiella_-_davviriikkalas_sami_giellabalkkasupmi_geigejuvvo_cakcat_2020.html"/>
