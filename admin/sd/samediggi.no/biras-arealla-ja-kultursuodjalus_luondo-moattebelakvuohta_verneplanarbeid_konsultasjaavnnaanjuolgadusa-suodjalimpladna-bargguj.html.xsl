...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Biras-arealla-ja-kultursuodjalus/Luondo-moattebelakvuohta/Verneplanarbeid/Konsultasjaavnnaanjuolgadusa-suodjalimpladna-bargguj'"/>
    ...
    <parallel_text xml:lang="sma" location="byjrese-areale-jih-kultuvrevarjelimmie_eatnemegellievoete_verneplanarbeid_konsultasjovnebihkedassh-vaarjelimmiesoejkesjebarkose.html"/>
	<parallel_text xml:lang="nob" location="miljoe-areal-og-kulturvern_naturmangfold_verneplanarbeid_konsultasjonsretningslinjer-for-verneplanarbeid.html"/>
	<parallel_text xml:lang="sme" location="biras-areala-ja-kultursuodjaleapmi_luonddusladdjivuohta_verneplanarbeid_suodjalanbarggu-raddadallannjuolggadusat.html"/></xsl:variable>
