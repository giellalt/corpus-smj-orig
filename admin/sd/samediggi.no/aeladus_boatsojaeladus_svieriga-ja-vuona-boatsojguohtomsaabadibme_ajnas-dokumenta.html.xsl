...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/AEladus/Boatsojaeladus/Svieriga-ja-Vuona-boatsojguohtomsaabadibme/Ajnas-dokumenta'"/>
    ...
    <parallel_text xml:lang="sma" location="ealahusat_boazodoallu_norgga-ruota-boazoguohtunkonvensuvdna_dehalas-dokumeanttat.html"/>
	<parallel_text xml:lang="nob" location="naeringer_reindrift_norsk-svensk-reinbeitekonvensjon_viktige-dokumenter.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_boazodoallu_norgga-ruota-boazoguohtunkonvensuvdna_dehalas-dokumeanttat.html"/></xsl:variable>
