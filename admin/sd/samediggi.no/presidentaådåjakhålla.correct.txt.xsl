...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/samedikkepresidenta-adajakhalla.10181.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámedikkepresidenta ådåjakhålla'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="https://sametinget.no/aktuelt/sametingspresidentens-nyttarstale.10179.aspx?sprak=1"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="https://sametinget.no/saernieh/saemiedigkiepresideenten-orrejaepiehaalome.10180.aspx?sprak=14"/>
        <parallel_text xml:lang="sme" location="https://sametinget.no/oddasat/samediggepresideantta-oddajagisardni.10183.aspx?sprak=12"/>
