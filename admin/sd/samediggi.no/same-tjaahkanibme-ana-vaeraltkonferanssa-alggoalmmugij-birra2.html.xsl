...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location=""/>
	<parallel_text xml:lang="nob" location="allsamisk-moete-om-fns-verdenskonferanse-om-urfolk2.html"/>
	<parallel_text xml:lang="sme" location="oppasami-coahkkin-on-algoalbmogiid-mailmmikonferanssa-birra-2014-s2.html"/></xsl:variable>
