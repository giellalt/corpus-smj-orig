...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Dearvvasvuohta-ja-sosiala/Sosiala/Sohkabealli-dassearvvu-hehttehussan'"/>
    ...
    <parallel_text xml:lang="sma" location="healsoe-jih-sosijaale_sosijaale_tjoele-goh-heaptoe-mirrestallemasse.html"/>
	<parallel_text xml:lang="nob" location="helse-og-sosial_sosial_kjoenn-som-hinder-for-likestilling.html"/>
	<parallel_text xml:lang="sme" location="dearvvasvuohta-ja-sosiala_sosiala_sohkabealli-dassearvvu-hehttehussan.html"/></xsl:variable>
