...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="giele_bievnesh-saemien-gieli-bijre.html"/>
	<parallel_text xml:lang="nob" location="spraak_fakta-om-samiske-spraak.html"/>
	<parallel_text xml:lang="sme" location="giella_faktadiedut-sami-gielaid-birra.html"/></xsl:variable>
