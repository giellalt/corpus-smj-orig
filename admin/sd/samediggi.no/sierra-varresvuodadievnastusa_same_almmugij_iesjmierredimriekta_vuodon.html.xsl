...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/spesialisthelsetjenester-til-den-samiske-befolkningen-med-utgangspunkt-i-retten-til-selvbestemmelse.7793.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sierra-varresvuodadievnastusá sáme álmmugij iesjmierredimriektá vuodon - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="spesialisthelsetjenester_til_den_samiske_befolkningen_med_utgangspunkt_i_retten_til_selvbestemmelse.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location=""/>
        <parallel_text xml:lang="sme" location="spesialista-dearvvasvuodabalvalusat_sami_albmoga_varas_iesmearridanvuoigatvuoda_vuodul_.html"/>
