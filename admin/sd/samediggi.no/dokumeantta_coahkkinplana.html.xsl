...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Dokumeantta/Coahkkinplana'"/>
    ...
    <parallel_text xml:lang="sma" location="tjaatsegh_tjaaanghkoesoejkesje.html"/>
	<parallel_text xml:lang="nob" location="dokumenter_moeteplan.html"/>
	<parallel_text xml:lang="sme" location="dokumeantta_coahkkinplana.html"/></xsl:variable>
