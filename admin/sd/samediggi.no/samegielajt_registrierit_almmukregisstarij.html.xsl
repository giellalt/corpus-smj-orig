...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/sprak/registrering-av-samiske-sprak-i-folkeregisteret/?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámegielajt registrierit álmmukregisstarij - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="registrering_av_samiske_sprak_i_folkeregisteret.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="registreereme_saemien_gielijste_almetjeregisterasse.html"/>
        <parallel_text xml:lang="sme" location="samegielaid_registreren_albmotregistarii.html"/>
