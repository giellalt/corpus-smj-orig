...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Manggalagan-ealahusdoaibma/Doarju-eanet-vasahusvudot-turismma-Romssa-fylkkas'"/>
    ...
    <parallel_text xml:lang="sma" location="jielemh_gellielaaketje-jielemh_vielie-daaaajreseturismem-tromsesne-daaarjohte.html"/>
	<parallel_text xml:lang="nob" location="naeringer_variert-naeringsliv_stoetter-oekt-opplevelsesturisme-i-troms.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_manggalagan-ealahusdoaibma_doarju-eanet-vasahusvudot-turismma-romssa-fylkkas.html"/></xsl:variable>
