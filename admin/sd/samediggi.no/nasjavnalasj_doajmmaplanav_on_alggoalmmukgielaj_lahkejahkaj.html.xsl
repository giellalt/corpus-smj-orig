...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/nasjavnalasj-doajmmaplanav-on-alggoalmmukgielaj-lahkejahkaj.26156.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Nasjåvnålasj doajmmaplánav ON álggoálmmukgielaj låhkejahkáj - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="nasjonal_handlingsplan_for_fns_tiar_for_urfolkssprak.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="nasjonaale_dahkoesoejkesje_en:n_luhkiejaepie_aalkoealmetji_gielide.html"/>
        <parallel_text xml:lang="sme" location="nationala_doaibmaplana_on_algoalbmotgielaid_logijagi_vaste.html"/>
