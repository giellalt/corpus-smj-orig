...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Dokumeantta/Sametingsraadets-vedtak'"/>
    ...
    <parallel_text xml:lang="sma" location="tjaatsegh_saemiedigkieraerien-naennoestimmie.html"/>
	<parallel_text xml:lang="nob" location="dokumenter_sametingsraadets-vedtak.html"/>
	<parallel_text xml:lang="sme" location="dokumeantta_sametingsraadets-vedtak.html"/></xsl:variable>
