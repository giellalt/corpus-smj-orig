...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="laante-jih-vierhtiereaktah_laantereaktah.html"/>
	<parallel_text xml:lang="nob" location="land-og-ressursrettigheter_landrettigheter.html"/>
	<parallel_text xml:lang="sme" location="eatnan-ja-resursavuoigatvuodat_eananvuoigatvuodat.html"/></xsl:variable>
