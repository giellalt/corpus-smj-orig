...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Boazodoallu/Boraspiret-aitet-guohtunealahusaid'"/>
    ...
    <parallel_text xml:lang="sma" location="ealahusat_boazodoallu_boraspiret-aitet-guohtunealahusaid.html"/>
	<parallel_text xml:lang="nob" location="naeringer_reindrift_rovvilt-truer-beitenaeringer.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_boazodoallu_boraspiret-aitet-guohtunealahusaid.html"/></xsl:variable>
