...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samedigge.no/Valgga/Diedo-jienastuslaago-birra'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Diedo jienastuslågo birra'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="informasjon-om-valgmanntallet.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="bievnesh-veeljemelaahkoen-bijre.html"/>
        <parallel_text xml:lang="sme" location="diehtojuohkin-valgajienastuslogu-birra.html"/>
