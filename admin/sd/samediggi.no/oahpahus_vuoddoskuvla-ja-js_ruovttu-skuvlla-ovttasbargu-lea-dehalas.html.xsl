...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Oahpahus/Vuoddoskuvla-ja-JS/Ruovttu-skuvlla-ovttasbargu-lea-dehalas'"/>
    ...
    <parallel_text xml:lang="sma" location="oahpahus_vuoddoskuvla-ja-js_ruovttu-skuvlla-ovttasbargu-lea-dehalas.html"/>
	<parallel_text xml:lang="nob" location="opplaering_grunnskole-og-vgs_hjem-skole-samarbeid-er-viktig.html"/>
	<parallel_text xml:lang="sme" location="oahpahus_vuoddoskuvla-ja-js_ruovttu-skuvlla-ovttasbargu-lea-dehalas.html"/></xsl:variable>
