...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/innsyn-i-sametingets-dokumenter/?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámedikke ássje- ja dokumænntagehtjadibme - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="innsyn_i_sametingets_dokumenter.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="luhpie_saemiedigkien_tjaatsegidie.html"/>
        <parallel_text xml:lang="sme" location="samedikki_asse-_ja_dokumeantageahcadeapmi.html"/>
