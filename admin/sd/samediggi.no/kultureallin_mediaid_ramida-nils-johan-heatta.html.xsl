...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Kultureallin/Mediaid/Ramida-Nils-Johan-Heatta'"/>
    ...
    <parallel_text xml:lang="sma" location="kultureallin_mediaid_ramida-nils-johan-heatta.html"/>
	<parallel_text xml:lang="nob" location="kulturliv_medier_gir-ros-til-nils-johan-heatta.html"/>
	<parallel_text xml:lang="sme" location="kultureallin_mediaid_ramida-nils-johan-heatta.html"/></xsl:variable>
