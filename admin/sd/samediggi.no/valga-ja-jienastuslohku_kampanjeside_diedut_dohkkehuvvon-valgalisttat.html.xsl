...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Valga-ja-jienastuslohku/Kampanjeside/Diedut/Dohkkehuvvon-valgalisttat'"/>
    ...
    <parallel_text xml:lang="sma" location="valga-ja-jienastuslohku_kampanjeside_diedut_dohkkehuvvon-valgalisttat.html"/>
	<parallel_text xml:lang="nob" location="valg-og-manntall_kampanjeside_info_godkjente-valglister.html"/>
	<parallel_text xml:lang="sme" location="valga-ja-jienastuslohku_kampanjeside_diedut_dohkkehuvvon-valgalisttat.html"/></xsl:variable>
