...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="store-forventninger-til-butenschoen-utvalget.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="butenschoen-moenehtsasse-stoerre-vuartoeh.html"/>
        <parallel_text xml:lang="sme" location="vuordamusat-burenschoen-lavdegotti-arvalusaide.html"/>
