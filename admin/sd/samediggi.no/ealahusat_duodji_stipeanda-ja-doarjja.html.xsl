...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Duodji/Stipeanda-ja-doarjja'"/>
    ...
    <parallel_text xml:lang="sma" location="ealahusat_duodji_stipeanda-ja-doarjja.html"/>
