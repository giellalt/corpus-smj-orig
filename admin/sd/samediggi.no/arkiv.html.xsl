...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Arkiv'"/>
    ...
    <parallel_text xml:lang="sma" location="vaaarhkoe.html"/>
	<parallel_text xml:lang="nob" location="arkiv.html"/>
	<parallel_text xml:lang="sme" location="arkiv.html"/></xsl:variable>
