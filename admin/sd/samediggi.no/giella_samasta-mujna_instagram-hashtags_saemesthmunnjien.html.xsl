...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Giella/Samasta-mujna/Instagram-hashtags/Saemesthmunnjien'"/>
    ...
    <parallel_text xml:lang="sma" location="giele_saemesth-munnjien_instagram-hashtags_saemesthmunnjien.html"/>
	<parallel_text xml:lang="nob" location="spraak_snakk-samisk-te-mae_instagram-hashtags_saemesthmunnjien.html"/>
	<parallel_text xml:lang="sme" location="giella_samas-muinna_instagram-hashtags_saemesthmunnjien.html"/></xsl:variable>
