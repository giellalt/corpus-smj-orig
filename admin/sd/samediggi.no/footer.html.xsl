...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Footer'"/>
    ...
    <parallel_text xml:lang="sma" location="footer.html"/>
	<parallel_text xml:lang="nob" location="footer.html"/>
	<parallel_text xml:lang="sme" location="footer.html"/></xsl:variable>
