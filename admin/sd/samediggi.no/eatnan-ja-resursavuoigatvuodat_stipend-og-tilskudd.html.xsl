...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Eatnan-ja-resursavuoigatvuodat/Stipend-og-tilskudd'"/>
    ...
    <parallel_text xml:lang="sma" location="eatnan-ja-resursavuoigatvuodat_stipend-og-tilskudd.html"/>
	<parallel_text xml:lang="nob" location="land-og-ressursrettigheter_stipend-og-tilskudd.html"/>
	<parallel_text xml:lang="sme" location="eatnan-ja-resursavuoigatvuodat_stipend-og-tilskudd.html"/></xsl:variable>
