...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="giele_reeremedajve-saemien-gielide.html"/>
	<parallel_text xml:lang="nob" location="spraak_forvaltningsomraade.html"/>
	<parallel_text xml:lang="sme" location="giella_samegielaid-halddasanguovlu.html"/></xsl:variable>
