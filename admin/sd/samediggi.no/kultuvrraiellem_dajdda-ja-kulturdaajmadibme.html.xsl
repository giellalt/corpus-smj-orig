...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="kultuvrejieleme_kaaanste-jih-kultuvrebarkoe.html"/>
	<parallel_text xml:lang="nob" location="kulturliv_kunst-og-kulturutoevelse.html"/>
	<parallel_text xml:lang="sme" location="kultureallin_daidda-ja-kulturbargu.html"/></xsl:variable>
