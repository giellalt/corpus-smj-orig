...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Biras-arealla-ja-kultursuodjalus/Kulturmujto'"/>
    ...
    <parallel_text xml:lang="sma" location="byjrese-areale-jih-kultuvrevarjelimmie_kultuvremojhtesh.html"/>
	<parallel_text xml:lang="nob" location="miljoe-areal-og-kulturvern_kulturminner.html"/>
	<parallel_text xml:lang="sme" location="biras-areala-ja-kultursuodjaleapmi_kulturmuittut.html"/></xsl:variable>
