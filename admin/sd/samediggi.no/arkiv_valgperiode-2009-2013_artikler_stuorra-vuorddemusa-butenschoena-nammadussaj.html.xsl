...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Arkiv/Valgperiode-2009-2013/Artikler/Stuorra-vuorddemusa-Butenschoena-nammadussaj'"/>
    ...
    <parallel_text xml:lang="sma" location="vaaarhkoe_veeljemeboelhken-2009-2013_tjaalegh_butenschoen-moenehtsasse-stoerre-vuartoeh.html"/>
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_store-forventninger-til-butenschoen-utvalget.html"/>
	<parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_vuordamusat-burenschoen-lavdegotti-arvalusaide.html"/></xsl:variable>
