...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Varresvuohta-ja-sosialla/Varresvuohta/Doarjju-guovllomedisijnalasj-guovdatjav-Divtasvuonan'"/>
    ...
    <parallel_text xml:lang="sma" location="dearvvasvuohta-ja-sosiala_dearvvasvuohta_doarju-guovlomedisiinnalasguovddaza-divttasvutnii.html"/>
	<parallel_text xml:lang="nob" location="helse-og-sosial_helse_stoetter-distriktsmedisinsk-senter-i-tysfjord.html"/>
	<parallel_text xml:lang="sme" location="dearvvasvuohta-ja-sosiala_dearvvasvuohta_doarju-guovlomedisiinnalasguovddaza-divttasvutnii.html"/></xsl:variable>
