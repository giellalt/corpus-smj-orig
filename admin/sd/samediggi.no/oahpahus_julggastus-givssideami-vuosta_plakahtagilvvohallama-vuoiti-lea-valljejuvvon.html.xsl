...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Oahpahus/Julggastus-givssideami-vuosta/Plakahtagilvvohallama-vuoiti-lea-valljejuvvon'"/>
    ...
    <parallel_text xml:lang="sma" location="lierehtimmie_manifeeste-irhkemen-voeoeste_plakaategaahtjemen-vitnije-lea-nommehtamme.html"/>
	<parallel_text xml:lang="nob" location="opplaering_arbeidet-mot-mobbing_vinneren-av-plakatkonkurransen-er-kaaret.html"/>
	<parallel_text xml:lang="sme" location="oahpahus_julggastus-givssideami-vuosta_plakahtagilvvohallama-vuoiti-lea-valljejuvvon.html"/></xsl:variable>
