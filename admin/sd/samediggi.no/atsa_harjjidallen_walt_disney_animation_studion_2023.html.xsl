...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/ohtsh-lierehtajjine-arrodh-walt-disney-animation-studiosne-2023.23191.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Åtså hárjjidallen Walt Disney Animation Studion 2023 - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="apply_as_an_internship_at_walt_disney_animation_studios_2023.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="ohtsh_lierehtaejjine_arrodh_walt_disney_animation_studiosne_2023.html"/>
        <parallel_text xml:lang="sme" location="oza_oahpahallin_walt_disney_animation_studioi_2023.html"/>
