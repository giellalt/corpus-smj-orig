...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Mearraealahusat/Algoalbmotjietna-ferte-gullot-luondduluosa-halddaseamis'"/>
    ...
    <parallel_text xml:lang="sma" location="jielemh_marijne-jielemh_aalkoealmetjegiele-tjuara-govlelgidh-reeremisnie-eatnemeloeseste.html"/>
	<parallel_text xml:lang="nob" location="naeringer_marine-naeringer_urfolksstemmen-maa-bli-hoert-i-forvaltningen-av-villaks.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_mearraealahusat_algoalbmotjietna-ferte-gullot-luondduluosa-halddaseamis.html"/></xsl:variable>
