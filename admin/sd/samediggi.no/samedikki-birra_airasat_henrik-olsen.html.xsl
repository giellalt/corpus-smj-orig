...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Samedikki-birra/Airasat/Henrik-Olsen'"/>
    ...
    <parallel_text xml:lang="sma" location="samedikki-birra_airasat_henrik-olsen.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_representanter_henrik-olsen.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_airasat_henrik-olsen.html"/></xsl:variable>
