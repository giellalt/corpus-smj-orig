...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saemiedigkien-garjagaetie/lohkh-munnjien-giele-voestesiereste/gelliengieleldh-arrodh/?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Moattegielagin årrot - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="om_det_a_vaere_flerspraklig.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="gelliengieleldh_arrodh.html"/>
        <parallel_text xml:lang="sme" location="mo_lea_leahkit_mangggagielat.html"/>
