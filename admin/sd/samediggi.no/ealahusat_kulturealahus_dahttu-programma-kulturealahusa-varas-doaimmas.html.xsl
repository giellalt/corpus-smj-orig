...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Kulturealahus/Dahttu-programma-kulturealahusa-varas-doaimmas'"/>
    ...
    <parallel_text xml:lang="sma" location="ealahusat_kulturealahus_dahttu-programma-kulturealahusa-varas-doaimmas.html"/>
	<parallel_text xml:lang="nob" location="naeringer_kulturnaering_dahttu-programmet-for-kulturnaering-i-gang.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_kulturealahus_dahttu-programma-kulturealahusa-varas-doaimmas.html"/></xsl:variable>
