...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Preassadiedahusat/Web-tv'"/>
    ...
    <parallel_text xml:lang="sma" location="preassadiedahusat_web-tv.html"/>
	<parallel_text xml:lang="nob" location="presse_web-tv.html"/>
	<parallel_text xml:lang="sme" location="preassadiedahusat_web-tv.html"/></xsl:variable>
