...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Giella/Faktadiedut-sami-gielaid-birra/Odda-digitala-satnegirji-almmuhuvvo'"/>
    ...
    <parallel_text xml:lang="sma" location="giele_bievnesh-saemien-gieli-bijre_orre-digitaale-baakoegaerja-olkese-baaata.html"/>
	<parallel_text xml:lang="nob" location="spraak_fakta-om-samiske-spraak_ny-digital-ordbok-lanseres.html"/>
	<parallel_text xml:lang="sme" location="giella_faktadiedut-sami-gielaid-birra_odda-digitala-satnegirji-almmuhuvvo.html"/></xsl:variable>
