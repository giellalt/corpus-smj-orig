...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Girjeradju/Mii-avzzuhit/Blogga'"/>
    ...
    <parallel_text xml:lang="sma" location="gaerjagaaetie_mijjieh-juvnehtibie_blogga.html"/>
	<parallel_text xml:lang="nob" location="bibliotek_vi-anbefaler_blogger.html"/>
	<parallel_text xml:lang="sme" location="girjeradju_mii-avzzuhit_blogga.html"/></xsl:variable>
