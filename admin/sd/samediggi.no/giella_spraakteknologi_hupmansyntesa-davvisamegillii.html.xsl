...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Giella/Spraakteknologi/Hupmansyntesa-davvisamegillii'"/>
    ...
    <parallel_text xml:lang="sma" location="giele_gieleteknologije_soptsestimmiesyntese-noerhtesaemien-gielese.html"/>
	<parallel_text xml:lang="nob" location="spraak_spraakteknologi_utvikler-talesyntese-for-nordsamisk.html"/>
	<parallel_text xml:lang="sme" location="giella_spraakteknologi_hupmansyntesa-davvisamegillii.html"/></xsl:variable>
