...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Girjeradju/Balvalusat'"/>
    ...
    <parallel_text xml:lang="sma" location="gaerjagaaetie_dienesjh.html"/>
	<parallel_text xml:lang="nob" location="bibliotek_tjenester.html"/>
	<parallel_text xml:lang="sme" location="girjeradju_balvalusat.html"/></xsl:variable>
