...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <parallel_text location="oensker-kandidater-til-nordisk-samisk-likestillingspris.html" xml:lang="nob"/>
<parallel_text location="haliida-evttohasaid-davviriikkalas-sami-dassearvobalkkasupmai.html" xml:lang="sme"/>
<parallel_text location="kandidaath-vaajtele-noerhtelaanti-saemien-mirrestallemebaalhkese.html" xml:lang="sma"/>
</xsl:variable>
