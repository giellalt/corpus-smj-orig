...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="jielemh_baaatsoe_akte-hijven-dirrege-dan-raastendaaaresth-baaatsose.html"/>
	<parallel_text xml:lang="nob" location="naeringer_reindrift_et-godt-verktoey-for-den-grenseoverskridende-reindriften.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_boazodoallu_buorre-gaskaoapmi-rajarasttideaddji-boazodollui.html"/></xsl:variable>
