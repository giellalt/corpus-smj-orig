...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Mearraealahusat/Doarjja-nuorra-guolasteddjiide'"/>
    ...
    <parallel_text xml:lang="sma" location="jielemh_marijne-jielemh_daaarjoe-noere-goeoelijidie.html"/>
	<parallel_text xml:lang="nob" location="naeringer_marine-naeringer_400.000-til-unge-fiskere.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_mearraealahusat_doarjja-nuorra-guolasteddjiide.html"/></xsl:variable>
