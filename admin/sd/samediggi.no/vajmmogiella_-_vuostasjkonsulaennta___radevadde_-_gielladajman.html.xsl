...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/hjertespraket-forstekonsulent-radgiver-spraktiltak-lulesamisk.10680.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Vájmmogiella - Vuostasjkonsulænnta / Rádevadde - Gielladåjman - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="hjertespraket_-_forstekonsulent_radgiver.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location=""/>
        <parallel_text xml:lang="sme" location="vaibmogiella_-_vuosttaskonsuleanta___raddeaddi_-_gielladoaimmat_-_julevsamegiella.html"/>
