...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <parallel_text location="falastallan.html" xml:lang="sme"/>
<parallel_text location="idrett.html" xml:lang="nob"/>
<parallel_text location="gaarsjelimmie.html" xml:lang="sma"/>
</xsl:variable>
