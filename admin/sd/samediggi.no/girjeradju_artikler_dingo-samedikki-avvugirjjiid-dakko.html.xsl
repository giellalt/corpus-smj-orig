...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Girjeradju/Artikler/Dingo-Samedikki-avvugirjjiid-dakko'"/>
    ...
    <parallel_text xml:lang="sma" location="girjeradju_artikler_dingo-samedikki-avvugirjjiid-dakko.html"/>
	<parallel_text xml:lang="nob" location="bibliotek_artikler_bestill-sametingets-jubileumsboeker-her.html"/>
	<parallel_text xml:lang="sme" location="girjeradju_artikler_dingo-samedikki-avvugirjjiid-dakko.html"/></xsl:variable>
