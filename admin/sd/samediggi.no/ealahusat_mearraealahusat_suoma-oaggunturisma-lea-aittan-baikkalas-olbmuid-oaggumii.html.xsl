...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Mearraealahusat/Suoma-oaggunturisma-lea-aittan-baikkalas-olbmuid-oaggumii'"/>
    ...
    <parallel_text xml:lang="sma" location="ealahusat_mearraealahusat_suoma-oaggunturisma-lea-aittan-baikkalas-olbmuid-oaggumii.html"/>
	<parallel_text xml:lang="nob" location="naeringer_marine-naeringer_finsk-fisketurisme-er-en-trussel-for-lokalbefolkningens-fiske.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_mearraealahusat_suoma-oaggunturisma-lea-aittan-baikkalas-olbmuid-oaggumii.html"/></xsl:variable>
