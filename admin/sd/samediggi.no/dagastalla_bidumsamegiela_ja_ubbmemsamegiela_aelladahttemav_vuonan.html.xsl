...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/jealajehtemem-pijtesaemien-jih-upmejesaemien-gieleste-noorjesne-digkede.23697.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dágástallá bidumsámegiela ja ubbmemsámegiela ælládahttemav Vuonan - Sámedigge'"/>
    <!--
    ...
    <!-- Publication year -->
    <xsl:variable name="year" select="'2023'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="diskuterer_revitalisering_av_pitesamisk_og_umesamisk_sprak_i_norge.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="jealajehtemem_pijtesaemien_jih_upmejesaemien_gieleste_noorjesne_digkede.html"/>
        <parallel_text xml:lang="sme" location="digastallet_bihtansamegiela_ja_ubmisamegiela_revitaliserema_norggas.html"/>
