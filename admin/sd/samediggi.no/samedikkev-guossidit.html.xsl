...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <parallel_text location="samedikki-galledeapmi.html" xml:lang="sme"/>
<parallel_text location="besoeke-sametinget.html" xml:lang="nob"/>
<parallel_text location="guessine-minnedh-saemiedigkesne.html" xml:lang="sma"/>
</xsl:variable>
