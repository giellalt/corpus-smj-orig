...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Valga-ja-jienastuslohku/Kampanjeside/Diedut/Gii-boahta-sisa-Samediggai'"/>
    ...
    <parallel_text xml:lang="sma" location="veeljeme-jih-veeljemelaahkoe_kampanjeside_bievnesh_gieh-saemiedaegkan-baaetieh.html"/>
	<parallel_text xml:lang="nob" location="valg-og-manntall_kampanjeside_info_hvem-kommer-inn-paa-sametinget.html"/>
	<parallel_text xml:lang="sme" location="valga-ja-jienastuslohku_kampanjeside_diedut_gii-boahta-sisa-samediggai.html"/></xsl:variable>
