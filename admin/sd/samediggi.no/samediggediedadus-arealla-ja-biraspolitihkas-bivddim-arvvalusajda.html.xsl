...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Biras-arealla-ja-kultursuodjalus/Areala/Samediggediedadus-arealla-ja-biraspolitihkas-Bivddim-arvvalusajda'"/>
    ...
    <parallel_text location="samedikki-diedahus-areala-ja-biraspolitihka-birra-bovdehus-saddet-arvalusaid.html" xml:lang="sme"/>
<parallel_text location="sametingsmelding-om-areal-og-miljoepolitikk-invitasjon-til-innspill.html" xml:lang="nob"/>
<parallel_text location="saemiedigkiebievnese-areale-jih-byjresepolitihken-bijre-boeoeredimmie-raeriejgujmie-baaetedh.html" xml:lang="sma"/>
</xsl:variable>
