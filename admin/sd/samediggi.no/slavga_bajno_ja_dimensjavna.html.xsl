...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/samedikki-birra/sami-albmotbeaivi-ja-nasuvnnalas-dovdomearkkat/leavgga-ivnnit-ja-dimensuvnnat/?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Slávgá bájno ja dimensjåvnå - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sameflaggets_farger_og_dimensjoner.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="saevegen_klaerieh_jih_dimensjovnh.html"/>
        <parallel_text xml:lang="sme" location="sami_leavgga_ivnnit_ja_dimensuvnnat.html"/>
