...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/nav-ja-nve-bierriji-valggogisa-sjaddat-vasstedittjat-samegiellaj.33558.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'NAV ja NVE bierriji vælggogisá sjaddat vásstedittjat sámegiellaj  - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="nav_og_nve_bor_forpliktes_til_a_svare_pa_samisk.html"/>
