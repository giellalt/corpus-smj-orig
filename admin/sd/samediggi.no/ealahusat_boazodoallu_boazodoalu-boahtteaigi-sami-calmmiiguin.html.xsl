...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Boazodoallu/Boazodoalu-boahtteaigi-Sami-calmmiiguin'"/>
    ...
    <parallel_text xml:lang="sma" location="ealahusat_boazodoallu_boazodoalu-boahtteaigi-sami-calmmiiguin.html"/>
	<parallel_text xml:lang="nob" location="naeringer_reindrift_framtidig-reindrift-fra-et-samisk-perspektiv.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_boazodoallu_boazodoalu-boahtteaigi-sami-calmmiiguin.html"/></xsl:variable>
