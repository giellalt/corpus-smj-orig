...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Kultureallin/Stipeanda-ja-doarjja'"/>
    ...
    <parallel_text xml:lang="sma" location="kultuvrejieleme_stipende-jih-daaarjoe.html"/>
	<parallel_text xml:lang="nob" location="kulturliv_stipend-og-tilskudd.html"/>
	<parallel_text xml:lang="sme" location="kultureallin_stipeanda-ja-doarjja.html"/></xsl:variable>
