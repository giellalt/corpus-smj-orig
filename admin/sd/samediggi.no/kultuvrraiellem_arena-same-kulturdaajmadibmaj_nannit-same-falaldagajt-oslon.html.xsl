...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Kultuvrraiellem/Arena-same-kulturdaajmadibmaj/Nannit-same-falaldagajt-Oslon'"/>
    ...
    <parallel_text xml:lang="sma" location="kultuvrejieleme_sijjieh-saemien-kultuvrebarkose_saemien-faalenassem-oslosne-naennoestehtedh.html"/>
	<parallel_text xml:lang="nob" location="kulturliv_arenaer-for-samisk-kulturutoevelse_styrke-det-samiske-tilbudet-i-oslo.html"/>
	<parallel_text xml:lang="sme" location="kultureallin_sami-kulturbargoarenat_nannet-sami-falaldaga-oslos.html"/></xsl:variable>
