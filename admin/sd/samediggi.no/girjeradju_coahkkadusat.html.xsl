...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Girjeradju/Coahkkadusat'"/>
    ...
    <parallel_text xml:lang="sma" location="gaerjagaaetie_vaaarhkoeh.html"/>
	<parallel_text xml:lang="nob" location="bibliotek_samlinger.html"/>
	<parallel_text xml:lang="sme" location="girjeradju_coahkkadusat.html"/></xsl:variable>
