...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Dearvvasvuohta-ja-sosiala/Dearvvasvuohta/Samediggeraddi-ravve-asahit-Sami-dearvvasvuodasiida-Samisk-helsepark'"/>
    ...
    <parallel_text xml:lang="sma" location="healsoe-jih-sosijaale_healsoe_saemiedigkie-laavenjostoelatjkoem-dorje-noeoerjen-foestehiejmesiebrine.html"/>
	<parallel_text xml:lang="nob" location="helse-og-sosial_helse_sametingsraadet-anbefaler-sami-dearvvasvuoda-siida-samisk-helsepark.html"/>
	<parallel_text xml:lang="sme" location="dearvvasvuohta-ja-sosiala_dearvvasvuohta_samediggeraddi-ravve-asahit-sami-dearvvasvuodasiida-samisk-helsepark.html"/></xsl:variable>
