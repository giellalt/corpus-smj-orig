...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Arkiv/Valgperiode-2009-2013/Artikler/Same-ja-inuihta-sjiehtadin-aktisasj-ulmijt-Nuukan'"/>
    ...
    <parallel_text xml:lang="sma" location="vaaarhkoe_veeljemeboelhken-2009-2013_tjaalegh_saemieh-jih-inuihth-siemes-tjaaenghkies-ulmiej-bijre-nuuk-sne.html"/>
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_samer-og-inuitter-enige-om-felles-maalsettinger-i-nuuk.html"/>
	<parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_samit-ja-inuihtat-sohpe-oktasas-mihttomeriid-nuuk-s.html"/></xsl:variable>
