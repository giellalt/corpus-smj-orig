...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Biras-arealla-ja-kultursuodjalus/Energija-ja-minerala'"/>
    ...
    <parallel_text xml:lang="sma" location="byjrese-areale-jih-kultuvrevarjelimmie_energije-jih-mineraalh.html"/>
	<parallel_text xml:lang="nob" location="miljoe-areal-og-kulturvern_energi-og-mineraler.html"/>
	<parallel_text xml:lang="sme" location="biras-areala-ja-kultursuodjaleapmi_energiija-ja-mineralat.html"/></xsl:variable>
