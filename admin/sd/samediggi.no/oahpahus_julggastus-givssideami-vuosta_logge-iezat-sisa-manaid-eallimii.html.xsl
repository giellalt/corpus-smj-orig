...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Oahpahus/Julggastus-givssideami-vuosta/Logge-iezat-sisa-manaid-eallimii'"/>
    ...
    <parallel_text xml:lang="sma" location="oahpahus_julggastus-givssideami-vuosta_logge-iezat-sisa-manaid-eallimii.html"/>
	<parallel_text xml:lang="nob" location="opplaering_arbeidet-mot-mobbing_logg-deg-paa-barnas-liv.html"/>
	<parallel_text xml:lang="sme" location="oahpahus_julggastus-givssideami-vuosta_logge-iezat-sisa-manaid-eallimii.html"/></xsl:variable>
