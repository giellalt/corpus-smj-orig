...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="healsoe-jih-sosijaale_maanavaarjelimmie.html"/>
	<parallel_text xml:lang="nob" location="helse-og-sosial_barnevern.html"/>
	<parallel_text xml:lang="sme" location="dearvvasvuohta-ja-sosiala_manaidsuodjalus.html"/></xsl:variable>
