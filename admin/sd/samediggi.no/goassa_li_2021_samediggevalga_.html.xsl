...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politikk/valg/for-deg-som-skal-stemme/nar-er-sametingsvalget-i-2021/?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Goassa li 2021 sámediggeválga? - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="nar_er_sametingsvalget_i_2021.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="gaessie_saemiedigkieveeljeme_jaepien_2021_.html"/>
        <parallel_text xml:lang="sme" location="goas_leat_2021_samediggevalggat_.html"/>
