...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Giella/Faktadiedut-sami-gielaid-birra/Sami-Giellagaldu-stahtabuseahtas'"/>
    ...
    <parallel_text xml:lang="sma" location="giella_faktadiedut-sami-gielaid-birra_sami-giellagaldu-stahtabuseahtas.html"/>
	<parallel_text xml:lang="nob" location="spraak_fakta-om-samiske-spraak_sami-giellagaldu-paa-statsbudsjettet.html"/>
	<parallel_text xml:lang="sme" location="giella_faktadiedut-sami-gielaid-birra_sami-giellagaldu-stahtabuseahtas.html"/></xsl:variable>
