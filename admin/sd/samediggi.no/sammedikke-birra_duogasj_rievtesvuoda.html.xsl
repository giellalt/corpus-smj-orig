...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="saemiedigkien-bijre_sjieke_reaktah.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_bakgrunn_rettigheter.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_duogas_vuoigatvuodat.html"/></xsl:variable>
