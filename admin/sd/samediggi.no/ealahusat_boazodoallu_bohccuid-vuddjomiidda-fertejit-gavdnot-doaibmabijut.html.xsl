...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Boazodoallu/Bohccuid-vuddjomiidda-fertejit-gavdnot-doaibmabijut'"/>
    ...
    <parallel_text xml:lang="sma" location="ealahusat_boazodoallu_bohccuid-vuddjomiidda-fertejit-gavdnot-doaibmabijut.html"/>
	<parallel_text xml:lang="nob" location="naeringer_reindrift_tiltak-mot-reinpaakjoersler-paa-nordlandsbanen-maa-paa-plass.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_boazodoallu_bohccuid-vuddjomiidda-fertejit-gavdnot-doaibmabijut.html"/></xsl:variable>
