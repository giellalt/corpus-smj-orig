...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Duodji/Bidjet-searaid-duodjebagadalliide'"/>
    ...
    <parallel_text xml:lang="sma" location="ealahusat_duodji_bidjet-searaid-duodjebagadalliide.html"/>
	<parallel_text xml:lang="nob" location="naeringer_duodji_satser-millioner-paa-duodjiveiledere.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_duodji_bidjet-searaid-duodjebagadalliide.html"/></xsl:variable>
