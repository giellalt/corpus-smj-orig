...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/nuortalasgiela-ealaskahttima-geaidnovalljen.22269.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Vuodo lullesámegiela ælládahttemij dágástaláduvvá  - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="veivalg_for_skoltesamisk_sprakvitalisering.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="geajnoeveeljeme_jealajehtiemasse_skoltesaemien_gieleste_.html"/>
        <parallel_text xml:lang="sme" location="nuortalasgiela_ealaskahttima_geaidnovalljen.html"/>
