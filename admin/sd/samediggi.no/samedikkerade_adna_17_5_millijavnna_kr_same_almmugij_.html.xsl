...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametingsradet-omdisponerer-17-5-millioner-kroner-til-det-samiske-folk.17999.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámedikkeráde adná 17,5 millijåvnnå kr sáme álmmugij  - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="sametingsradet_omdisponerer_17_5_millioner_kroner_til_det_samiske_folk.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="saemiedigkieraerie_17_5_millijovnh_kravnah_saemien_aalmegasse_serteste.html"/>
        <parallel_text xml:lang="sme" location="samediggeraddi_sirda_17_5_miljon_ruvnno_sami_albmogii_buorrin.html"/>
