...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Oahpahus/Oahpponeavvut/Vuoruhit-samegiela-nubbingiellan'"/>
    ...
    <parallel_text xml:lang="sma" location="oahpahus_oahpponeavvut_vuoruhit-samegiela-nubbingiellan.html"/>
	<parallel_text xml:lang="nob" location="opplaering_laeremidler_prioriterer-samisk-som-andrespraak.html"/>
	<parallel_text xml:lang="sme" location="oahpahus_oahpponeavvut_vuoruhit-samegiela-nubbingiellan.html"/></xsl:variable>
