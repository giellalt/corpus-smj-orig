...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ednam-ja-resurssarievtesvuodaj/Guollimriekta/Guolastime-bajkalasj-haldadibme-Deanus'"/>
    ...
    <parallel_text xml:lang="sma" location="laante-jih-vierhtiereaktah_goeoelemereakta_voenges-reereme-goeoelemistie-deatnusne.html"/>
	<parallel_text xml:lang="nob" location="land-og-ressursrettigheter_fiskerettigheter_lokal-forvaltning-av-fiske-i-tana.html"/>
	<parallel_text xml:lang="sme" location="eatnan-ja-resursavuoigatvuodat_bivdovuoigatvuohta_guolasteami-baikkalas-halddaseapmi-deanus.html"/></xsl:variable>
