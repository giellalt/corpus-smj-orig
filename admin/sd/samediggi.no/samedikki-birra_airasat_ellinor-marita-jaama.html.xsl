...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Samedikki-birra/Airasat/Ellinor-Marita-Jaama'"/>
    ...
    <parallel_text xml:lang="sma" location="samedikki-birra_airasat_ellinor-marita-jaama.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_representanter_ellinor-marita-jaama.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_airasat_ellinor-marita-jaama.html"/></xsl:variable>
