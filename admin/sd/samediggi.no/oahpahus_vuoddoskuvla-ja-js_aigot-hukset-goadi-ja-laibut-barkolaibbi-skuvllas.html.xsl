...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Oahpahus/Vuoddoskuvla-ja-JS/Aigot-hukset-goadi-ja-laibut-barkolaibbi-skuvllas'"/>
    ...
    <parallel_text xml:lang="sma" location="oahpahus_vuoddoskuvla-ja-js_aigot-hukset-goadi-ja-laibut-barkolaibbi-skuvllas.html"/>
	<parallel_text xml:lang="nob" location="opplaering_grunnskole-og-vgs_skal-bygge-gamme-og-lage-barkebroed-i-skolen.html"/>
	<parallel_text xml:lang="sme" location="oahpahus_vuoddoskuvla-ja-js_aigot-hukset-goadi-ja-laibut-barkolaibbi-skuvllas.html"/></xsl:variable>
