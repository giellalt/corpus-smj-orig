...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Arkiv/Valgperiode-2009-2013/Artikler/Same-tjaahkanibme-ANa-vaeraltkonferanssa-alggoalmmugij-birra/Same-tjaahkanibme'"/>
    ...
    <parallel_text location="spr-bovde-oppasami-coahkkimii.html" xml:lang="sme"/>
<parallel_text location="spr-bovde-oppasami-coahkkimii.html" xml:lang="nob"/>
</xsl:variable>
