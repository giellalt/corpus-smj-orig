...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/bevilget-tilskudd-til-samiske-sprakprosjekter.14953.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Juollodum doarjja sáme giellaprosjevtajda - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="bevilget_tilskudd_til_samiske_sprakprosjekter.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="daarjoem_saemien_gieleprosjektide_vadteme.html"/>
        <parallel_text xml:lang="sme" location="juolludan_ruda_sami_giellaproseavttaide.html"/>
