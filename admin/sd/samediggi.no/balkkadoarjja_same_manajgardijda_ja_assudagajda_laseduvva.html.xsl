...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/okt-lonnsstotte-til-samiske-barnehager-og-avdelinger.19167.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Bálkkádoarjja sáme mánájgárdijda ja åssudagájda laseduvvá - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="okt_lonnsstotte_til_samiske_barnehager_og_avdelinger.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="lissiehtamme_baalhkadaarjoe_saemien_maanagiertide_jih_goevtesidie_.html"/>
        <parallel_text xml:lang="sme" location="lasi_balkadoarjja_sami_manaidgarddiide_ja_ossodagaide.html"/>
