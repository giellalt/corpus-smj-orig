...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Suohkanodastus'"/>
    ...
    <parallel_text xml:lang="sma" location="tjieltereforme.html"/>
	<parallel_text xml:lang="nob" location="kommunereformen.html"/>
	<parallel_text xml:lang="sme" location="suohkanodastus.html"/></xsl:variable>
