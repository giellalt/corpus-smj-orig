...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Valga-ja-jienastuslohku/Kampanjeside'"/>
    ...
    <parallel_text xml:lang="sma" location="valga-ja-jienastuslohku_kampanjeside.html"/>
	<parallel_text xml:lang="nob" location="valg-og-manntall_kampanjeside.html"/>
	<parallel_text xml:lang="sme" location="valga-ja-jienastuslohku_kampanjeside.html"/></xsl:variable>
