...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ednam-ja-resurssarievtesvuodaj/Guollimriekta/Merragaddenammadus/Merragaddeguollimnammadusa-maerradusarvvalussaj'"/>
	...
	<parallel_text xml:lang="nob" location="land-og-ressursrettigheter_fiskerettigheter_kystfiskeutvalget_kystfiskeutvalgets-innstilling.html"/>
	<parallel_text xml:lang="sme" location="eatnan-ja-resursavuoigatvuodat_bivdovuoigatvuohta_riddoguolastanlavdegotti_riddoguolastanlavdegotti.html"/></xsl:variable>
