...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Samedikki-birra/Duogas/Samediggi-25-jagi'"/>
    ...
    <parallel_text xml:lang="sma" location="saemiedigkien-bijre_sjieke_saemiedigkie-25-jaepieh.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_bakgrunn_sametinget-25-aar.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_duogas_samediggi-25-jagi.html"/></xsl:variable>
