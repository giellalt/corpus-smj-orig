...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/samenes-nasjonaldag-narmer-seg.22886.aspx?sprak=15'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="samenes_nasjonaldag_naermer_seg_.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="saemiej_aalmegebiejjie_geatskeneminie_.html"/>
        <parallel_text xml:lang="sme" location="sami_albmotbeaivi_lahkona_.html"/>
