...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/tekstene-til-nasjonalsangen-og-nasjonaljoiken-samlet-i-ett-dokument.23611.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Præssadiedádus Juohkusis sáme rijkalasjgåvåstagájda - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="tekstene_til_nasjonalsangen_og_nasjonaljoiken_samlet_i_ett_dokument.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="saerniebievnesje_moenehtsistie_saemiej_naasjovnev_aehtaj_bijre.html"/>
        <parallel_text xml:lang="sme" location="albmotlavlaga_ja_albmotluodi_teavsttat_cohkkejuvvon_ovtta_dokumentii.html"/>
