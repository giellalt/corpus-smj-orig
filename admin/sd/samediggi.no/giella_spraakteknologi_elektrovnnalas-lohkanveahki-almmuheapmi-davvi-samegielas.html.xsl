...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Giella/Spraakteknologi/Elektrovnnalas-lohkanveahki-almmuheapmi-davvi-samegielas'"/>
    ...
    <parallel_text xml:lang="sma" location="giella_spraakteknologi_elektrovnnalas-lohkanveahki-almmuheapmi-davvi-samegielas.html"/>
	<parallel_text xml:lang="nob" location="spraak_spraakteknologi_lansering-av-elektronisk-lesehjelp-for-nordsamisk.html"/>
	<parallel_text xml:lang="sme" location="giella_spraakteknologi_elektrovnnalas-lohkanveahki-almmuheapmi-davvi-samegielas.html"/></xsl:variable>
