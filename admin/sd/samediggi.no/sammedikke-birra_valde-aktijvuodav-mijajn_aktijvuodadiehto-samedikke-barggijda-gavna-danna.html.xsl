...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Sammedikke-birra/Valde-aktijvuodav-mijajn/Aktijvuodadiehto-Samedikke-barggijda-gavna-danna'"/>
    ...
    <parallel_text xml:lang="sma" location="samedikki-birra_valdde-oktavuoda_bargiid-oktavuodadiedut.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_kontakt-oss_kontaktinformasjon-til-ansatte.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_valdde-oktavuoda_bargiid-oktavuodadiedut.html"/></xsl:variable>
