...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Sammedikke-birra/Ajrrasa'"/>
    ...
    <parallel_text xml:lang="sma" location="saemiedigkien-bijre_tjirkijh.html"/>
	<parallel_text xml:lang="nob" location="om-sametinget_representanter.html"/>
	<parallel_text xml:lang="sme" location="samedikki-birra_airasat.html"/></xsl:variable>
