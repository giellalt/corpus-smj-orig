...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Girjeradju/Mii-avzzuhit/Blogga/Sami-girjeradjubalvalus'"/>
    ...
    <parallel_text xml:lang="sma" location="gaerjagaaetie_mijjieh-juvnehtibie_blogga_saemien-gaerjagaaetiedienesje.html"/>
	<parallel_text xml:lang="nob" location="bibliotek_vi-anbefaler_blogger_samisk-bibliotektjeneste.html"/>
	<parallel_text xml:lang="sme" location="girjeradju_mii-avzzuhit_blogga_sami-girjeradjubalvalus.html"/></xsl:variable>
