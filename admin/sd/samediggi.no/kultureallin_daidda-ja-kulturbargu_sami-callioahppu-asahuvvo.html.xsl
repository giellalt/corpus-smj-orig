...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Kultureallin/Daidda-ja-kulturbargu/Sami-callioahppu-asahuvvo'"/>
    ...
    <parallel_text xml:lang="sma" location="kultuvrejieleme_kaaanste-jih-kultuvrebarkoe_saemien-tjaelijelearoe-tseegkesaavva.html"/>
	<parallel_text xml:lang="nob" location="kulturliv_kunst-og-kulturutoevelse_samisk-forfatterstudie-etableres.html"/>
	<parallel_text xml:lang="sme" location="kultureallin_daidda-ja-kulturbargu_sami-callioahppu-asahuvvo.html"/></xsl:variable>
