...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Arkiv/Valgperiode-2009-2013/Artikler/Samediggi-angirussa-nannosit-dujiin'"/>
    ...
    <parallel_text xml:lang="sma" location="vaaarhkoe_veeljemeboelhken-2009-2013_tjaalegh_saemiedigkie-duedtiem-tjarke-daaarjede.html"/>
	<parallel_text xml:lang="nob" location="arkiv_valgperiode-2009-2013_artikler_sametinget-satser-sterkt-paa-duodji.html"/>
	<parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_samediggi-angirussa-nannosit-dujiin.html"/></xsl:variable>
