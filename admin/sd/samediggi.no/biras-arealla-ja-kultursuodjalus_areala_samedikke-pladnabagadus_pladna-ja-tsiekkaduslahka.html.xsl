...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/layout/set/print/Biras-arealla-ja-kultursuodjalus/Areala/Samedikke-pladnabagadus/Pladna-ja-tsiekkaduslahka'"/>
    ...
    <parallel_text xml:lang="sma" location="byjrese-areale-jih-kultuvrevarjelimmie_areale_samedikki-planaveahkki_soejkesje-jih-bigkemelaake.html"/>
	<parallel_text xml:lang="nob" location="miljoe-areal-og-kulturvern_areal_sametinget-planveileder_plan-og-bygningsloven.html"/>
	<parallel_text xml:lang="sme" location="biras-areala-ja-kultursuodjaleapmi_areala_samedikki-planaveahkki_plana-ja-huksenlahka.html"/></xsl:variable>
