...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samedigge.no/Ealahusat/Mearraealahusat/Ministtar-beahtta-reabbabivdiid'"/>
    ...
    <parallel_text xml:lang="sma" location="ealahusat_mearraealahusat_ministtar-beahtta-reabbabivdiid.html"/>
	<parallel_text xml:lang="nob" location="naeringer_marine-naeringer_ministeren-svikter-krabbefiskerne.html"/>
	<parallel_text xml:lang="sme" location="ealahusat_mearraealahusat_ministtar-beahtta-reabbabivdiid.html"/></xsl:variable>
