...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/lesekampanjen-sommerles-no-ogsa-pa-samiske-sprak.20879.aspx?sprak=15'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Låhkåmkampánnja Sommerles.no sámegielajda aj - Sámedigge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="lesekampanjen_sommerles_no_ogsa_pa_samiske_sprak.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="lohkemekampanje_sommerles_no_aaj_saemien_gieline.html"/>
        <parallel_text xml:lang="sme" location="lohkankampanja_sommerles_no_maid_samegielaide.html"/>
