...
<xsl:variable name="para_fin" select="'nat-min-laki-kansallisista-vahemmistoista-.html'"/>
...
<xsl:variable name="para_sma" select="'nat-min-laake-nasjovnelle-unnebelahkoej-bjre.html'"/>
<xsl:variable name="para_sme" select="'nat-min-lahka-riikkalas-unniloguid-birra.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'nat-min-ny-lag-om-nationella-minoriteter.html'"/>
