...
<xsl:variable name="para_fin" select="'nat-min-hallintoalueet.html'"/>
...
<xsl:variable name="para_sma" select="'nat-min-reeremedajvh.html'"/>
<xsl:variable name="para_sme" select="'nat-min-halddahusguovllut.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'nat-min-forvaltningsomraden.html'"/>
