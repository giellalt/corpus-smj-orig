...
<xsl:variable name="para_fin" select="'nat-min-default.html'"/>
...
<xsl:variable name="para_sma" select="'nat-min-default.html'"/>
<xsl:variable name="para_sme" select="'nat-min-default.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'nat-min-default.html'"/>
