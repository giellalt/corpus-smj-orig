...
<xsl:variable name="parallels">
	<parallel_text location="nat-min-default.html" xml:lang="fin"/>
	<parallel_text location="nat-min-default.html" xml:lang="sma"/>
	<parallel_text location="nat-min-default.html" xml:lang="sme"/>
	<parallel_text location="nat-min-default.html" xml:lang="swe"/>
</xsl:variable>
