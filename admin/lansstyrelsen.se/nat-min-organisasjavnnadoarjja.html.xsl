...
<xsl:variable name="parallels">
	<parallel_text location="nat-min-jarjestotuki.html" xml:lang="fin"/>
	<parallel_text location="nat-min-aarganisasjovnedaarjoeh.html" xml:lang="sma"/>
	<parallel_text location="nat-min-organisasuvdnadoarjja.html" xml:lang="sme"/>
	<parallel_text location="nat-min-organisationsbidrag.html" xml:lang="swe"/>
</xsl:variable>
