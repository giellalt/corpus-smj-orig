...
<xsl:variable name="para_fin" select="'nat-min-jarjestotuki.html'"/>
...
<xsl:variable name="para_sma" select="'nat-min-aarganisasjovnedaarjoeh.html'"/>
<xsl:variable name="para_sme" select="'nat-min-organisasuvdnadoarjja.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'nat-min-organisationsbidrag.html'"/>
