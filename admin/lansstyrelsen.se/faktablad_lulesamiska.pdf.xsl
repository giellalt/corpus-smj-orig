...
<xsl:variable name="para_fin" select="'faktablad_finska.pdf'"/>
...
<xsl:variable name="para_sma" select="'faktablad_sydsamiska.pdf'"/>
<xsl:variable name="para_sme" select="'faktablad_nordsamiska.pdf'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'faktablad_meänkieli.pdf'"/>
