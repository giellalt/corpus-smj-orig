...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.lansstyrelsen.se/dalarna/SiteCollectionDocuments/Sv/manniska-och-samhalle/nationella-minoriteter/Faktablad%20lulesamiska.pdf'"/>
    ...
    <xsl:variable name="sub_email" select="'unhammer+apertium@mm.st'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="faktablad_finska.pdf"/>
        ...
        <parallel_text xml:lang="sma" location="faktablad_sydsamiska.pdf"/>
        <parallel_text xml:lang="sme" location="faktablad_nordsamiska.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location=""/>
        <parallel_text xml:lang="swe" location="faktablad_meankieli.pdf"/>
    </xsl:variable>
