...
<xsl:variable name="para_fin" select="'nat-min-valtiontuki.html'"/>
...
<xsl:variable name="para_sma" select="'nat-min-staatedaarjoeh.html'"/>
<xsl:variable name="para_sme" select="'nat-min-stahtadoarjja.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'nat-min-statsbidrag.html'"/>
