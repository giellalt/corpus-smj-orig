...
<xsl:variable name="parallels">
	<parallel_text location="nat-min-laaninhallituksen-tehtavat.html" xml:lang="fin"/>
	<parallel_text location="nat-min-leenestuvrien-stilleme.html" xml:lang="sma"/>
	<parallel_text location="nat-min-leanastivrra-bargogohccumus.html" xml:lang="sme"/>
	<parallel_text location="nat-min-lansstyrelsens-uppdrag.html" xml:lang="swe"/>
</xsl:variable>
