...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/getfile.php/1471124.1172.eqfvbpxteq/Reglement+samisk.pdf'"/>
    ...
    <language xml:lang="nob"/><language xml:lang="swe"/><language xml:lang="smj"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="reglement_for_elever_ved_tysfjord_kulturskole_av_01.03.10.pdf"/>
