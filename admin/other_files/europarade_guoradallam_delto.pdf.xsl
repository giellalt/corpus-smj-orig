...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.manskligarattigheter.se/Media/Get/608/lulesamiska-pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Europaráde guoradallam'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="europaraerien_goeredimmie_delto.pdf"/>
        <parallel_text xml:lang="sme" location="europaradi_darkkisteapmi_delto.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'4=25'"/>
