...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.udir.no/upload/larerplaner/Fastsatte_lareplaner_for_Kunnskapsloeftet/Samiske/Fordypning_i_samisk_lulesamisk.rtf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'SÁMEGIELA TJIEGŊODIBME - OAHPPOPLÁDNA'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'913'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="lareplan_i_fordypning_samisk_bokmal.doc"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="fordypning_i_samisk_sorsamisk.doc"/>
        <parallel_text xml:lang="sme" location="fordypning_i_samisk_nordsamisk.doc"/>
