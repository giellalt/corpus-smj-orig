...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.manskligarattigheter.se/dm3/file_archive/081104/3d521ec27614dda9f3524b1dfc43822c/lulesamiska.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Rijkalasj unneplågo ja unneplågogiela'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="nasjovne_unnebelahkoe_jih_unnebelahkoegielh.pdf"/>
        <parallel_text xml:lang="sme" location="nasuvnnalas_unnitlogut_ja_unnitlogugielat.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'2=22'"/>
