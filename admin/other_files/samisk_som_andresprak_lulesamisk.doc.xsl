...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.udir.no/upload/larerplaner/Fastsatte_lareplaner_for_Kunnskapsloeftet/Samiske/Samisk_som_andresprak_lulesamisk.rtf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'SÁMEGIELLA NUBBENGIELLAN, SÁMEGIELLA 2 JA SÁMEGIELLA 3 - OAHPPOPLÁDNA'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'3178'"/>
    ...
    <xsl:variable name="note" select="'Converted from rtf to doc with OpenOffice.org'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="samisk_som_andresprak_bokmal.doc"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="samisk_som_andresprak_sorsamisk.doc"/>
        <parallel_text xml:lang="sme" location="samisk_som_andresprak_samisk_2_og_3.doc"/>
