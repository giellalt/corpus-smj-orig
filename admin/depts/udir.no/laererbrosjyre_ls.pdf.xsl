...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.udir.no/Upload/Nasjonale_prover/2012/lærerbrosjyre/laererbrosjyre_ls.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="laererbrosjyre_ss.pdf"/>
        <parallel_text xml:lang="sme" location="laererbrosjyre_ns.pdf"/>
