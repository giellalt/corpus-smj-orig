...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/Upload/Nasjonale_prover/2012/Foreldrebrosjyrer/UDIR_Foreldrebrosjyre_2012_Lulesamisk.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="udir_foreldrebrosjyre_2012_sorsamisk.pdf"/></xsl:variable>
