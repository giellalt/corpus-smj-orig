...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.udir.no/globalassets/filer/regelverk/tidlig-innsats/foreldreinfo/lulesamisk_spesundervisning_foreldre.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PP-dievnastus ja sierraåhpadibme'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="spesundervisning_foreldre_nob.pdf"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="spesundervisning_foreldre_sma.pdf"/>
        <parallel_text xml:lang="sme" location="spesundervisning_foreldre_sme.pdf"/>
