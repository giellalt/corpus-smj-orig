...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/Upload/Nasjonale_prover/2013/Foreldrebrosjyrer/UDIR_Foreldrebrosjyre_2013_Lulesamisk.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="udir_foreldrebrosjyre_2013_sa_rsamisk.pdf"/></xsl:variable>
