...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://veiledninger.udir.no/Samisk%20andrespr%e5k/www.udir.no/Lareplaner/Veiledninger-til-lareplaner/Revidert-2013/Samisk-som-andrespraak/Samegiella-nubbengiellan-samegiella-2-ja-samegi/Hoyremeny-toppniva/Generell-litteratur-og-larestoff/index.html'"/>
    ...
    <parallel_text xml:lang="nob" location="16_generell-litteratur-og-larestoff.html"/>
	<parallel_text xml:lang="sma" location="16_generell-litteratur-og-larestoff.html"/>
	<parallel_text xml:lang="sme" location="16_generell-litteratur-og-larestoff.html"/></xsl:variable>
