...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/PageFiles/82438/UDIR_Foreldrebrosjyre_2014_LULESAMISK.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="udir_foreldrebrosjyre_2014_sorsamisk.pdf"/>
	<parallel_text xml:lang="sme" location="udir_foreldrebrosjyre_2014_nordsamisk.pdf"/></xsl:variable>
