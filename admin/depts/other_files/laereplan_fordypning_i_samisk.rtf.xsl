...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/Upload/larerplaner/Fastsatte_lareplaner_for_Kunnskapsloeftet/Samiske/planer_samisk/Samisk/Fordypning_i_samisk_lulesamisk.rtf'"/>
    ...
    <parallel_text xml:lang="sme" location="laereplan_fordypning_i_samisk.rtf"/>
	<parallel_text xml:lang="sma" location="laereplan_fordypning_i_samisk.rtf"/>
	<parallel_text xml:lang="nob" location="laereplan_fordypning_i_samisk.html"/></xsl:variable>
