...
<xsl:variable name="filename" select="'http://www.regjeringen.no/Upload/AID/temadokumenter/sami/sami_samekonv_lulesamisk.pdf'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sami_samekonv_engelsk.pdf" xml:lang="eng"/>
	<parallel_text location="sami_samekonv_sorsamisk.pdf" xml:lang="sma"/>
</xsl:variable>
