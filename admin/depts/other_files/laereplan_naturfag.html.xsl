...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/kl06/NAT2-03/Hele/Komplett_visning?lplang=smj&amp;read=1'"/>
    ...
    <parallel_text xml:lang="nob" location="laereplan_naturfag.html"/>
	<parallel_text xml:lang="sma" location="laereplan_naturfag.html"/>
	<parallel_text xml:lang="sme" location="laereplan_naturfag.html"/></xsl:variable>
