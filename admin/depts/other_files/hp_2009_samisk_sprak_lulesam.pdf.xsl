...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.regjeringen.no/upload/FAD/Vedlegg/SAMI/HP_2009_samisk_sprak_lulesam.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Same gielaj doajmmapladna'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'22000'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="hp_2009_samisk_sprak_norsk.pdf"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="handlingsplan_2009_samisk_sprak_sorsamisk.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-6, 59, 67'"/>
    ...
    <xsl:variable name="top_margin" select="'all=7, 8=39, 63=43'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'42=3, 47=3, 52=3, 58=3, 60=55, 61=46'"/>
    <xsl:variable name="inner_left_margin" select="'42=44, 47=52, 52=42, 58=42, 60=3, 61=3'"/>
    <xsl:variable name="inner_top_margin" select="'42=3, 47=3, 52=3, 58=41, 60=3, 61=26'"/>
    <xsl:variable name="inner_bottom_margin" select="'42=50, 47=50, 52=28, 58=3, 60=44, 61=45'"/>
...
<xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
               <xsl:with-param name="inputString" select="$text"/>
               <xsl:with-param name="target" select="'1�/2�/3�/4�/5�/6�/7�/8�/9�/'"/>
