...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/upload/larerplaner/fastsatte_lareplaner_for_kunnskapsloeftet/samiske/planer_samisk/samisk/lareplan-samisk-som-forstesprak-sfs1-04-lulesamisk.docx'"/>
	...
	<parallel_text xml:lang="sme" location="laereplan_samisk_foerstespraak.html"/></xsl:variable>
