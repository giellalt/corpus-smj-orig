...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fin/preassaguovdda/pressemeldinger/2013/oecd-doajmmaplanajn-nuoraj-vuoksjuj-ja-v.html?id=728488'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'OECD doajmmaplánajn nuoraj vuoksjuj ja værrogarvvema vuosstij - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'599'"/>
...
<xsl:variable name="para_eng" select="'strengthened-cooperation-in-the-north.html_id=728955'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kostnadsramme-for-nytt-nasjonalmuseum.html_id=729282'"/>
<xsl:variable name="para_nob" select="'oecd-med-handlingsplan-for-ungdom-og-mot.html_id=728488'"/>
<xsl:variable name="para_sma" select="'politiijaielggadeapmi-geigejuvvui-faremo.html_id=730801'"/>
<xsl:variable name="para_sme" select="'falaldatgilvu-doaimmahit-digitala-poastt.html_id=728771'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="oecd-med-handlingsplan-for-ungdom-og-mot_id_728488.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 930560ee28 (Lule Saami regjeringen.no doc renamed, metadata updated in parallel files)
