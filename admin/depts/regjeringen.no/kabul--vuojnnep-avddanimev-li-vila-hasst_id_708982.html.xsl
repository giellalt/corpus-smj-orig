...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="kabul-visible-progress-though-challenges_id_708982.html"/>
        ...
        <parallel_text xml:lang="nob" location="kabul--ser-fremgang-gjenstar-utfordringe_id_708982.html"/>
