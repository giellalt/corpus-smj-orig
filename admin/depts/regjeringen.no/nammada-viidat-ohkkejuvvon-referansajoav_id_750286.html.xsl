...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="author1_ln" select="'Gielda- ja ođasmahttindepartemeanta'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="per-edgar-kokkvold-ny-leiar-for-kringkas_id_751233.html"/>
        <parallel_text xml:lang="nob" location="oppnevner-bredt-sammensatt-referansegrup_id_750286.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location=""/>
        <parallel_text xml:lang="sme" location="raehus-dahttu-joatkit-investerendoarjagi_id_750382.html"/>
