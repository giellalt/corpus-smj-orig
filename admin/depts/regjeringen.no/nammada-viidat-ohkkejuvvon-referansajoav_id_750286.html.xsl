...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kmd/preassaguovdda/preassadieahusat/2014/nammada-viidat-ohkkejuvvon-referansajoav.html?id=750286'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Nammada viidát čohkkejuvvon referánsajoavkku - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1082'"/>
...
<xsl:variable name="para_nno" select="'per-edgar-kokkvold-ny-leiar-for-kringkas.html_id=751233'"/>
<xsl:variable name="para_nob" select="'oppnevner-bredt-sammensatt-referansegrup.html_id=750286'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'raehus-dahttu-joatkit-investerendoarjagi.html_id=750382'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="oppnevner-bredt-sammensatt-referansegrup.html_id=750286" xml:lang="nob"/>
