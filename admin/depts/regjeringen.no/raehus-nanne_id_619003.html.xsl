...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/pressesenter/pressemeldinger/2010/raehus-nanne.html?id=619003'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ráđđehus nanne sámi gielaid áŋgiruššama - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'992'"/>
    ...
    <!-- Automatically filled in by CorpusTools -->
    <xsl:variable name="template_version" select="'$Revision: 34129 $'"/>
    <!-- Automatically filled in by CorpusTools -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="regjeringen-styrker-satsingen-pa-samiske_id_619003.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="raehus-nanne_id_619003.html"/>
        <parallel_text xml:lang="sme" location="raehus-nanne_id_619003.html"/>
