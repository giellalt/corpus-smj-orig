...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/aktuelt/nyheter/2012/sjiehtadus-oaggit-vuona-virgalattjajt-al.html?id=708369'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sjiehtadus oaggit vuona virgálattjajt ålggorijkajn - regjeringen.no'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="''"/>
    <xsl:variable name="author1_ln" select="'Justiisa- ja gearggusvuođadepartemeanta'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="wordcount" select="'600'"/>
    ...
    <language xml:lang="smj"/><language xml:lang="sma"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="avtale-sikrer-norsk-personell-i-utlandet_id_708369.html"/>
