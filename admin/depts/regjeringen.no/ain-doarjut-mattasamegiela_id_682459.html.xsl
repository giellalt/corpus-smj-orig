...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'686'"/>
=======
...
<xsl:variable name="para_eng" select="'increased-tax-revenues-for-the-local-gov.html_id=682335'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'vidareforer-satsing-pa-sorsamisk-sprak.html_id=682459'"/>
<xsl:variable name="para_nob" select="'videreforer-satsing-pa-sorsamisk-sprak.html_id=682459'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'johtilis-vaiddameannudeapmi-almmola-hahk.html_id=682461'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="ain-doarjut-mattasamegiela.html_id=682459" xml:lang="sma"/>
