...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/pressesenter/pressemeldinger/2012/humlegard-sjadda-ada-politidirektorra-.html?id=708441'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Humlegård sjaddá ådå politidirektørra  - regjeringen.no'"/>
...
<xsl:variable name="para_nob" select="'humlegard-blir-ny-politidirektor-.html_id=708441'"/>
<xsl:variable name="para_sma" select="'nannoesabpoe-klijmaraajvarimmieh-jih-voe.html_id=710557'"/>
<xsl:variable name="para_sme" select="'surrogatiija-.html_id=660199'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="humlegard-blir-ny-politidirektor-_id_708441.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 930560ee28 (Lule Saami regjeringen.no doc renamed, metadata updated in parallel files)
