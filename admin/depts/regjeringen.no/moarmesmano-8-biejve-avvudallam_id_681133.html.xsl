...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/aigeguovdil/nyheter/2012/moarmesmano-8-biejve-avvudallam.html?id=681133'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Moarmesmáno 8. biejve ávvudallam - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'264'"/>
...
<xsl:variable name="para_eng" select="'amendments-to-the-mental-health-care-act.html_id=682169'"/>
...
<xsl:variable name="para_nob" select="'markering-av-8-mai.html_id=681133'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'preassakonferansa-2012-darkkistuvvon-nat.html_id=681969'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="markering-av-8-mai_id_681133.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 930560ee28 (Lule Saami regjeringen.no doc renamed, metadata updated in parallel files)
