...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ad/preassaguovdda/preassadieahusat/2012/virggevahagahttemadastus.html?id=682373'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Fidnovihkeođastus - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'714'"/>
    ...
    <language xml:lang="nob"/><language xml:lang="sma"/><language xml:lang="smj"/><language xml:lang="sme"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="yrkesskadereform_id_682373.html"/>
        <parallel_text xml:lang="nob" location="yrkesskadereform_id_682373.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="virggevahagahttemadastus_id_682373.html"/>
        <parallel_text xml:lang="sme" location="virggevahagahttemadastus_id_682373.html"/>
