...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/smk/aigeguovdil/sartnit-ja-artihkkalat/statsministeren/statsminister_jens_stoltenberg/2012/halla-friddjabessambiejven-ja-nasjonala-.html?id=681132'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Hålla friddjabessambiejven ja nasjonála veteránbiejve, moarmesmáno 8. biejve 2012  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'640'"/>
...
<xsl:variable name="para_eng" select="'financial-markets-report.html_id=682184'"/>
...
<xsl:variable name="para_nob" select="'tale-pa-frigjorings--og-veterandagen-8-m.html_id=681132'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'moarmesmano-8-biejve-avvudallam.html_id=681133'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tale-pa-frigjorings--og-veterandagen-8-m.html_id=681132" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 930560ee28 (Lule Saami regjeringen.no doc renamed, metadata updated in parallel files)
