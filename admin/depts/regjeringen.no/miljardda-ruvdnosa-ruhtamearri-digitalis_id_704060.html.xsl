...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2012/miljardda-ruvdnosa-ruhtamearri-digitalis.html?id=704060'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Miljárdda ruvdnosaš ruhtamearri digitaliseremii - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'2220'"/>
...
<xsl:variable name="para_nno" select="'meir-til-naturinformasjon-og-forvalting.html_id=703559'"/>
<xsl:variable name="para_nob" select="'milliardbelop-til-digitalisering.html_id=704060'"/>
<xsl:variable name="para_sma" select="'raavrevijhke-saemien-gielen-reeremedajve.html_id=704691'"/>
<xsl:variable name="para_sme" select="'bidja-arjjaid-sami-kultur--ja-gielladoai.html_id=703581'"/>
