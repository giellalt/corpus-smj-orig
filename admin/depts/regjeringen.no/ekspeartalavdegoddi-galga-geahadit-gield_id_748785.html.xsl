...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/kmd/preassaguovdda/preassadieahusat/2014/ekspeartalavdegoddi-galga-geahadit-gield.html?id=748785'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ekspeartalávdegoddi galgá geahčadit gielddaid bargamušaid - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1085'"/>
...
<xsl:variable name="para_eng" select="'first-load-of-chemical-weapons-has-left-.html_id=748879'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'endringar-i-privatskolelova.html_id=749098'"/>
<xsl:variable name="para_nob" select="'ekspertutvalg.html_id=748785'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'olahusjahki-norgga-mearraborramua-olgori.html_id=748798'"/>
