...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/nhd/preassaguovdda/preassadieahusat/2012/19-gisjugisvuoda-libjjav-oadtju.html?id=685913'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'19 gisjugisvuoda libjjáv oadtju - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'497'"/>
...
<xsl:variable name="para_nob" select="'19-far-medaljen-for-edel-dad.html_id=685913'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'slagsvold-vedum-nammaduvvon-oa-eanandoal.html_id=685949'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="19-far-medaljen-for-edel-dad_id_685913.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 930560ee28 (Lule Saami regjeringen.no doc renamed, metadata updated in parallel files)
