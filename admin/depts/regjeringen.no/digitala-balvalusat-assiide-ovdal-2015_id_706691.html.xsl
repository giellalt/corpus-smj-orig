...
<xsl:variable name="para_nob" select="'digitale-tjenester-til-innbyggerne-innen.html_id=706691'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'2013-kulturbueahtta--finnmarku.html_id=707179'"/>
