...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/ad/preassaguovdda/preassadieahusat/2012/alkkep-oadtjot-bargodisvuodarudajt-ga-le.html?id=682364'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Guolleindustriijas galgá álkit oažžut beaiveruđa jos permitterejuvvo gaskaboddosaččat - regjeringen.no'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="''"/>
    <xsl:variable name="author1_ln" select="'Bargodepartemeanta'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="wordcount" select="'513'"/>
    ...
    <language xml:lang="sme"/><language xml:lang="sma"/><language xml:lang="smj"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="lettere-a-fa-dagpenger-for-delvis-permit_id_682364.html"/>
        <parallel_text xml:lang="nob" location="lettere-a-fa-dagpenger-for-delvis-permit_id_682364.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="alkkep-oadtjot-bargodisvuodarudajt-ga-le_id_682364.html"/>
        <parallel_text xml:lang="sme" location="alkkep-oadtjot-bargodisvuodarudajt-ga-le_id_682364.html"/>
