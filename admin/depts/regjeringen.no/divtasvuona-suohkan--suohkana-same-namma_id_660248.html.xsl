...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/se/dep/krd/preassaguovdda/Preassadieahusat/2011/divtasvuona-suohkan--suohkana-same-namma.html?id=660248'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Divtasvuona suohkan – suohkana sáme namma  - regjeringen.no'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="''"/>
    <xsl:variable name="author1_ln" select="'Gielda- ja guovlodepartemeanta'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="wordcount" select="'193'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="tysfjord-kommune--samisk-navn-pa-kommune_id_660248.html"/>
