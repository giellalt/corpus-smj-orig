...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/oasat/taler_og_artikler/av_ovrig_politisk_ledelse/taler-og-artikler-av-statssekretar-raimo/2011/dearvvahansardni-daiddaskuvlla-rahpandil.html?id=654228'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Dearvvahansárdni dáiddaskuvlla rahpandilálašvuhtii Kárášjogas  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1116'"/>
...
<xsl:variable name="para_eng" select="'nok-five-billion-more-to-local-authoriti.html_id=657120'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'komm-pressemelding-1-3.html_id=657120'"/>
<xsl:variable name="para_nob" select="'kunstskolen-i-karasjok.html_id=654228'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'15-miljovnna-kruvnno-govdaoallai.html_id=654357'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kunstskolen-i-karasjok_id_654228.html" xml:lang="nob"/>
<parallel_text location="prime-ministers-address-at-the-city-hall_id_651840.html" xml:lang="eng"/>
</xsl:variable>
>>>>>>> 930560ee28 (Lule Saami regjeringen.no doc renamed, metadata updated in parallel files)
