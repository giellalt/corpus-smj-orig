...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Aigeguovdil/Oasat/2009/gonagasla-majestehta-sardni-6-samedikki-.html?id=581643'"/>
<xsl:variable name="title" select="'Gonagaslaš Majestehta sárdni 6. Sámedikki rahpama oktavuođas golggotmánu 13.b. 2009 - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'2384'"/>
...
<xsl:variable name="para_nob" select="'kongen-apnet-sametinget.html?id=581643'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kongen-apnet-sametinget_id_581643.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 930560ee28 (Lule Saami regjeringen.no doc renamed, metadata updated in parallel files)
