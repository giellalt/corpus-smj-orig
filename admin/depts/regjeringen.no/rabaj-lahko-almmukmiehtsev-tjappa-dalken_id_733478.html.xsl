...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="author1_ln" select="'Birasgáhttendepartemeanta'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="recommend-demolition-of-the-damaged-buil_id_731758.html"/>
        ...
        <parallel_text xml:lang="nob" location="apnet-lahko-nasjonalpark-i-stralende-var_id_733478.html"/>
