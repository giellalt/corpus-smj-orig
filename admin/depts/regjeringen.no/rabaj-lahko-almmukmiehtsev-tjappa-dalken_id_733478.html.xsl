...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/md/Fadda/Preassaguovdda/2013/rabaj-lahko-almmukmiehtsev-tjappa-dalken.html?id=733478'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Rabáj Láhko álmmukmiehtsev tjáppa dálken - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'460'"/>
...
<xsl:variable name="para_nob" select="'apnet-lahko-nasjonalpark-i-stralende-var.html_id=733478'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="apnet-lahko-nasjonalpark-i-stralende-var.html_id=733478" xml:lang="nob"/>
<parallel_text location="recommend-demolition-of-the-damaged-buil_id_731758.html" xml:lang="eng"/>
</xsl:variable>
>>>>>>> 930560ee28 (Lule Saami regjeringen.no doc renamed, metadata updated in parallel files)
