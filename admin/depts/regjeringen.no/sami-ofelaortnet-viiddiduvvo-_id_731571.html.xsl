...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/fad/preassaguovdda/preassadieahusat/2013/sami-ofelaortnet-viiddiduvvo-.html?id=731571'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sámi ofelašortnet viiddiduvvo  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'856'"/>
...
<xsl:variable name="para_nno" select="'ekspertgruppe-pa-pengespel.html_id=731706'"/>
<xsl:variable name="para_nob" select="'den-samiske-veiviserordningen-utvides.html_id=731571'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ruhtaspealuid-ekspeartajoavku.html_id=731706'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="den-samiske-veiviserordningen-utvides_id_731571.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 930560ee28 (Lule Saami regjeringen.no doc renamed, metadata updated in parallel files)
