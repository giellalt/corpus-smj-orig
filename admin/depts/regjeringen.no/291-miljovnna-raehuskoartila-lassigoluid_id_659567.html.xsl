...
<xsl:variable name="para_eng" select="'nok-268-billion-to-rural-and-regional-po.html_id=657051'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'komm-pressemelding-1.html_id=657051'"/>
<xsl:variable name="para_nob" select="'291-millioner-til-ekstrakostnader-i-regj.html_id=659567'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'nanne-ovttasbarggu-oktasaat-avkkala-orga.html_id=659573'"/>
