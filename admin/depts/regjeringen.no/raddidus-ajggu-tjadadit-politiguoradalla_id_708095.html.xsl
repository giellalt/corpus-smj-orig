...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/jd/pressesenter/pressemeldinger/2012/raddidus-ajggu-tjadadit-politiguoradalla.html?id=708095'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ráddidus ájggu tjadádit politiguoradallamav - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'633'"/>
...
<xsl:variable name="para_nno" select="'sju-millionar-til-ikt-i-domstolane-.html_id=708095'"/>
<xsl:variable name="para_nob" select="'konkurranse-om-levering-av-digital-post.html_id=708247'"/>
<xsl:variable name="para_sma" select="'nannoesabpoe-klijmaraajvarimmieh-jih-voe.html_id=710557'"/>
<xsl:variable name="para_sme" select="'gilvu-doaimmahit-digitala-poastta.html_id=708247'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sju-millionar-til-ikt-i-domstolane-_id_708095.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> 930560ee28 (Lule Saami regjeringen.no doc renamed, metadata updated in parallel files)
