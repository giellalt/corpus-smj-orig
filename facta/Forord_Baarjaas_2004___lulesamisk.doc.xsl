...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Forord_Ba_rja_s_2004___lulesamisk.doc'"/>
  <xsl:variable name="title" select="'Forord BÃ¥rjÃ¥s 2004'"/>
  <xsl:variable name="author1_fn" select="'Lars BÃ¸rge'"/>
  <xsl:variable name="author1_ln" select="'Myklevoll'"/>
