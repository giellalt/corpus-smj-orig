...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Christina_A___½hren_sammendrag.doc'"/>
  <xsl:variable name="title" select="'Mattias le nuora sÃ¡me bÃ¡httja'"/>
  <xsl:variable name="author1_fn" select="'Christina'"/>
  <xsl:variable name="author1_ln" select="'Ãhren'"/>
