...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Eksamensdahkam._2.giella.doc'"/>
  <xsl:variable name="title" select="'JulevsÃ¡megiella/Lulesamisk'"/>
  ...
  <xsl:variable name="wordcount" select="'407'"/>
