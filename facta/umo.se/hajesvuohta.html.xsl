...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Hajesvuohta'"/>
    ...
    <parallel_text xml:lang="fin" location="alakuloisuus.html"/>
	<parallel_text xml:lang="fit" location="matalapaine-eli-alakulonen.html"/>
	<parallel_text xml:lang="rmf" location="mulano.html"/>
	<parallel_text xml:lang="rmu" location="togalopha.html"/>
	<parallel_text xml:lang="rmy-rka" location="tristimos.html"/>
	<parallel_text xml:lang="rmy-rlo" location="depresirime.html"/>
	<parallel_text xml:lang="sma" location="hujnesne.html"/>
	<parallel_text xml:lang="sme" location="lossesvuohta.html"/>
	<parallel_text xml:lang="swe" location="nedstamdhet.html"/></xsl:variable>
