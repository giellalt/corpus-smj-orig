...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/P-tablahtta'"/>
    ...
    <parallel_text xml:lang="fin" location="ehkaisypilleri.html"/>
	<parallel_text xml:lang="fit" location="p-pilleri.html"/>
	...
	<parallel_text xml:lang="rmy-rka" location="preventivno-drab.html"/>
	<parallel_text xml:lang="rmy-rlo" location="p-piller.html"/>
	<parallel_text xml:lang="sma" location="p-pillere.html"/>
	<parallel_text xml:lang="sme" location="p-pillar.html"/>
	<parallel_text xml:lang="swe" location="p-piller.html"/></xsl:variable>
