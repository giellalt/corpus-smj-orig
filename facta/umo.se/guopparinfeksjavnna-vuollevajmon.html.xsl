...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Guopparinfeksjavnna-vuollevajmon'"/>
    ...
    <parallel_text xml:lang="fin" location="hiivatulehdus.html"/>
	<parallel_text xml:lang="fit" location="svamppia-sukuelimessa-eli-alapaassa.html"/>
	<parallel_text xml:lang="rmf" location="balanis-aro-teluni-trupos.html"/>
	<parallel_text xml:lang="rmn" location="parnothavdipa.html"/>
	<parallel_text xml:lang="rmu" location="rappani-an-minshe.html"/>
	<parallel_text xml:lang="rmy-rka" location="infektacija-makar-le-purne.html"/>
	<parallel_text xml:lang="rmy-rlo" location="fungus-svamp-ande-telunipe-vagina-penis.html"/>
	<parallel_text xml:lang="sma" location="goebperh-tsavhnosne.html"/>
	<parallel_text xml:lang="sme" location="guoppar-vuolledabiin.html"/>
	<parallel_text xml:lang="swe" location="svamp-i-underlivet.html"/></xsl:variable>
