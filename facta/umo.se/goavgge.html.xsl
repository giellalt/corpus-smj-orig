...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Goavgge'"/>
    ...
    <parallel_text xml:lang="fin" location="ahdistus.html"/>
	<parallel_text xml:lang="fit" location="ahistus.html"/>
	<parallel_text xml:lang="rmf" location="dar.html"/>
	<parallel_text xml:lang="rmn" location="baridar.html"/>
	<parallel_text xml:lang="rmu" location="nervolo.html"/>
	<parallel_text xml:lang="rmy-rka" location="dar.html"/>
	<parallel_text xml:lang="rmy-rlo" location="ongesto.html"/>
	<parallel_text xml:lang="sma" location="asve.html"/>
	<parallel_text xml:lang="sme" location="aestus.html"/>
	<parallel_text xml:lang="swe" location="angest.html"/></xsl:variable>
