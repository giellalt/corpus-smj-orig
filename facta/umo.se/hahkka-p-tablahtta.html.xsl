...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Hahkka-p-tablahtta'"/>
    ...
    <parallel_text xml:lang="fin" location="jalkiehkaisypilleri.html"/>
	<parallel_text xml:lang="fit" location="akyytti-p-pilleri.html"/>
	<parallel_text xml:lang="rmf" location="sigutno-p-pilleri-akut-p-pilleri.html"/>
	<parallel_text xml:lang="rmn" location="akutno-pipula.html"/>
	<parallel_text xml:lang="rmu" location="kris-p-drabb.html"/>
	<parallel_text xml:lang="rmy-rka" location="akutno-p-drab.html"/>
	<parallel_text xml:lang="rmy-rlo" location="akutno-p-piller-preventivno-tabletka.html"/>
	<parallel_text xml:lang="sma" location="akute-p-pillere.html"/>
	<parallel_text xml:lang="sme" location="fahkkatla-p-pillar.html"/>
	<parallel_text xml:lang="swe" location="akut-p-piller.html"/></xsl:variable>
