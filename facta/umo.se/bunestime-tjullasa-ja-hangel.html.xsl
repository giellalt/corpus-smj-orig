...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Bunestime-tjullasa-ja-hangel'"/>
    ...
    <parallel_text xml:lang="fin" location="pussailu-suutelu-ja-hyvaily.html"/>
	<parallel_text xml:lang="fit" location="muiskuja-pyssia-ja--kuherteluahonglaamista.html"/>
	...
	<parallel_text xml:lang="rmy-rka" location="umidimos-aj-asbajimos.html"/>
	<parallel_text xml:lang="rmy-rlo" location="vut-umidipe-thaj-hangel-seksualno-khelipe.html"/>
	<parallel_text xml:lang="sma" location="tjonnestidh-tjuvliestidh-jih-gijhkierdidh.html"/>
	<parallel_text xml:lang="sme" location="cummat-ja-rahkastallan.html"/>
	<parallel_text xml:lang="swe" location="pussar-kyssar-och-hangel.html"/></xsl:variable>
