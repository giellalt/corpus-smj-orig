...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Suovastibme'"/>
    ...
    <parallel_text xml:lang="fin" location="tupakointi.html"/>
	<parallel_text xml:lang="fit" location="polttaminen-eli-tupakointi.html"/>
	...
	<parallel_text xml:lang="rmy-rka" location="te-phes-duhano.html"/>
	<parallel_text xml:lang="rmy-rlo" location="kana-pel-pe-duxano.html"/>
	<parallel_text xml:lang="sma" location="rievhkestimmie.html"/>
	<parallel_text xml:lang="sme" location="borgguheapmi.html"/>
	<parallel_text xml:lang="swe" location="rokning.html"/></xsl:variable>
