...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Seksualak-tjardda-bi-hetero-homo'"/>
    ...
    <parallel_text xml:lang="fin" location="seksuaalinen-suuntautuminen--bi-hetero-homo-.html"/>
	<parallel_text xml:lang="fit" location="seksuaalinen-taipumus--biiseksuaalinen-hetero-homo.html"/>
	...
	<parallel_text xml:lang="sma" location="seksuellen-syjhtede--bi-heteroe-homoe.html"/>
	<parallel_text xml:lang="sme" location="seksualala-sodju---bi-hetero-homo.html"/>
	<parallel_text xml:lang="swe" location="sexuell-laggning---hetero-homo-bi.html"/>
	<parallel_text xml:lang="yid" location="seksuelse-nejgung---baj-hetero-homo.html"/></xsl:variable>
