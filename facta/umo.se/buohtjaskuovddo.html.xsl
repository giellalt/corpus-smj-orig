...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Buohtjaskuovddo'"/>
    ...
    <parallel_text xml:lang="fin" location="kondomi.html"/>
	<parallel_text xml:lang="fit" location="kontoomi.html"/>
	...
	<parallel_text xml:lang="sma" location="kondome.html"/>
	<parallel_text xml:lang="sme" location="kondoma.html"/>
	<parallel_text xml:lang="swe" location="kondom.html"/></xsl:variable>
