...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Seksa-vuostasj-bale'"/>
    ...
    <parallel_text xml:lang="fin" location="eka-kerta.html"/>
	<parallel_text xml:lang="fit" location="seksia-ensi-kerran.html"/>
	<parallel_text xml:lang="rmf" location="seksi-vaguno-var.html"/>
	<parallel_text xml:lang="rmn" location="seksi-o-prvo-puti.html"/>
	<parallel_text xml:lang="rmu" location="jeckesta-tjiron-gla-bulopha.html"/>
	<parallel_text xml:lang="rmy-rka" location="buledimos-angluni-data.html"/>
	<parallel_text xml:lang="rmy-rlo" location="sekso-angluni-data.html"/>
	<parallel_text xml:lang="sma" location="sekse-voestes-aejkien.html"/>
	<parallel_text xml:lang="sme" location="seksa-vuostta-geardde.html"/>
	<parallel_text xml:lang="swe" location="sex-forsta-gangen.html"/>
	<parallel_text xml:lang="yid" location="seks-tsum-ershtn-mol.html"/></xsl:variable>
