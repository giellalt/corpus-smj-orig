...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Pubertahtta'"/>
    ...
    <parallel_text xml:lang="fin" location="murrosika.html"/>
	<parallel_text xml:lang="fit" location="pyberteetti.html"/>
	<parallel_text xml:lang="rmf" location="puberiteti.html"/>
	<parallel_text xml:lang="rmn" location="puberteti.html"/>
	<parallel_text xml:lang="rmu" location="puberteten.html"/>
	<parallel_text xml:lang="rmy-rka" location="kana-e-glata-kerdol-ternimata.html"/>
	<parallel_text xml:lang="rmy-rlo" location="puberteto.html"/>
	<parallel_text xml:lang="sma" location="puberteete.html"/>
	<parallel_text xml:lang="sme" location="ravasmanahki.html"/>
	<parallel_text xml:lang="swe" location="puberteten.html"/></xsl:variable>
