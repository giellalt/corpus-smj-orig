...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Minoritetssprakstext'"/>
    ...
    <parallel_text xml:lang="fin" location="ruotsin-kansalliset-vahemmistot-ja-vahemmistokielet.html"/>
	<parallel_text xml:lang="fit" location="ruottin-kansaliset-vahemistot-ja-niitten-kielet.html"/>
	...
	<parallel_text xml:lang="sma" location="sveerjen-nasjovnelle-unnebelahkoeh-jih-dej-gielh.html"/>
	<parallel_text xml:lang="sme" location="ruoa-nauvnnala-minoritehtat-ja-sin-giella.html"/>
	<parallel_text xml:lang="swe" location="nationella-minoritetssprak.html"/></xsl:variable>
