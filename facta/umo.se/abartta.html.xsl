...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Abartta'"/>
    ...
    <parallel_text xml:lang="fin" location="abortti.html"/>
	<parallel_text xml:lang="fit" location="abortti.html"/>
	...
	<parallel_text xml:lang="sma" location="abort.html"/>
	<parallel_text xml:lang="sme" location="aborta.html"/>
	<parallel_text xml:lang="swe" location="abort.html"/></xsl:variable>
