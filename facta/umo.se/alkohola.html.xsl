...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Alkohola'"/>
    ...
    <parallel_text xml:lang="fin" location="alkoholi.html"/>
	<parallel_text xml:lang="fit" location="alkkuhooli.html"/>
	<parallel_text xml:lang="rmf" location="alkoholi.html"/>
	<parallel_text xml:lang="rmn" location="alkoholi.html"/>
	<parallel_text xml:lang="rmu" location="alkohol.html"/>
	<parallel_text xml:lang="rmy-rka" location="alkoholo.html"/>
	<parallel_text xml:lang="rmy-rlo" location="alkoholo.html"/>
	<parallel_text xml:lang="sma" location="alkohole.html"/>
	<parallel_text xml:lang="sme" location="alkohola.html"/>
	<parallel_text xml:lang="swe" location="alkohol.html"/></xsl:variable>
