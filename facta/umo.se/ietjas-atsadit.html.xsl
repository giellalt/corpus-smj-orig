...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Ietjas-atsadit'"/>
    ...
    <parallel_text xml:lang="fin" location="seksitautitestit.html"/>
	<parallel_text xml:lang="fit" location="testata-ittea.html"/>
	...
	<parallel_text xml:lang="sma" location="teestedh.html"/>
	<parallel_text xml:lang="sme" location="testet-ieas.html"/>
	<parallel_text xml:lang="swe" location="att-testa-sig.html"/></xsl:variable>
