...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska'"/>
    ...
    <parallel_text xml:lang="eng" location="umo-in-english.html"/>
	<parallel_text xml:lang="fin" location="finska.html"/>
	<parallel_text xml:lang="fit" location="meankieli.html"/>
	...
	<parallel_text xml:lang="sma" location="sydsamiska.html"/>
	<parallel_text xml:lang="sme" location="nordsamiska.html"/>
	<parallel_text xml:lang="yid" location="jiddisch-latinsk.html"/></xsl:variable>
