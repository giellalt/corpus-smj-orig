...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Gatjastusa-nannusap-iesjdabdduj'"/>
    ...
    <parallel_text xml:lang="eng" location="how-to-improve-self-esteem.html"/>
	<parallel_text xml:lang="fin" location="vinkkeja-itsetunnon-kohentamiseen.html"/>
	<parallel_text xml:lang="fit" location="tipsia-kuinka-parantaa-ommaa-ittentuntoa.html"/>
	...
	<parallel_text xml:lang="sma" location="raerieh-buerebe-jijtjedomtesasse.html"/>
	<parallel_text xml:lang="sme" location="guoiggus-buoret-iedovdui.html"/>
	<parallel_text xml:lang="swe" location="tips-for-battre-sjalvkansla.html"/>
	<parallel_text xml:lang="yid" location="rejchern.html"/></xsl:variable>
