...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Nuppastibme'"/>
    ...
    <parallel_text xml:lang="fin" location="kiusaaminen.html"/>
	<parallel_text xml:lang="fit" location="mobbaus-eli-mobbinki.html"/>
	<parallel_text xml:lang="rmf" location="holjiba.html"/>
	<parallel_text xml:lang="rmn" location="mobibe.html"/>
	...
	<parallel_text xml:lang="sma" location="irhkeme.html"/>
	<parallel_text xml:lang="sme" location="givssideapmi.html"/>
	<parallel_text xml:lang="swe" location="mobbning.html"/></xsl:variable>
