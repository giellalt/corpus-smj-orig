...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Lulesamiska/Liejbbe'"/>
    ...
    <parallel_text xml:lang="fin" location="kuukautiset.html"/>
	<parallel_text xml:lang="fit" location="mensi.html"/>
	<parallel_text xml:lang="rmf" location="meni.html"/>
	<parallel_text xml:lang="rmn" location="mensturacija.html"/>
	<parallel_text xml:lang="rmu" location="rattepha.html"/>
	<parallel_text xml:lang="rmy-rka" location="lolo-kurko.html"/>
	<parallel_text xml:lang="rmy-rlo" location="zuvliako-on-mens.html"/>
	<parallel_text xml:lang="sma" location="gujnelemmie.html"/>
	<parallel_text xml:lang="sme" location="manodavddat.html"/>
	<parallel_text xml:lang="swe" location="mens.html"/></xsl:variable>
