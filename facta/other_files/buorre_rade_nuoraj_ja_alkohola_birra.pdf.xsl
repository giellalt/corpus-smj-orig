...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.blakors.no/wp-content/uploads/2017/04/BROSJYRE_SAMISK_LULE_LAVOPPL.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Buorre ráde nuoraj ja alkohola birra dunji gut la æjgát lågenanjagágij'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="''"/>
    <xsl:variable name="author1_ln" select="'Blå Kors Norge'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="gode_rad_om_ungdom_og_alkohol.pdf"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="hijven_raerieh_noeri_jih_alkohovlen.pdf"/>
        <parallel_text xml:lang="sme" location="buori_ravvagat_alkohola_ja_nuorravuoda.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'9'"/>
