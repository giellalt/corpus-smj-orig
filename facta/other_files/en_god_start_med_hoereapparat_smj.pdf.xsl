...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.hlf.no/globalassets/brosjyrer/en-god-start-med-horeapparat_44sider_lulesamisk.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'GÅ GULÁDAGÁV ADNEGOADÁ'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Maren Bækkelund'"/>
    <xsl:variable name="author1_ln" select="'Ellingsen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="en_god_start_med_hoereapparat_sma.pdf"/>
        <parallel_text xml:lang="sme" location="en_god_start_med_hoereapparat_sme.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-3, 38-44'"/>
