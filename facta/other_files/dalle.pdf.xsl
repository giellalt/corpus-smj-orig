...
<xsl:variable name="filename" select="'http://www.aajege.no/attachments/108_Dålle.pdf'"/>
<xsl:variable name="title" select="'Dålle'"/>
...
<xsl:variable name="wordcount" select="'542'"/>
