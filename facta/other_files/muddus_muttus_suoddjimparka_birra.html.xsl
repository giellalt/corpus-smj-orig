...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sverigesnationalparker.se/smj/vallji-suoddjimparkav/muddus--muttos-suoddjimparkka/suoddjimparkkadiedo/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Muddus / Muttus suoddjimpárka birra'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="swe" location="om_muddus_muttos_nationalpark.html"/>
    </xsl:variable>
