...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://nuorat.se/opinion/man-alov-svieriga-arro-maksa/'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Tobias'"/>
    <xsl:variable name="author1_ln" select="'Poggats'"/>
    <!-- m, f or unknown -->
