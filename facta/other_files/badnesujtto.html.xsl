...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.norrbotten.se/sv/Om-Region-Norrbotten/Other-languages/Lulesamiska/Tandvard/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Bádnesujtto/Tandvård'"/>
    <!--
    ...
    <language xml:lang="swe"/><language xml:lang="eng"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="batnediksun.html"/>
