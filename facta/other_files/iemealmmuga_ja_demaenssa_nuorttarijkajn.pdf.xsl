...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.diva-portal.se/smash/get/diva2:1390959/FULLTEXT01.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Iemeálmmuga ja demænssa Nuorttarijkajn'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Lars Rottem'"/>
    <xsl:variable name="author1_ln" select="'Krangnes'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'2-3, 24-25, 28'"/>
    ...
    <xsl:variable name="bottom_margin" select="'8=16, 9=27, 11=20, 12=14, 14=15, 15=33, 20=16'"/>
