...
<xsl:variable name="filename" select="'http://www.aajege.no/attachments/110_Moerh.pdf'"/>
<xsl:variable name="title" select="'Moerh'"/>
...
<xsl:variable name="wordcount" select="'1220'"/>
