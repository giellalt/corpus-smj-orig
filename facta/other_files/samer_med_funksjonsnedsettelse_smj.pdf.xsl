...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://nordicwelfare.org/wp-content/uploads/2017/10/NorskSamerapportLAYOUT160414.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'SITUASJONEN TIL SAMER MED FUNKSJONSNEDSETTELSE'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="samer_med_funksjonsnedsettelse_eng.pdf"/>
        ...
        <parallel_text xml:lang="nob" location="samer_med_funksjonsnedsettelse_nob.pdf"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="samer_med_funksjonsnedsettelse_sma.pdf"/>
        <parallel_text xml:lang="sme" location="samer_med_funksjonsnedsettelse_sme.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-8, 11-132'"/>
