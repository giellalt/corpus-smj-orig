...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'LULESAMISK_2___OPPGAVER.doc'"/>
  <xsl:variable name="title" select="'2001` VUOĐĐOSKUVLLA   LOAHPPAGEAHČČALEAPMI'"/>
  ...
  <xsl:variable name="wordcount" select="'562'"/>
...
<xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
               ...
               <xsl:with-param name="target" select="'ń/ñ/'"/>
               <xsl:with-param name="replacement" select="'ŋ/ŋ/'"/>
