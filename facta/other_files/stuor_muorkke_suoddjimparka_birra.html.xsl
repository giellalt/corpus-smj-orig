...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sverigesnationalparker.se/smj/vallji-suoddjimparkav/stora-sjofallet--stuor-muorkke-suoddjimparkka/suoddjimparkkadiedo/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Stora Sjöfallets / Stuor Muorkke suoddjimpárka birra'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="about_stuor_muorkke_national_park.html"/>
        ...
        <parallel_text xml:lang="swe" location="om_stora_sjofallet_nationalpark.html"/>
    </xsl:variable>
