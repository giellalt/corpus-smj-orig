...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Svenne___sa_megiellaj.doc'"/>
  <xsl:variable name="title" select="'Guojmmevuohta ja aktisasjbarggo institusjÃ¥vnÃ¥j gaskan â hÃ¡sstalusÃ¡ boahtteÃ¡jggÃ¡j'"/>
  <xsl:variable name="author1_fn" select="'Sven-Roald'"/>
  <xsl:variable name="author1_ln" select="'NystÃ¸'"/>
