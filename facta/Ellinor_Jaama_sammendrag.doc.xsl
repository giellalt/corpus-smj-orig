...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Ellinor_Ja___½ma_sammendrag.doc'"/>
  <xsl:variable name="title" select="''"/>
  <xsl:variable name="author1_fn" select="'Ellinor Marita'"/>
  <xsl:variable name="author1_ln" select="'JÃ¥ma'"/>
