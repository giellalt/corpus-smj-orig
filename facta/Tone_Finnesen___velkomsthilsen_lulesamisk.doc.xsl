...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Tone_Finnesen___velkomsthilsen_lulesamisk.doc'"/>
  <xsl:variable name="title" select="'StivrrajÃ¥dediddje Tone Finnesena buorisboahtemhÃ¥lla Ãrrana dutkamkonferÃ¡nsan snjuktjamÃ¡no'"/>
