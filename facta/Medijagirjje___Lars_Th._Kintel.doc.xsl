...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Medija_girjje___Lars_Th._Kintel.doc'"/>
  <xsl:variable name="title" select="'MediÃ¡girjje'"/>
  <xsl:variable name="author1_fn" select="'Liv Inger'"/>
  <xsl:variable name="author1_ln" select="'Somby'"/>
