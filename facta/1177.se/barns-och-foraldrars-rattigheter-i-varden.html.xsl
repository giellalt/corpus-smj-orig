...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.1177.se/Nationella-minoritetssprak/Nationella-minoritetssprak/Lulesamiska/Regler-och-rattigheter/Barns-och-foraldrars-rattigheter-i-varden'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="barns-och-foraldrars-rattigheter-i-varden.html"/>
        <parallel_text xml:lang="fin" location="barns-och-foraldrars-rattigheter-i-varden.html"/>
        <parallel_text xml:lang="fit" location="barns-och-.html"/>
...
<parallel_text location="barns-och-foraldrars-rattigheter-i-varden.html" xml:lang="yid"/>
