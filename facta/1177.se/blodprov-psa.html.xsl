...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Nationella-minoritetssprak/Nationella-minoritetssprak/Lulesamiska/Undersokningar-och-prover/Blodprov-PSA'"/>
    ...
    <parallel_text xml:lang="eng" location="psa.html"/>
	<parallel_text xml:lang="fin" location="psa.html"/>
	<parallel_text xml:lang="fit" location="blodprov-psa.html"/>
	...
	<parallel_text xml:lang="rus" location="psa.html"/>
	<parallel_text xml:lang="sma" location="blodprov-psa.html"/>
	<parallel_text xml:lang="sme" location="blodprov-psa.html"/>
	<parallel_text xml:lang="swe" location="psa.html"/>
	<parallel_text xml:lang="yid" location="psa-blodprov.html"/></xsl:variable>
