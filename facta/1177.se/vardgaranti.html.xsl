...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Nationella-minoritetssprak/Nationella-minoritetssprak/Lulesamiska/Regler-och-rattigheter/Vardgaranti'"/>
    ...
    <parallel_text xml:lang="eng" location="vardgaranti.html"/>
	<parallel_text xml:lang="fin" location="vardgaranti.html"/>
	<parallel_text xml:lang="fit" location="vardgaranti.html"/>
	<parallel_text xml:lang="rmf" location="vardgaranti.html"/>
	<parallel_text xml:lang="rmn" location="vardgaranti.html"/>
	<parallel_text xml:lang="rmu" location="vardgaranti.html"/>
	<parallel_text xml:lang="rmy-rka" location="vardgaranti.html"/>
	<parallel_text xml:lang="rmy-rlo" location="vardgaranti.html"/>
	<parallel_text xml:lang="sma" location="vardgaranti.html"/>
	<parallel_text xml:lang="sme" location="vardgaranti.html"/>
	<parallel_text xml:lang="swe" location="vardgarantier.html"/>
	<parallel_text xml:lang="yid" location="vardgaranti.html"/></xsl:variable>
