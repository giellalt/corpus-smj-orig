...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Nationella-minoritetssprak/Nationella-minoritetssprak/Lulesamiska/Regler-och-rattigheter/Hitta-ratt-i-sjukvarden'"/>
	...
	<parallel_text xml:lang="yid" location="hitta-ratt-i-sjukvarden.html"/></xsl:variable>
