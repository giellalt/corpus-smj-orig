...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Nationella-minoritetssprak/Nationella-minoritetssprak/Lulesamiska/Sveriges-nationella-minoritetssprak/Sveriges-nationella-minoriteter-och-minoriteter-och-minoritetssprak'"/>
    ...
    <parallel_text xml:lang="fin" location="sveriges-nationella-minoritetssprak.html"/>
	<parallel_text xml:lang="fit" location="sveriges-nationella-minoriteter-och-minoritetssprak.html"/>
	...
	<parallel_text xml:lang="swe" location=".html"/>
	<parallel_text xml:lang="yid" location="sveriges-nationella-minoriteter-och-minoritetssprak.html"/></xsl:variable>
