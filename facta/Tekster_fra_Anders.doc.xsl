...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Tekster_fra_Anders.doc'"/>
  <xsl:variable name="title" select="'Det samiske ligger hjertet nÃ¦rmest'"/>
  <xsl:variable name="author1_fn" select="'Anders'"/>
