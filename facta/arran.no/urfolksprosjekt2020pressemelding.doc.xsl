...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.arran.no/getfile.php/335255.927.xsrfruvtqy/urfolksprosjekt2020pressemelding.doc'"/>
    ...
    <parallel_text xml:lang="nob" location="urfolksprosjekt2020pressemelding.doc"/></xsl:variable>
