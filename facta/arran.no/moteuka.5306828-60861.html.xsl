...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.arran.no/moteuka.5306828-60861.html'"/>
    ...
    <parallel_text xml:lang="nob" location="moteuka.5306828-60861.html"/></xsl:variable>
