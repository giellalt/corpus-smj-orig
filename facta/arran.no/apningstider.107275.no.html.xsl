...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.arran.no/apningstider.107275.no.html'"/>
    ...
    <parallel_text xml:lang="nob" location="apningstider.107275.no.html"/>
	<parallel_text xml:lang="eng" location="apningstider.107275.no.html"/></xsl:variable>
