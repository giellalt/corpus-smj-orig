...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.arran.no/schreiners-fotomateriale.271861.se.html'"/>
    ...
    <parallel_text xml:lang="nob" location="schreiners-fotomateriale.271861.se.html"/></xsl:variable>
