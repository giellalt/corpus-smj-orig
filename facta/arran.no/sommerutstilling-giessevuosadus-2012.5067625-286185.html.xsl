...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.arran.no/sommerutstilling-giessevuosadus-2012.5067625-286185.html'"/>
    ...
    <parallel_text xml:lang="nob" location="sommerutstilling-giessevuosadus-2012.5067625-286185.html"/></xsl:variable>
