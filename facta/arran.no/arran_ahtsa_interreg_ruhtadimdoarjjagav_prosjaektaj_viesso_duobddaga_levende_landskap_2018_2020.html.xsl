...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://arran.no/dahpaduvva/?Article=192'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'ÁRRAN ÅHTSÅ INTERREG-RUHTADIMDOARJJAGAV PROSJÆKTAJ VIESSO DUOBDDÁGA/LEVENDE LANDSKAP 2018–2020'"/>
    <!--
    ...
    <language xml:lang="eng"/><language xml:lang="nob"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="arran_soker_om_interreg_tilskudd_til_prosjektet_viesso_duobddaga_levende_landskap_2018_2020.html"/>
