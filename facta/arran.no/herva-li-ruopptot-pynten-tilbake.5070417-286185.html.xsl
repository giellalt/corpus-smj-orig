...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.arran.no/herva-li-ruopptot-pynten-tilbake.5070417-286185.html'"/>
    ...
    <parallel_text xml:lang="nob" location="herva-li-ruopptot-pynten-tilbake.5070417-286185.html"/></xsl:variable>
