...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.arran.no/giella.316358.se.html'"/>
    ...
    <parallel_text xml:lang="sme" location="giella.316358.se.html"/>
	<parallel_text xml:lang="swe" location="giella.316358.se.html"/></xsl:variable>
