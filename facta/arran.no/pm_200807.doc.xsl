...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.arran.no/getfile.php/517170.927.wtdcwwquac/PM+200807.doc'"/>
    ...
    <parallel_text xml:lang="nob" location="pm_200807.doc"/></xsl:variable>
