...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.arran.no/baarjaas-2014.5576016-60861.html'"/>
    ...
    <parallel_text xml:lang="nob" location="baarjaas-2014.5576016-60861.html"/></xsl:variable>
