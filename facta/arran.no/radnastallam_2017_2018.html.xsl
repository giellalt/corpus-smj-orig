...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://arran.no/dahpaduvva/?Article=160'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'RÁDNASTALLAM 2017/2018'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Ingrid'"/>
    <xsl:variable name="author1_ln" select="'Kintel'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="author1_born" select="'1988'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="radnastallam_2017_2018.html"/>
