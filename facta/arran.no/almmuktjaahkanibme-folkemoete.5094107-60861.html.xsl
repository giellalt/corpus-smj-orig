...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.arran.no/almmuktjaahkanibme-folkemoete.5094107-60861.html'"/>
    ...
    <parallel_text xml:lang="nob" location="almmuktjaahkanibme-folkemoete.5094107-60861.html"/></xsl:variable>
