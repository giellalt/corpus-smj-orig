...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Sammendrag_Sagdahl___lulesamisk.doc'"/>
  <xsl:variable name="title" select="'BÃ¡jkÃ¡lasj vuodnaresursa ja regulerimpolitihkka. Buojkulvis Divtasvuodna.'"/>
  <xsl:variable name="author1_fn" select="'BjÃ¸rn'"/>
  <xsl:variable name="author1_ln" select="'Sagdahl'"/>
