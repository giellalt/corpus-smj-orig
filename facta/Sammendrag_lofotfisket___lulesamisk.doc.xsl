...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Sammendrag_lofotfisket___lulesamisk.doc'"/>
  <xsl:variable name="title" select="'SÃ¡me ja LofoahttaguolÃ¡stus Ã¥vdep Ã¡jgij'"/>
  <xsl:variable name="author1_fn" select="'Alf Ragnar'"/>
  <xsl:variable name="author1_ln" select="'Nielssen'"/>
