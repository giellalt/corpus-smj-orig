...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Tekster_fra_Samuel.doc'"/>
  <xsl:variable name="title" select="'TÃ¦ksta: Gudrun Eriksen Lindi'"/>
  <xsl:variable name="author1_fn" select="'Gudrun '"/>
  <xsl:variable name="author1_ln" select="'Eriksen Lindi'"/>
  ...
  <xsl:variable name="translator_fn" select="'Samuel'"/>
  <xsl:variable name="translator_ln" select="'GÃ¦lok'"/>
