...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Sammendrag_laksekonsesjoner___lulesamisk.doc'"/>
  <xsl:variable name="title" select="'Dalloj g̴ luossakonsesj̴vn̴ b̴dijga'"/>
  <xsl:variable name="author1_fn" select="'H̴kan T.'"/>
  <xsl:variable name="author1_ln" select="'Sandersen'"/>
