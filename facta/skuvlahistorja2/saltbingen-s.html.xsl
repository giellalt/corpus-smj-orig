...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/saltbingen-s.htm'"/>
<xsl:variable name="title" select="'Oajvveskuvrremiehttim vuodoskavlån'"/>
<xsl:variable name="author1_fn" select="'Frank A.'"/>
<xsl:variable name="author1_ln" select="'Jenssen'"/>
<xsl:variable name="author1_gender" select="'m'"/>
<xsl:variable name="author1_born" select="'1952'"/>
...
<xsl:variable name="translator_fn" select="'Kaia'"/>
<xsl:variable name="translator_ln" select="'Kalstad'"/>
<xsl:variable name="translator_gender" select="'f'"/>
<xsl:variable name="translator_born" select="'1935'"/>
<xsl:variable name="translator_nat" select="'NO'"/>
<!-- select license type: free, standard or other -->
<xsl:variable name="license_type" select="'free'"/>
<xsl:variable name="sub_name" select="''"/>
<xsl:variable name="sub_email" select="''"/>
<xsl:variable name="wordcount" select="'2393'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="saltbingen-n.html" xml:lang="nob"/>
</xsl:variable>
