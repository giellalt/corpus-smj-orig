...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Tekster_Lulesamisk_fra_Rachel.doc'"/>
  <xsl:variable name="title" select="'JÃHKKO JA ÃJÃDUS'"/>
  <xsl:variable name="author1_fn" select="'Marit'"/>
  <xsl:variable name="author1_ln" select="'Guttorm'"/>
  ...
  <xsl:variable name="translator_fn" select="'Rachel'"/>
