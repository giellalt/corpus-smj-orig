...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.gruvehistorie.no/Sami.html'"/>
    ...
    <parallel_text xml:lang="deu" location="german.html"/>
	<parallel_text xml:lang="eng" location="english.html"/>
	<parallel_text xml:lang="nob" location="norsk.html"/></xsl:variable>
