...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Lina_Gaski_sammendrag.doc'"/>
  <xsl:variable name="title" select="'MÃ¡httep gus mÃ¥lssot gÃ¡bmagijs stiebilijda?'"/>
  <xsl:variable name="author1_fn" select="'Lina'"/>
