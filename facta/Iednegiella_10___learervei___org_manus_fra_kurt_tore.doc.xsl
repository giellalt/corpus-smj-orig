...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Iednegiella_10___learervei___org_manus_fra_kurt_tore.doc'"/>
  <xsl:variable name="title" select="'GIELALASJ VÃJKKUDAGÃ'"/>
  ...
  <xsl:variable name="publisher" select="'SÃ¡mediggi'"/>
