...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.calliidlagadus.org/web/index.php?egavpi=1&amp;girji=117&amp;giella1=sam'"/>
    ...
    <parallel_text xml:lang="nob" location="index.php_egavpi-1_girji-116_giella1-sam.html"/>
	<parallel_text xml:lang="sme" location="index.php_egavpi-1_girji-113_giella1-sam.html"/>
	<parallel_text xml:lang="sma" location="index.php_egavpi-1_girji-122_giella1-sam.html"/></xsl:variable>
