...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Giella_le_fa_bmo___Lars_Th._Kintel_korrekturlest.doc'"/>
  <xsl:variable name="title" select="'Giella l rÃ¡ddo'"/>
  <xsl:variable name="author1_fn" select="'Maaren'"/>
  <xsl:variable name="author1_ln" select="'Paalismaa'"/>
