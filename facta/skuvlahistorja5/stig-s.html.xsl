...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://skuvla.info/skolehist/stig-s.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ássjeguoddáluváj gå sidáj sámegiellaåhpadusáv'"/>
    <!--
    ...
    <xsl:variable name="author1_born" select="'19511015'"/>
    <!--
    ...
    <xsl:variable name="translator_fn" select="'Kaja'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="stig-n.html"/>
