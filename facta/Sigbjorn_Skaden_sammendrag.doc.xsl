...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'SigbjÃ¸rn_Ska_den_sammendrag.doc'"/>
  <xsl:variable name="title" select="'SÃ¡me tjuovggidusÃ¡jge sisi'"/>
  <xsl:variable name="author1_fn" select="'SigbjÃ¸rn'"/>
  <xsl:variable name="author1_ln" select="'SkÃ¥den'"/>
