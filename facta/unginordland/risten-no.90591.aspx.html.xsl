...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.unginordland.no/infonuorra-2/julevsamegiella/julevsamegiella/risten-no.90591.aspx'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="risten-no.aspx.html"/>
        <parallel_text xml:lang="sme" location="risten-no-ns.90549.aspx.html"/>
