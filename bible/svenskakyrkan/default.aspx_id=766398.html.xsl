...
<xsl:variable name="para_fin" select="'default.aspx_id=655205.html'"/>
...
<xsl:variable name="para_sma" select="'default.aspx_id=767243.html'"/>
<xsl:variable name="para_sme" select="'default.aspx_id=767288.html'"/>
