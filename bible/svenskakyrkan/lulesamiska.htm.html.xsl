...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.svenskakyrkan.se/kyrkoval2005/lulesamiska.htm'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="eng.htm.html"/>
        <parallel_text xml:lang="fin" location="finsktrk.htm.html"/>
        ...
        <parallel_text xml:lang="sma" location="sydsam.htm.html"/>
        <parallel_text xml:lang="sme" location="nordsamiska.htm.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location=""/>
        <parallel_text xml:lang="swe" location=""/>
    <parallel_text location="franska.htm.html" xml:lang="fra"/>
<parallel_text location="tyska.htm.html" xml:lang="deu"/>
<parallel_text location="romani.htm.html" xml:lang="rmy-rka"/>
<parallel_text location="spansk.htm.html" xml:lang="spa"/>
</xsl:variable>
