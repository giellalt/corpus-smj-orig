...
<xsl:variable name="para_fin" select="'default.aspx_id=655211.html'"/>
...
<xsl:variable name="para_sma" select="'default.aspx_id=767249.html'"/>
<xsl:variable name="para_sme" select="'default.aspx_id=767273.html'"/>
