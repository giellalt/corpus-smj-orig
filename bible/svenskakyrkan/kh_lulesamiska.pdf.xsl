...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://internwww.svenskakyrkan.se/default.aspx?id=782262&amp;ptid=3095'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kyrkohandboksforslag_finska.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="kh_nordsamiska.pdf"/>
