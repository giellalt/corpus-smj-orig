...
<xsl:variable name="para_eng" select="'kyrkoval_a4_eng.pdf'"/>
<xsl:variable name="para_fin" select="'kyrkoval_a4_fi.pdf'"/>
...
<xsl:variable name="para_sma" select="'050818kyrkoval_a4_sydsam.pdf'"/>
<xsl:variable name="para_sme" select="'kyrkoval_a4_nordsamiska.pdf'"/>
<xsl:variable name="para_smj" select="'kyrkoval_a4_lulesamiska.pdf'"/>
