...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.svenskakyrkan.se/kyrkoval2005/documents/Kyrkoval_A4_lulesamiska.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="kyrkoval_a4_eng.pdf"/>
        <parallel_text xml:lang="fin" location="kyrkoval_a4_fi.pdf"/>
        ...
        <parallel_text xml:lang="sma" location="050818kyrkoval_a4_sydsam.pdf"/>
        <parallel_text xml:lang="sme" location="kyrkoval_a4_nordsamiska.pdf"/>
        <parallel_text xml:lang="smj" location="kyrkoval_a4_lulesamiska.pdf"/>
