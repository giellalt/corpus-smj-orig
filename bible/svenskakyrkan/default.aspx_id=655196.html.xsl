...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.svenskakyrkan.se/default.aspx?id=655196'"/>
    ...
    <!-- Automatically filled in by CorpusTools -->
    <xsl:variable name="template_version" select="'$Revision: 104145 $'"/>
    <!-- Automatically filled in by CorpusTools -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="suomeksi.html"/>
        ...
        <parallel_text xml:lang="sma" location="default.aspx_id=655194.html"/>
        <parallel_text xml:lang="sme" location="default.aspx_id=655195.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location=""/>
        <parallel_text xml:lang="swe" location="kyrkans-grundlaggande-uppgifter.html"/>
    </xsl:variable>
