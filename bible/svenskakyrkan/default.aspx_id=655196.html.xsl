...
<xsl:variable name="para_fin" select="'suomeksi.html'"/>
...
<xsl:variable name="para_sma" select="'default.aspx_id=655194.html'"/>
<xsl:variable name="para_sme" select="'default.aspx_id=655195.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'kyrkans-grundlaggande-uppgifter.html'"/>
