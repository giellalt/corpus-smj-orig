...
<xsl:variable name="para_fin" select="'default.aspx_id=655212.html'"/>
...
<xsl:variable name="para_sma" select="'lihtsegevoete.html'"/>
<xsl:variable name="para_sme" select="'miellahttuvuohta.html'"/>
