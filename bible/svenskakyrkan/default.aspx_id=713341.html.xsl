...
<xsl:variable name="para_fin" select="'default.aspx_id=642909.html'"/>
...
<xsl:variable name="para_sma" select="'default.aspx_id=713329.html'"/>
<xsl:variable name="para_sme" select="'default.aspx_id=713339.html'"/>
