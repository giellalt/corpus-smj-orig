...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.svenskakyrkan.se/default.aspx?id=713341'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="default.aspx_id=642909.html"/>
        ...
        <parallel_text xml:lang="sma" location="default.aspx_id=713329.html"/>
        <parallel_text xml:lang="sme" location="default.aspx_id=713339.html"/>
