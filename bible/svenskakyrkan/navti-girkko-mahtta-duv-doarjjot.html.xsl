...
<xsl:variable name="para_fin" select="'default.aspx_id=775900.html'"/>
...
<xsl:variable name="para_sma" select="'nemhtie-grhkoe-datnem-maahta-daarjodh.html'"/>
<xsl:variable name="para_sme" select="'na-sahtta-girku-doarjut-du.html'"/>
