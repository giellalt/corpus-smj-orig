...
<xsl:variable name="para_fin" select="'default.aspx_id=775925.html'"/>
...
<xsl:variable name="para_sma" select="'internationelle-barkoe.html'"/>
<xsl:variable name="para_sme" select="'riikkaidgaskasa-bargu.html'"/>
