...
<xsl:variable name="filename" select="'https://internwww.svenskakyrkan.se/default.aspx?id=782265&amp;ptid=3095'"/>
...
<xsl:variable name="parallels">
  ...
  <!-- <parallel_text xml:lang="swe" location=""/> -->
	<parallel_text xml:lang="sme" location="nordsamiska_noter.pdf"/>
</xsl:variable>
