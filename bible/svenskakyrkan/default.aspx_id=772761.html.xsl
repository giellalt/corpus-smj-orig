...
<xsl:variable name="para_fin" select="'default.aspx_id=655200.html'"/>
...
<xsl:variable name="para_sma" select="'default.aspx_id=772785.html'"/>
<xsl:variable name="para_sme" select="'default.aspx_id=772795.html'"/>
