...
<xsl:variable name="para_fin" select="'default.aspx_id=775915.html'"/>
...
<xsl:variable name="para_sma" select="'kristeles-jaahkoe.html'"/>
<xsl:variable name="para_sme" select="'risttala-osku.html'"/>
