...
<xsl:variable name="para_nob" select="'plan_for_samisk_trosopplaering.pdf'"/>
<xsl:variable name="para_sma" select="'plan_for_samisk_trosopplaering.pdf'"/>
<xsl:variable name="para_sme" select="'plan_for_samisk_trosopplaering.pdf'"/>
