...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.kirken.no/?event=downloadFile&amp;FamID=179596'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sáme jáhkkoåhpaduspládna'"/>
    <!--
    ...
    <xsl:variable name="ISBN" select="'987-82-7545-103-1'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="plan_for_samisk_trosopplaering.pdf"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="plan_for_samisk_trosopplaering.pdf"/>
        <parallel_text xml:lang="sme" location="plan_for_samisk_trosopplaering.pdf"/>
