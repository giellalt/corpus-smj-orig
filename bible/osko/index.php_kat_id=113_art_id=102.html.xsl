...
<xsl:variable name="para_nob" select="'index.php_kat_id=113_art_id=102.html'"/>
<xsl:variable name="para_sma" select="'index.php_kat_id=113_art_id=102.html'"/>
<xsl:variable name="para_sme" select="'index.php_kat_id=113_art_id=102.html'"/>
