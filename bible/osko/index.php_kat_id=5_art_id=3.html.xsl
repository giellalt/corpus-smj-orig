...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.osko.no/index.php?kat_id=5&amp;art_id=3'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="index.php_kat_id=5_art_id=3.html"/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="index.php_kat_id=5_art_id=3.html"/>
        <parallel_text xml:lang="sme" location="index.php_kat_id=5_art_id=3.html"/>
