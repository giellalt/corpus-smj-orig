...
<xsl:variable name="para_nob" select="'index.php_kat_id=5_art_id=3.html'"/>
<xsl:variable name="para_sma" select="'index.php_kat_id=5_art_id=3.html'"/>
<xsl:variable name="para_sme" select="'index.php_kat_id=5_art_id=3.html'"/>
