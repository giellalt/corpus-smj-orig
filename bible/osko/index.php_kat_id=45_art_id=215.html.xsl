...
<xsl:variable name="filename" select="'http://www.osko.no/index.php?kat_id=45&amp;art_id=215'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index.php_kat_id=45_art_id=215.html" xml:lang="nob"/>
	<parallel_text location="index.php_kat_id=45_art_id=215.html" xml:lang="sma"/>
	<parallel_text location="index.php_kat_id=45_art_id=215.html" xml:lang="sme"/>
</xsl:variable>
