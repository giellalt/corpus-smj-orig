...
<xsl:variable name="para_nob" select="'index.php_kat_id=216_art_id=260.html'"/>
<xsl:variable name="para_sma" select="'index.php_kat_id=216_art_id=260.html'"/>
<xsl:variable name="para_sme" select="'index.php_kat_id=216_art_id=260.html'"/>
