...
<xsl:variable name="filename" select="'http://www.osko.no/index.php?kat_id=31&amp;art_id=32'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index.php_kat_id=31_art_id=32.html" xml:lang="nob"/>
	<parallel_text location="index.php_kat_id=31_art_id=32.html" xml:lang="sma"/>
	<parallel_text location="index.php_kat_id=31_art_id=32.html" xml:lang="sme"/>
</xsl:variable>
