...
<xsl:variable name="para_nob" select="'index.php_kat_id=37_art_id=169.html'"/>
<xsl:variable name="para_sma" select="'index.php_kat_id=37_art_id=169.html'"/>
<xsl:variable name="para_sme" select="'index.php_kat_id=37_art_id=169.html'"/>
