...
<xsl:variable name="filename" select="'http://www.osko.no/index.php?kat_id=121&amp;art_id=136'"/>
...
<xsl:variable name="para_nob" select="'index.php_kat_id=121_art_id=136.html'"/>
<xsl:variable name="para_sma" select="'index.php_kat_id=121_art_id=136.html'"/>
<xsl:variable name="para_sme" select="'index.php_kat_id=121_art_id=136.html'"/>
