...
<xsl:variable name="filename" select="'http://www.osko.no/index.php?kat_id=91&amp;art_id=86'"/>
...
<xsl:variable name="para_nob" select="'index.php_kat_id=91_art_id=86.html'"/>
<xsl:variable name="para_sma" select="'index.php_kat_id=91_art_id=86.html'"/>
<xsl:variable name="para_sme" select="'index.php_kat_id=91_art_id=86.html'"/>
