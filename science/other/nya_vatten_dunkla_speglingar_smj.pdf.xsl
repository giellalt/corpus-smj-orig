...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.diva-portal.org/smash/get/diva2:697690/FULLTEXT01.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Nya vatten, dunkla speglingar. Industriell kolonialism genom svensk vattenkraftutbyggnad i renskötselområdet 1910-1968'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Åsa'"/>
    <xsl:variable name="author1_ln" select="'Össbo'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="translator_fn" select="'Nils-Olof'"/>
    <xsl:variable name="translator_ln" select="'Sortelius'"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-7, 9-314'"/>
