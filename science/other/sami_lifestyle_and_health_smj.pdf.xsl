...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://umu.diva-portal.org/smash/get/diva2:489385/FULLTEXT02.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sami lifestyle and health. epidemiological studies from northern Sweden'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="sami_lifestyle_and_health_sma.pdf"/>
        <parallel_text xml:lang="sme" location="sami_lifestyle_and_health_sme.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-12, 15-102'"/>
    ...
    <xsl:variable name="top_margin" select="'13=19'"/>
    <xsl:variable name="bottom_margin" select="'14=60'"/>
