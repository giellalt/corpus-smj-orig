...
<xsl:variable name="title" select="'Dån le dánna - infonuorra'"/>
<xsl:variable name="author1_fn" select="''"/>
<xsl:variable name="author1_ln" select="'unknown'"/>
...
<xsl:variable name="publisher" select="'Infonuorra'"/>
<xsl:variable name="publChannel" select="'http://www.infonuorra.no/'"/>
