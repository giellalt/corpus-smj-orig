...
<xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/samisk/nievres-d-lkke-allobarggijt-hiemssi.4195'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Nievres dálkke ællobarggijt hiemssi'"/>
