...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.lansstyrelsen.se/download/18.2e0f9f621636c84402732e0e/1528896661325/Lagen%20om%20nationella%20minoriteter%20och%20minoritetsspr%C3%A5k%20(2009724)%20lulesamiska.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Láhka rijkalasj unneplågoj ja unneplågogielaj birra'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="''"/>
    <xsl:variable name="author1_ln" select="'minoritet.se'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="top_margin" select="'all=3'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'1=3'"/>
    <xsl:variable name="inner_left_margin" select="'1=66'"/>
    <xsl:variable name="inner_top_margin" select="'1=5'"/>
    <xsl:variable name="inner_bottom_margin" select="'1=50'"/>
