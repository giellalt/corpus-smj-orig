...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.regeringen.se/content/1/c6/13/75/73/b3418a89.pdf'"/>
    ...
    <xsl:variable name="note" select="'Main url: http://www.regeringen.se/sb/d/108/a/137573'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="cd166226.pdf"/>
        ...
        <parallel_text xml:lang="sma" location="787037c6.pdf"/>
        <parallel_text xml:lang="sme" location="3ad2153c.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location=""/>
        <parallel_text xml:lang="swe" location="20090724.htm.html"/>
    </xsl:variable>
