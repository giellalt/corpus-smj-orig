...
<xsl:variable name="para_fin" select="'cd166226.pdf'"/>
...
<xsl:variable name="para_sma" select="'787037c6.pdf'"/>
<xsl:variable name="para_sme" select="'3ad2153c.pdf'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'20090724.htm.html'"/>
