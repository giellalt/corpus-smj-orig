...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://unnarievsak.blogspot.no'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Naima'"/>
    <xsl:variable name="author1_ln" select="'K. Nergård'"/>
    <!-- m, f or unknown -->
    ...
    -->
    <xsl:variable name="author1_nat" select="'nor/swe'"/>
    ...
    <!-- Publication year -->
    <xsl:variable name="year" select="'2011/2012'"/>
    ...
    <xsl:variable name="note" select="'blogg tekstene er publiser mellom 26.01.2012 og 02.12.11'"/>
