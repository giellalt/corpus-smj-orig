...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://ulmusj.blogspot.no/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Lisásj'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Lisa Lucia'"/>
    <xsl:variable name="author1_ln" select="'Lyngman Gælok'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="note" select="'Tekstene er postet på bloggen mellom 28.02.12 og 08.012.11'"/>
