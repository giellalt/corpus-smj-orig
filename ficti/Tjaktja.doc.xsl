...
<xsl:variable name="publisher" select="'Sámi girjjit'"/>
<xsl:variable name="publChannel" select="''"/>
<xsl:variable name="year" select="'1987'"/>
<xsl:variable name="ISBN" select="'91 86604 14 7'"/>
<xsl:variable name="ISSN" select="''"/>
<xsl:variable name="place" select="''"/>
<xsl:variable name="genre" select="'fiction'"/>
