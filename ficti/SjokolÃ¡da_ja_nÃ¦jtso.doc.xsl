...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Sjokola_da_ja_nÃ¦jtso.doc'"/>
  <xsl:variable name="title" select="'SjokolÃ¡da ja nÃ¦jtso'"/>
  ...
  <xsl:variable name="publisher" select="'BÃ¡hko'"/>
