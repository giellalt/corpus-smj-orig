...
<xsl:variable name="filename" select="'HGR1931.doc'"/>
<xsl:variable name="title" select="'Lulelapska anteckningar: Sägner och folktro. Jokkmokk 1931, ULMA 4086'"/>
...
<xsl:variable name="wordcount" select="'2369'"/>
